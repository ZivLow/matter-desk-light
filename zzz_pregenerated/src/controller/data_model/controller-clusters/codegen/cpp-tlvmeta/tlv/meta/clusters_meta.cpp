...
const Entry<ItemInfo> _Scenes[] = {
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 44 }, // Scenes::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // Scenes::int16u
  { { CommandTag(0), "AddScene", ItemType::kDefault }, 23 }, // Scenes::AddScene::AddSceneRequest
  { { CommandTag(1), "ViewScene", ItemType::kDefault }, 25 }, // Scenes::ViewScene::ViewSceneRequest
  { { CommandTag(2), "RemoveScene", ItemType::kDefault }, 27 }, // Scenes::RemoveScene::RemoveSceneRequest
  { { CommandTag(3), "RemoveAllScenes", ItemType::kDefault }, 29 }, // Scenes::RemoveAllScenes::RemoveAllScenesRequest
  { { CommandTag(4), "StoreScene", ItemType::kDefault }, 31 }, // Scenes::StoreScene::StoreSceneRequest
  { { CommandTag(5), "RecallScene", ItemType::kDefault }, 33 }, // Scenes::RecallScene::RecallSceneRequest
  { { CommandTag(6), "GetSceneMembership", ItemType::kDefault }, 34 }, // Scenes::GetSceneMembership::GetSceneMembershipRequest
  { { CommandTag(64), "EnhancedAddScene", ItemType::kDefault }, 36 }, // Scenes::EnhancedAddScene::EnhancedAddSceneRequest
  { { CommandTag(65), "EnhancedViewScene", ItemType::kDefault }, 38 }, // Scenes::EnhancedViewScene::EnhancedViewSceneRequest
  { { CommandTag(66), "CopyScene", ItemType::kDefault }, 40 }, // Scenes::CopyScene::CopySceneRequest
  { { CommandTag(0), "AddSceneResponse", ItemType::kDefault }, 24 }, // Scenes::AddSceneResponse
  { { CommandTag(1), "ViewSceneResponse", ItemType::kDefault }, 26 }, // Scenes::ViewSceneResponse
  { { CommandTag(2), "RemoveSceneResponse", ItemType::kDefault }, 28 }, // Scenes::RemoveSceneResponse
  { { CommandTag(3), "RemoveAllScenesResponse", ItemType::kDefault }, 30 }, // Scenes::RemoveAllScenesResponse
  { { CommandTag(4), "StoreSceneResponse", ItemType::kDefault }, 32 }, // Scenes::StoreSceneResponse
  { { CommandTag(6), "GetSceneMembershipResponse", ItemType::kDefault }, 35 }, // Scenes::GetSceneMembershipResponse
  { { CommandTag(64), "EnhancedAddSceneResponse", ItemType::kDefault }, 37 }, // Scenes::EnhancedAddSceneResponse
  { { CommandTag(65), "EnhancedViewSceneResponse", ItemType::kDefault }, 39 }, // Scenes::EnhancedViewSceneResponse
  { { CommandTag(66), "CopySceneResponse", ItemType::kDefault }, 41 }, // Scenes::CopySceneResponse
};
...
const Entry<ItemInfo> _Scenes_ExtensionFieldSet[] = {
  ...
  { { ContextTag(1), "attributeValueList", ItemType::kList }, 43 }, // Scenes::AttributeValuePair[]
};
...
const Entry<ItemInfo> _Scenes_AddSceneRequest[] = {
  ...
  { { ContextTag(4), "extensionFieldSets", ItemType::kList }, 42 }, // Scenes::ExtensionFieldSet[]
};
...
const Entry<ItemInfo> _Scenes_ViewSceneResponse[] = {
  ...
  { { ContextTag(5), "extensionFieldSets", ItemType::kList }, 42 }, // Scenes::ExtensionFieldSet[]
};
...
const Entry<ItemInfo> _Scenes_CopySceneRequest[] = {
  { { ContextTag(0), "mode", ItemType::kBitmap }, 45 }, // Scenes::ScenesCopyMode
...
const Entry<ItemInfo> _Scenes_ScenesCopyMode[] = {
  { { ConstantValueTag(0x1), "kCopyAllScenes", ItemType::kDefault }, kInvalidNodeIndex }, // Scenes::ScenesCopyMode::kCopyAllScenes
};
...
const Entry<ItemInfo> _OnOff[] = {
  ...
  { { AttributeTag(16387), "startUpOnOff", ItemType::kEnum }, 52 }, // OnOff::StartUpOnOffEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 53 }, // OnOff::Feature
  ...
  { { CommandTag(64), "OffWithEffect", ItemType::kDefault }, 47 }, // OnOff::OffWithEffect::OffWithEffectRequest
  { { CommandTag(65), "OnWithRecallGlobalScene", ItemType::kDefault }, kInvalidNodeIndex }, // OnOff::OnWithRecallGlobalScene::()
  { { CommandTag(66), "OnWithTimedOff", ItemType::kDefault }, 48 }, // OnOff::OnWithTimedOff::OnWithTimedOffRequest
};

const Entry<ItemInfo> _OnOff_OffWithEffectRequest[] = {
  { { ContextTag(0), "effectIdentifier", ItemType::kEnum }, 51 }, // OnOff::EffectIdentifierEnum
...
const Entry<ItemInfo> _OnOff_OnWithTimedOffRequest[] = {
  { { ContextTag(0), "onOffControl", ItemType::kBitmap }, 54 }, // OnOff::OnOffControlBitmap
...
const Entry<ItemInfo> _LevelControl[] = {
  ...
  { { AttributeTag(15), "options", ItemType::kBitmap }, 69 }, // LevelControl::LevelControlOptions
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 68 }, // LevelControl::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // LevelControl::int16u
  { { CommandTag(0), "MoveToLevel", ItemType::kDefault }, 57 }, // LevelControl::MoveToLevel::MoveToLevelRequest
  { { CommandTag(1), "Move", ItemType::kDefault }, 58 }, // LevelControl::Move::MoveRequest
  { { CommandTag(2), "Step", ItemType::kDefault }, 59 }, // LevelControl::Step::StepRequest
  { { CommandTag(3), "Stop", ItemType::kDefault }, 60 }, // LevelControl::Stop::StopRequest
  { { CommandTag(4), "MoveToLevelWithOnOff", ItemType::kDefault }, 61 }, // LevelControl::MoveToLevelWithOnOff::MoveToLevelWithOnOffRequest
  { { CommandTag(5), "MoveWithOnOff", ItemType::kDefault }, 62 }, // LevelControl::MoveWithOnOff::MoveWithOnOffRequest
  { { CommandTag(6), "StepWithOnOff", ItemType::kDefault }, 63 }, // LevelControl::StepWithOnOff::StepWithOnOffRequest
  { { CommandTag(7), "StopWithOnOff", ItemType::kDefault }, 64 }, // LevelControl::StopWithOnOff::StopWithOnOffRequest
  { { CommandTag(8), "MoveToClosestFrequency", ItemType::kDefault }, 65 }, // LevelControl::MoveToClosestFrequency::MoveToClosestFrequencyRequest
};
...
const Entry<ItemInfo> _LevelControl_MoveToLevelRequest[] = {
  ...
  { { ContextTag(2), "optionsMask", ItemType::kBitmap }, 69 }, // LevelControl::LevelControlOptions
  { { ContextTag(3), "optionsOverride", ItemType::kBitmap }, 69 }, // LevelControl::LevelControlOptions
};

const Entry<ItemInfo> _LevelControl_MoveRequest[] = {
  { { ContextTag(0), "moveMode", ItemType::kEnum }, 66 }, // LevelControl::MoveMode
...
const Entry<ItemInfo> _LevelControl_StepRequest[] = {
  { { ContextTag(0), "stepMode", ItemType::kEnum }, 67 }, // LevelControl::StepMode
  ...
  { { ContextTag(3), "optionsMask", ItemType::kBitmap }, 69 }, // LevelControl::LevelControlOptions
  { { ContextTag(4), "optionsOverride", ItemType::kBitmap }, 69 }, // LevelControl::LevelControlOptions
};

const Entry<ItemInfo> _LevelControl_StopRequest[] = {
  { { ContextTag(0), "optionsMask", ItemType::kBitmap }, 69 }, // LevelControl::LevelControlOptions
  { { ContextTag(1), "optionsOverride", ItemType::kBitmap }, 69 }, // LevelControl::LevelControlOptions
};
...
const Entry<ItemInfo> _LevelControl_MoveMode[] = {
  { { ConstantValueTag(0x0), "kUp", ItemType::kDefault }, kInvalidNodeIndex }, // LevelControl::MoveMode::kUp
  { { ConstantValueTag(0x1), "kDown", ItemType::kDefault }, kInvalidNodeIndex }, // LevelControl::MoveMode::kDown
};

const Entry<ItemInfo> _LevelControl_StepMode[] = {
  { { ConstantValueTag(0x0), "kUp", ItemType::kDefault }, kInvalidNodeIndex }, // LevelControl::StepMode::kUp
  { { ConstantValueTag(0x1), "kDown", ItemType::kDefault }, kInvalidNodeIndex }, // LevelControl::StepMode::kDown
};
...
const Entry<ItemInfo> _LevelControl_LevelControlOptions[] = {
  { { ConstantValueTag(0x1), "kExecuteIfOff", ItemType::kDefault }, kInvalidNodeIndex }, // LevelControl::LevelControlOptions::kExecuteIfOff
  { { ConstantValueTag(0x2), "kCoupleColorTempToLevel", ItemType::kDefault }, kInvalidNodeIndex }, // LevelControl::LevelControlOptions::kCoupleColorTempToLevel
};
...
const Entry<ItemInfo> _Descriptor[] = {
  { { AttributeTag(0), "deviceTypeList", ItemType::kList }, 76 }, // Descriptor::DeviceTypeStruct[]
  ...
  { { AttributeTag(4), "tagList", ItemType::kList }, 75 }, // Descriptor::SemanticTagStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 77 }, // Descriptor::Feature
...
const Entry<ItemInfo> _Descriptor_SemanticTagStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 74 }, // Descriptor_SemanticTagStruct[]
};

const Entry<ItemInfo> _Descriptor_DeviceTypeStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 73 }, // Descriptor_DeviceTypeStruct[]
};
...
const Entry<ItemInfo> _Binding[] = {
  { { AttributeTag(0), "binding", ItemType::kList }, 80 }, // Binding::TargetStruct[]
...
const Entry<ItemInfo> _Binding_TargetStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 79 }, // Binding_TargetStruct[]
};

const Entry<ItemInfo> _AccessControl[] = {
  { { AttributeTag(0), "acl", ItemType::kList }, 87 }, // AccessControl::AccessControlEntryStruct[]
  { { AttributeTag(1), "extension", ItemType::kList }, 88 }, // AccessControl::AccessControlExtensionStruct[]
  ...
  { { EventTag(0), "AccessControlEntryChanged", ItemType::kDefault }, 85 }, // AccessControl::AccessControlEntryChanged
  { { EventTag(1), "AccessControlExtensionChanged", ItemType::kDefault }, 86 }, // AccessControl::AccessControlExtensionChanged
};
...
const Entry<ItemInfo> _AccessControl_AccessControlEntryStruct[] = {
  { { ContextTag(1), "privilege", ItemType::kEnum }, 91 }, // AccessControl::AccessControlEntryPrivilegeEnum
  { { ContextTag(2), "authMode", ItemType::kEnum }, 90 }, // AccessControl::AccessControlEntryAuthModeEnum
  { { ContextTag(3), "subjects", ItemType::kList }, 1 }, // AccessControl::int64u[]
  { { ContextTag(4), "targets", ItemType::kList }, 89 }, // AccessControl::AccessControlTargetStruct[]
...
const Entry<ItemInfo> _AccessControl_AccessControlEntryChanged[] = {
  ...
  { { ContextTag(3), "changeType", ItemType::kEnum }, 92 }, // AccessControl::ChangeTypeEnum
  { { ContextTag(4), "latestValue", ItemType::kDefault }, 83 }, // AccessControl::AccessControlEntryStruct
  { { ContextTag(254), "fabricIndex", ItemType::kDefault }, kInvalidNodeIndex }, // AccessControl::fabric_idx
};
...
const Entry<ItemInfo> _AccessControl_AccessControlExtensionChanged[] = {
  ...
  { { ContextTag(2), "adminPasscodeID", ItemType::kDefault }, kInvalidNodeIndex }, // AccessControl::int16u
  { { ContextTag(3), "changeType", ItemType::kEnum }, 92 }, // AccessControl::ChangeTypeEnum
  { { ContextTag(4), "latestValue", ItemType::kDefault }, 84 }, // AccessControl::AccessControlExtensionStruct
  { { ContextTag(254), "fabricIndex", ItemType::kDefault }, kInvalidNodeIndex }, // AccessControl::fabric_idx
};

const Entry<ItemInfo> _AccessControl_AccessControlEntryStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 83 }, // AccessControl_AccessControlEntryStruct[]
};

const Entry<ItemInfo> _AccessControl_AccessControlExtensionStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 84 }, // AccessControl_AccessControlExtensionStruct[]
};

const Entry<ItemInfo> _AccessControl_AccessControlTargetStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 82 }, // AccessControl_AccessControlTargetStruct[]
};
...
const Entry<ItemInfo> _Actions[] = {
  { { AttributeTag(0), "actionList", ItemType::kList }, 111 }, // Actions::ActionStruct[]
  { { AttributeTag(1), "endpointLists", ItemType::kList }, 110 }, // Actions::EndpointListStruct[]
  ...
  { { EventTag(0), "StateChanged", ItemType::kDefault }, 108 }, // Actions::StateChanged
  { { EventTag(1), "ActionFailed", ItemType::kDefault }, 109 }, // Actions::ActionFailed
  { { CommandTag(0), "InstantAction", ItemType::kDefault }, 96 }, // Actions::InstantAction::InstantActionRequest
  { { CommandTag(1), "InstantActionWithTransition", ItemType::kDefault }, 97 }, // Actions::InstantActionWithTransition::InstantActionWithTransitionRequest
  { { CommandTag(2), "StartAction", ItemType::kDefault }, 98 }, // Actions::StartAction::StartActionRequest
  { { CommandTag(3), "StartActionWithDuration", ItemType::kDefault }, 99 }, // Actions::StartActionWithDuration::StartActionWithDurationRequest
  { { CommandTag(4), "StopAction", ItemType::kDefault }, 100 }, // Actions::StopAction::StopActionRequest
  { { CommandTag(5), "PauseAction", ItemType::kDefault }, 101 }, // Actions::PauseAction::PauseActionRequest
  { { CommandTag(6), "PauseActionWithDuration", ItemType::kDefault }, 102 }, // Actions::PauseActionWithDuration::PauseActionWithDurationRequest
  { { CommandTag(7), "ResumeAction", ItemType::kDefault }, 103 }, // Actions::ResumeAction::ResumeActionRequest
  { { CommandTag(8), "EnableAction", ItemType::kDefault }, 104 }, // Actions::EnableAction::EnableActionRequest
  { { CommandTag(9), "EnableActionWithDuration", ItemType::kDefault }, 105 }, // Actions::EnableActionWithDuration::EnableActionWithDurationRequest
  { { CommandTag(10), "DisableAction", ItemType::kDefault }, 106 }, // Actions::DisableAction::DisableActionRequest
  { { CommandTag(11), "DisableActionWithDuration", ItemType::kDefault }, 107 }, // Actions::DisableActionWithDuration::DisableActionWithDurationRequest
};
...
const Entry<ItemInfo> _Actions_ActionStruct[] = {
  ...
  { { ContextTag(2), "type", ItemType::kEnum }, 114 }, // Actions::ActionTypeEnum
  { { ContextTag(3), "endpointListID", ItemType::kDefault }, kInvalidNodeIndex }, // Actions::int16u
  { { ContextTag(4), "supportedCommands", ItemType::kBitmap }, 116 }, // Actions::CommandBits
  { { ContextTag(5), "state", ItemType::kEnum }, 113 }, // Actions::ActionStateEnum
};
...
const Entry<ItemInfo> _Actions_EndpointListStruct[] = {
  ...
  { { ContextTag(1), "name", ItemType::kDefault }, kInvalidNodeIndex }, // Actions::char_string
  { { ContextTag(2), "type", ItemType::kEnum }, 115 }, // Actions::EndpointListTypeEnum
...
const Entry<ItemInfo> _Actions_StateChanged[] = {
  { { ContextTag(0), "actionID", ItemType::kDefault }, kInvalidNodeIndex }, // Actions::int16u
  { { ContextTag(1), "invokeID", ItemType::kDefault }, kInvalidNodeIndex }, // Actions::int32u
  { { ContextTag(2), "newState", ItemType::kEnum }, 113 }, // Actions::ActionStateEnum
};
...
const Entry<ItemInfo> _Actions_ActionFailed[] = {
  ...
  { { ContextTag(1), "invokeID", ItemType::kDefault }, kInvalidNodeIndex }, // Actions::int32u
  { { ContextTag(2), "newState", ItemType::kEnum }, 113 }, // Actions::ActionStateEnum
  { { ContextTag(3), "error", ItemType::kEnum }, 112 }, // Actions::ActionErrorEnum
};

const Entry<ItemInfo> _Actions_EndpointListStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 95 }, // Actions_EndpointListStruct[]
};

const Entry<ItemInfo> _Actions_ActionStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 94 }, // Actions_ActionStruct[]
};
...
const Entry<ItemInfo> _BasicInformation[] = {
  ...
  { { AttributeTag(19), "capabilityMinima", ItemType::kDefault }, 118 }, // BasicInformation::CapabilityMinimaStruct
  { { AttributeTag(20), "productAppearance", ItemType::kDefault }, 119 }, // BasicInformation::ProductAppearanceStruct
  ...
  { { EventTag(0), "StartUp", ItemType::kDefault }, 120 }, // BasicInformation::StartUp
  { { EventTag(2), "Leave", ItemType::kDefault }, 121 }, // BasicInformation::Leave
  { { EventTag(3), "ReachableChanged", ItemType::kDefault }, 122 }, // BasicInformation::ReachableChanged
...
const Entry<ItemInfo> _BasicInformation_ProductAppearanceStruct[] = {
  { { ContextTag(0), "finish", ItemType::kEnum }, 124 }, // BasicInformation::ProductFinishEnum
  { { ContextTag(1), "primaryColor", ItemType::kEnum }, 123 }, // BasicInformation::ColorEnum
};
...
const Entry<ItemInfo> _OtaSoftwareUpdateProvider[] = {
  ...
  { { CommandTag(0), "QueryImage", ItemType::kDefault }, 126 }, // OtaSoftwareUpdateProvider::QueryImage::QueryImageRequest
  { { CommandTag(2), "ApplyUpdateRequest", ItemType::kDefault }, 128 }, // OtaSoftwareUpdateProvider::ApplyUpdateRequest::ApplyUpdateRequestRequest
  { { CommandTag(4), "NotifyUpdateApplied", ItemType::kDefault }, 130 }, // OtaSoftwareUpdateProvider::NotifyUpdateApplied::NotifyUpdateAppliedRequest
  { { CommandTag(1), "QueryImageResponse", ItemType::kDefault }, 127 }, // OtaSoftwareUpdateProvider::QueryImageResponse
  { { CommandTag(3), "ApplyUpdateResponse", ItemType::kDefault }, 129 }, // OtaSoftwareUpdateProvider::ApplyUpdateResponse
};
...
const Entry<ItemInfo> _OtaSoftwareUpdateProvider_QueryImageRequest[] = {
  ...
  { { ContextTag(3), "protocolsSupported", ItemType::kList }, 131 }, // OtaSoftwareUpdateProvider::DownloadProtocolEnum[]
...
const Entry<ItemInfo> _OtaSoftwareUpdateProvider_QueryImageResponse[] = {
  { { ContextTag(0), "status", ItemType::kEnum }, 134 }, // OtaSoftwareUpdateProvider::StatusEnum
...
const Entry<ItemInfo> _OtaSoftwareUpdateProvider_ApplyUpdateResponse[] = {
  { { ContextTag(0), "action", ItemType::kEnum }, 132 }, // OtaSoftwareUpdateProvider::ApplyUpdateActionEnum
  { { ContextTag(1), "delayedActionTime", ItemType::kDefault }, kInvalidNodeIndex }, // OtaSoftwareUpdateProvider::int32u
};
...
const Entry<ItemInfo> _OtaSoftwareUpdateProvider_DownloadProtocolEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 133 }, // OtaSoftwareUpdateProvider_DownloadProtocolEnum[]
};
...
const Entry<ItemInfo> _OtaSoftwareUpdateRequestor[] = {
  { { AttributeTag(0), "defaultOTAProviders", ItemType::kList }, 141 }, // OtaSoftwareUpdateRequestor::ProviderLocation[]
  { { AttributeTag(1), "updatePossible", ItemType::kDefault }, kInvalidNodeIndex }, // OtaSoftwareUpdateRequestor::boolean
  { { AttributeTag(2), "updateState", ItemType::kEnum }, 144 }, // OtaSoftwareUpdateRequestor::UpdateStateEnum
  ...
  { { EventTag(0), "StateTransition", ItemType::kDefault }, 138 }, // OtaSoftwareUpdateRequestor::StateTransition
  { { EventTag(1), "VersionApplied", ItemType::kDefault }, 139 }, // OtaSoftwareUpdateRequestor::VersionApplied
  { { EventTag(2), "DownloadError", ItemType::kDefault }, 140 }, // OtaSoftwareUpdateRequestor::DownloadError
  { { CommandTag(0), "AnnounceOTAProvider", ItemType::kDefault }, 137 }, // OtaSoftwareUpdateRequestor::AnnounceOTAProvider::AnnounceOTAProviderRequest
};
...
const Entry<ItemInfo> _OtaSoftwareUpdateRequestor_AnnounceOTAProviderRequest[] = {
  ...
  { { ContextTag(2), "announcementReason", ItemType::kEnum }, 142 }, // OtaSoftwareUpdateRequestor::AnnouncementReasonEnum
...
const Entry<ItemInfo> _OtaSoftwareUpdateRequestor_StateTransition[] = {
  { { ContextTag(0), "previousState", ItemType::kEnum }, 144 }, // OtaSoftwareUpdateRequestor::UpdateStateEnum
  { { ContextTag(1), "newState", ItemType::kEnum }, 144 }, // OtaSoftwareUpdateRequestor::UpdateStateEnum
  { { ContextTag(2), "reason", ItemType::kEnum }, 143 }, // OtaSoftwareUpdateRequestor::ChangeReasonEnum
...
const Entry<ItemInfo> _OtaSoftwareUpdateRequestor_ProviderLocation_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 136 }, // OtaSoftwareUpdateRequestor_ProviderLocation[]
};
...
const Entry<ItemInfo> _TimeFormatLocalization[] = {
  { { AttributeTag(0), "hourFormat", ItemType::kEnum }, 149 }, // TimeFormatLocalization::HourFormatEnum
  { { AttributeTag(1), "activeCalendarType", ItemType::kEnum }, 148 }, // TimeFormatLocalization::CalendarTypeEnum
  { { AttributeTag(2), "supportedCalendarTypes", ItemType::kList }, 147 }, // TimeFormatLocalization::CalendarTypeEnum[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 150 }, // TimeFormatLocalization::Feature
...
const Entry<ItemInfo> _TimeFormatLocalization_CalendarTypeEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 148 }, // TimeFormatLocalization_CalendarTypeEnum[]
};
...
const Entry<ItemInfo> _UnitLocalization[] = {
  { { AttributeTag(0), "temperatureUnit", ItemType::kEnum }, 152 }, // UnitLocalization::TempUnitEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 153 }, // UnitLocalization::Feature
...
const Entry<ItemInfo> _PowerSource[] = {
  { { AttributeTag(0), "status", ItemType::kEnum }, 172 }, // PowerSource::PowerSourceStatusEnum
  ...
  { { AttributeTag(5), "wiredCurrentType", ItemType::kEnum }, 173 }, // PowerSource::WiredCurrentTypeEnum
  ...
  { { AttributeTag(10), "activeWiredFaults", ItemType::kList }, 164 }, // PowerSource::WiredFaultEnum[]
  ...
  { { AttributeTag(14), "batChargeLevel", ItemType::kEnum }, 167 }, // PowerSource::BatChargeLevelEnum
  { { AttributeTag(15), "batReplacementNeeded", ItemType::kDefault }, kInvalidNodeIndex }, // PowerSource::boolean
  { { AttributeTag(16), "batReplaceability", ItemType::kEnum }, 171 }, // PowerSource::BatReplaceabilityEnum
  { { AttributeTag(17), "batPresent", ItemType::kDefault }, kInvalidNodeIndex }, // PowerSource::boolean
  { { AttributeTag(18), "activeBatFaults", ItemType::kList }, 162 }, // PowerSource::BatFaultEnum[]
  { { AttributeTag(19), "batReplacementDescription", ItemType::kDefault }, kInvalidNodeIndex }, // PowerSource::char_string
  { { AttributeTag(20), "batCommonDesignation", ItemType::kEnum }, 169 }, // PowerSource::BatCommonDesignationEnum
  ...
  { { AttributeTag(23), "batApprovedChemistry", ItemType::kEnum }, 165 }, // PowerSource::BatApprovedChemistryEnum
  ...
  { { AttributeTag(26), "batChargeState", ItemType::kEnum }, 168 }, // PowerSource::BatChargeStateEnum
  ...
  { { AttributeTag(30), "activeBatChargeFaults", ItemType::kList }, 163 }, // PowerSource::BatChargeFaultEnum[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 175 }, // PowerSource::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // PowerSource::int16u
  { { EventTag(0), "WiredFaultChange", ItemType::kDefault }, 159 }, // PowerSource::WiredFaultChange
  { { EventTag(1), "BatFaultChange", ItemType::kDefault }, 160 }, // PowerSource::BatFaultChange
  { { EventTag(2), "BatChargeFaultChange", ItemType::kDefault }, 161 }, // PowerSource::BatChargeFaultChange
};

const Entry<ItemInfo> _PowerSource_BatChargeFaultChangeType[] = {
  { { ContextTag(0), "current", ItemType::kList }, 163 }, // PowerSource::BatChargeFaultEnum[]
  { { ContextTag(1), "previous", ItemType::kList }, 163 }, // PowerSource::BatChargeFaultEnum[]
};

const Entry<ItemInfo> _PowerSource_BatFaultChangeType[] = {
  { { ContextTag(0), "current", ItemType::kList }, 162 }, // PowerSource::BatFaultEnum[]
  { { ContextTag(1), "previous", ItemType::kList }, 162 }, // PowerSource::BatFaultEnum[]
};

const Entry<ItemInfo> _PowerSource_WiredFaultChangeType[] = {
  { { ContextTag(0), "current", ItemType::kList }, 164 }, // PowerSource::WiredFaultEnum[]
  { { ContextTag(1), "previous", ItemType::kList }, 164 }, // PowerSource::WiredFaultEnum[]
};
...
const Entry<ItemInfo> _PowerSource_BatFaultEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 170 }, // PowerSource_BatFaultEnum[]
};

const Entry<ItemInfo> _PowerSource_BatChargeFaultEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 166 }, // PowerSource_BatChargeFaultEnum[]
};

const Entry<ItemInfo> _PowerSource_WiredFaultEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 174 }, // PowerSource_WiredFaultEnum[]
};
...
const Entry<ItemInfo> _GeneralCommissioning[] = {
  ...
  { { AttributeTag(1), "basicCommissioningInfo", ItemType::kDefault }, 177 }, // GeneralCommissioning::BasicCommissioningInfo
  { { AttributeTag(2), "regulatoryConfig", ItemType::kEnum }, 184 }, // GeneralCommissioning::RegulatoryLocationTypeEnum
  { { AttributeTag(3), "locationCapability", ItemType::kEnum }, 184 }, // GeneralCommissioning::RegulatoryLocationTypeEnum
  ...
  { { CommandTag(0), "ArmFailSafe", ItemType::kDefault }, 178 }, // GeneralCommissioning::ArmFailSafe::ArmFailSafeRequest
  { { CommandTag(2), "SetRegulatoryConfig", ItemType::kDefault }, 180 }, // GeneralCommissioning::SetRegulatoryConfig::SetRegulatoryConfigRequest
  { { CommandTag(4), "CommissioningComplete", ItemType::kDefault }, kInvalidNodeIndex }, // GeneralCommissioning::CommissioningComplete::()
  { { CommandTag(1), "ArmFailSafeResponse", ItemType::kDefault }, 179 }, // GeneralCommissioning::ArmFailSafeResponse
  { { CommandTag(3), "SetRegulatoryConfigResponse", ItemType::kDefault }, 181 }, // GeneralCommissioning::SetRegulatoryConfigResponse
  { { CommandTag(5), "CommissioningCompleteResponse", ItemType::kDefault }, 182 }, // GeneralCommissioning::CommissioningCompleteResponse
};
...
const Entry<ItemInfo> _GeneralCommissioning_ArmFailSafeResponse[] = {
  { { ContextTag(0), "errorCode", ItemType::kEnum }, 183 }, // GeneralCommissioning::CommissioningErrorEnum
...
const Entry<ItemInfo> _GeneralCommissioning_SetRegulatoryConfigRequest[] = {
  { { ContextTag(0), "newRegulatoryConfig", ItemType::kEnum }, 184 }, // GeneralCommissioning::RegulatoryLocationTypeEnum
...
const Entry<ItemInfo> _NetworkCommissioning[] = {
  ...
  { { AttributeTag(1), "networks", ItemType::kList }, 201 }, // NetworkCommissioning::NetworkInfoStruct[]
  ...
  { { AttributeTag(5), "lastNetworkingStatus", ItemType::kEnum }, 202 }, // NetworkCommissioning::NetworkCommissioningStatusEnum
  ...
  { { AttributeTag(8), "supportedWiFiBands", ItemType::kList }, 199 }, // NetworkCommissioning::WiFiBandEnum[]
  { { AttributeTag(9), "supportedThreadFeatures", ItemType::kBitmap }, 205 }, // NetworkCommissioning::ThreadCapabilitiesBitmap
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 204 }, // NetworkCommissioning::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // NetworkCommissioning::int16u
  { { CommandTag(0), "ScanNetworks", ItemType::kDefault }, 189 }, // NetworkCommissioning::ScanNetworks::ScanNetworksRequest
  { { CommandTag(2), "AddOrUpdateWiFiNetwork", ItemType::kDefault }, 191 }, // NetworkCommissioning::AddOrUpdateWiFiNetwork::AddOrUpdateWiFiNetworkRequest
  { { CommandTag(3), "AddOrUpdateThreadNetwork", ItemType::kDefault }, 192 }, // NetworkCommissioning::AddOrUpdateThreadNetwork::AddOrUpdateThreadNetworkRequest
  { { CommandTag(4), "RemoveNetwork", ItemType::kDefault }, 193 }, // NetworkCommissioning::RemoveNetwork::RemoveNetworkRequest
  { { CommandTag(6), "ConnectNetwork", ItemType::kDefault }, 195 }, // NetworkCommissioning::ConnectNetwork::ConnectNetworkRequest
  { { CommandTag(8), "ReorderNetwork", ItemType::kDefault }, 197 }, // NetworkCommissioning::ReorderNetwork::ReorderNetworkRequest
  { { CommandTag(1), "ScanNetworksResponse", ItemType::kDefault }, 190 }, // NetworkCommissioning::ScanNetworksResponse
  { { CommandTag(5), "NetworkConfigResponse", ItemType::kDefault }, 194 }, // NetworkCommissioning::NetworkConfigResponse
  { { CommandTag(7), "ConnectNetworkResponse", ItemType::kDefault }, 196 }, // NetworkCommissioning::ConnectNetworkResponse
};
...
const Entry<ItemInfo> _NetworkCommissioning_WiFiInterfaceScanResultStruct[] = {
  { { ContextTag(0), "security", ItemType::kBitmap }, 206 }, // NetworkCommissioning::WiFiSecurityBitmap
  ...
  { { ContextTag(3), "channel", ItemType::kDefault }, kInvalidNodeIndex }, // NetworkCommissioning::int16u
  { { ContextTag(4), "wiFiBand", ItemType::kEnum }, 203 }, // NetworkCommissioning::WiFiBandEnum
...
const Entry<ItemInfo> _NetworkCommissioning_ScanNetworksResponse[] = {
  { { ContextTag(0), "networkingStatus", ItemType::kEnum }, 202 }, // NetworkCommissioning::NetworkCommissioningStatusEnum
  { { ContextTag(1), "debugText", ItemType::kDefault }, kInvalidNodeIndex }, // NetworkCommissioning::char_string
  { { ContextTag(2), "wiFiScanResults", ItemType::kList }, 200 }, // NetworkCommissioning::WiFiInterfaceScanResultStruct[]
  { { ContextTag(3), "threadScanResults", ItemType::kList }, 198 }, // NetworkCommissioning::ThreadInterfaceScanResultStruct[]
};
...
const Entry<ItemInfo> _NetworkCommissioning_ThreadInterfaceScanResultStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 187 }, // NetworkCommissioning_ThreadInterfaceScanResultStruct[]
};

const Entry<ItemInfo> _NetworkCommissioning_WiFiBandEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 203 }, // NetworkCommissioning_WiFiBandEnum[]
};

const Entry<ItemInfo> _NetworkCommissioning_WiFiInterfaceScanResultStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 188 }, // NetworkCommissioning_WiFiInterfaceScanResultStruct[]
};

const Entry<ItemInfo> _NetworkCommissioning_NetworkInfoStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 186 }, // NetworkCommissioning_NetworkInfoStruct[]
};
...
const Entry<ItemInfo> _DiagnosticLogs[] = {
  ...
  { { CommandTag(0), "RetrieveLogsRequest", ItemType::kDefault }, 208 }, // DiagnosticLogs::RetrieveLogsRequest::RetrieveLogsRequestRequest
  { { CommandTag(1), "RetrieveLogsResponse", ItemType::kDefault }, 209 }, // DiagnosticLogs::RetrieveLogsResponse
};

const Entry<ItemInfo> _DiagnosticLogs_RetrieveLogsRequestRequest[] = {
  { { ContextTag(0), "intent", ItemType::kEnum }, 210 }, // DiagnosticLogs::IntentEnum
  { { ContextTag(1), "requestedProtocol", ItemType::kEnum }, 212 }, // DiagnosticLogs::TransferProtocolEnum
...
const Entry<ItemInfo> _DiagnosticLogs_RetrieveLogsResponse[] = {
  { { ContextTag(0), "status", ItemType::kEnum }, 211 }, // DiagnosticLogs::StatusEnum
...
const Entry<ItemInfo> _GeneralDiagnostics[] = {
  { { AttributeTag(0), "networkInterfaces", ItemType::kList }, 223 }, // GeneralDiagnostics::NetworkInterface[]
  ...
  { { AttributeTag(4), "bootReason", ItemType::kEnum }, 224 }, // GeneralDiagnostics::BootReasonEnum
  { { AttributeTag(5), "activeHardwareFaults", ItemType::kList }, 222 }, // GeneralDiagnostics::HardwareFaultEnum[]
  { { AttributeTag(6), "activeRadioFaults", ItemType::kList }, 221 }, // GeneralDiagnostics::RadioFaultEnum[]
  { { AttributeTag(7), "activeNetworkFaults", ItemType::kList }, 220 }, // GeneralDiagnostics::NetworkFaultEnum[]
  { { AttributeTag(8), "testEventTriggersEnabled", ItemType::kDefault }, kInvalidNodeIndex }, // GeneralDiagnostics::boolean
  { { AttributeTag(9), "averageWearCount", ItemType::kDefault }, kInvalidNodeIndex }, // GeneralDiagnostics::int32u
  ...
  { { EventTag(0), "HardwareFaultChange", ItemType::kDefault }, 216 }, // GeneralDiagnostics::HardwareFaultChange
  { { EventTag(1), "RadioFaultChange", ItemType::kDefault }, 217 }, // GeneralDiagnostics::RadioFaultChange
  { { EventTag(2), "NetworkFaultChange", ItemType::kDefault }, 218 }, // GeneralDiagnostics::NetworkFaultChange
  { { EventTag(3), "BootReason", ItemType::kDefault }, 219 }, // GeneralDiagnostics::BootReason
  { { CommandTag(0), "TestEventTrigger", ItemType::kDefault }, 215 }, // GeneralDiagnostics::TestEventTrigger::TestEventTriggerRequest
};
...
const Entry<ItemInfo> _GeneralDiagnostics_NetworkInterface[] = {
  ...
  { { ContextTag(7), "type", ItemType::kEnum }, 226 }, // GeneralDiagnostics::InterfaceTypeEnum
};
...
const Entry<ItemInfo> _GeneralDiagnostics_HardwareFaultChange[] = {
  { { ContextTag(0), "current", ItemType::kList }, 222 }, // GeneralDiagnostics::HardwareFaultEnum[]
  { { ContextTag(1), "previous", ItemType::kList }, 222 }, // GeneralDiagnostics::HardwareFaultEnum[]
};
...
const Entry<ItemInfo> _GeneralDiagnostics_NetworkFaultChange[] = {
  { { ContextTag(0), "current", ItemType::kList }, 220 }, // GeneralDiagnostics::NetworkFaultEnum[]
  { { ContextTag(1), "previous", ItemType::kList }, 220 }, // GeneralDiagnostics::NetworkFaultEnum[]
};

const Entry<ItemInfo> _GeneralDiagnostics_BootReason[] = {
  { { ContextTag(0), "bootReason", ItemType::kEnum }, 224 }, // GeneralDiagnostics::BootReasonEnum
};

const Entry<ItemInfo> _GeneralDiagnostics_NetworkFaultEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 227 }, // GeneralDiagnostics_NetworkFaultEnum[]
};

const Entry<ItemInfo> _GeneralDiagnostics_RadioFaultEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 228 }, // GeneralDiagnostics_RadioFaultEnum[]
};

const Entry<ItemInfo> _GeneralDiagnostics_HardwareFaultEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 225 }, // GeneralDiagnostics_HardwareFaultEnum[]
};

const Entry<ItemInfo> _GeneralDiagnostics_NetworkInterface_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 214 }, // GeneralDiagnostics_NetworkInterface[]
};
...
const Entry<ItemInfo> _SoftwareDiagnostics[] = {
  { { AttributeTag(0), "threadMetrics", ItemType::kList }, 232 }, // SoftwareDiagnostics::ThreadMetricsStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 233 }, // SoftwareDiagnostics::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // SoftwareDiagnostics::int16u
  { { EventTag(0), "SoftwareFault", ItemType::kDefault }, 231 }, // SoftwareDiagnostics::SoftwareFault
...
const Entry<ItemInfo> _SoftwareDiagnostics_ThreadMetricsStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 230 }, // SoftwareDiagnostics_ThreadMetricsStruct[]
};
...
const Entry<ItemInfo> _ThreadNetworkDiagnostics[] = {
  ...
  { { AttributeTag(1), "routingRole", ItemType::kEnum }, 246 }, // ThreadNetworkDiagnostics::RoutingRoleEnum
  ...
  { { AttributeTag(8), "routeTable", ItemType::kList }, 243 }, // ThreadNetworkDiagnostics::RouteTableStruct[]
  ...
  { { AttributeTag(59), "securityPolicy", ItemType::kDefault }, 238 }, // ThreadNetworkDiagnostics::SecurityPolicy
  { { AttributeTag(60), "channelPage0Mask", ItemType::kDefault }, kInvalidNodeIndex }, // ThreadNetworkDiagnostics::octet_string
  { { AttributeTag(61), "operationalDatasetComponents", ItemType::kDefault }, 236 }, // ThreadNetworkDiagnostics::OperationalDatasetComponents
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 247 }, // ThreadNetworkDiagnostics::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // ThreadNetworkDiagnostics::int16u
  { { EventTag(0), "ConnectionStatus", ItemType::kDefault }, 239 }, // ThreadNetworkDiagnostics::ConnectionStatus
  { { EventTag(1), "NetworkFaultChange", ItemType::kDefault }, 240 }, // ThreadNetworkDiagnostics::NetworkFaultChange
...
const Entry<ItemInfo> _ThreadNetworkDiagnostics_ConnectionStatus[] = {
  { { ContextTag(0), "connectionStatus", ItemType::kEnum }, 244 }, // ThreadNetworkDiagnostics::ConnectionStatusEnum
};
...
const Entry<ItemInfo> _ThreadNetworkDiagnostics_NetworkFaultEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 245 }, // ThreadNetworkDiagnostics_NetworkFaultEnum[]
};

const Entry<ItemInfo> _ThreadNetworkDiagnostics_NeighborTableStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 235 }, // ThreadNetworkDiagnostics_NeighborTableStruct[]
};

const Entry<ItemInfo> _ThreadNetworkDiagnostics_RouteTableStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 237 }, // ThreadNetworkDiagnostics_RouteTableStruct[]
};
...
const Entry<ItemInfo> _WiFiNetworkDiagnostics[] = {
  ...
  { { AttributeTag(1), "securityType", ItemType::kEnum }, 254 }, // WiFiNetworkDiagnostics::SecurityTypeEnum
  { { AttributeTag(2), "wiFiVersion", ItemType::kEnum }, 255 }, // WiFiNetworkDiagnostics::WiFiVersionEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 256 }, // WiFiNetworkDiagnostics::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // WiFiNetworkDiagnostics::int16u
  { { EventTag(0), "Disconnection", ItemType::kDefault }, 249 }, // WiFiNetworkDiagnostics::Disconnection
  { { EventTag(1), "AssociationFailure", ItemType::kDefault }, 250 }, // WiFiNetworkDiagnostics::AssociationFailure
  { { EventTag(2), "ConnectionStatus", ItemType::kDefault }, 251 }, // WiFiNetworkDiagnostics::ConnectionStatus
...
const Entry<ItemInfo> _WiFiNetworkDiagnostics_AssociationFailure[] = {
  { { ContextTag(0), "associationFailure", ItemType::kEnum }, 252 }, // WiFiNetworkDiagnostics::AssociationFailureCauseEnum
...
const Entry<ItemInfo> _WiFiNetworkDiagnostics_ConnectionStatus[] = {
  { { ContextTag(0), "connectionStatus", ItemType::kEnum }, 253 }, // WiFiNetworkDiagnostics::ConnectionStatusEnum
};
...
const Entry<ItemInfo> _EthernetNetworkDiagnostics[] = {
  { { AttributeTag(0), "PHYRate", ItemType::kEnum }, 258 }, // EthernetNetworkDiagnostics::PHYRateEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 259 }, // EthernetNetworkDiagnostics::Feature
...
const Entry<ItemInfo> _TimeSynchronization[] = {
  ...
  { { AttributeTag(1), "granularity", ItemType::kEnum }, 275 }, // TimeSynchronization::GranularityEnum
  { { AttributeTag(2), "timeSource", ItemType::kEnum }, 277 }, // TimeSynchronization::TimeSourceEnum
  { { AttributeTag(3), "trustedTimeSource", ItemType::kDefault }, 264 }, // TimeSynchronization::TrustedTimeSourceStruct
  { { AttributeTag(4), "defaultNTP", ItemType::kDefault }, kInvalidNodeIndex }, // TimeSynchronization::char_string
  { { AttributeTag(5), "timeZone", ItemType::kList }, 274 }, // TimeSynchronization::TimeZoneStruct[]
  { { AttributeTag(6), "DSTOffset", ItemType::kList }, 273 }, // TimeSynchronization::DSTOffsetStruct[]
  { { AttributeTag(7), "localTime", ItemType::kDefault }, kInvalidNodeIndex }, // TimeSynchronization::epoch_us
  { { AttributeTag(8), "timeZoneDatabase", ItemType::kEnum }, 278 }, // TimeSynchronization::TimeZoneDatabaseEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 279 }, // TimeSynchronization::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // TimeSynchronization::int16u
  { { EventTag(1), "DSTStatus", ItemType::kDefault }, 271 }, // TimeSynchronization::DSTStatus
  { { EventTag(2), "TimeZoneStatus", ItemType::kDefault }, 272 }, // TimeSynchronization::TimeZoneStatus
  { { CommandTag(0), "SetUTCTime", ItemType::kDefault }, 265 }, // TimeSynchronization::SetUTCTime::SetUTCTimeRequest
  { { CommandTag(1), "SetTrustedTimeSource", ItemType::kDefault }, 266 }, // TimeSynchronization::SetTrustedTimeSource::SetTrustedTimeSourceRequest
  { { CommandTag(2), "SetTimeZone", ItemType::kDefault }, 267 }, // TimeSynchronization::SetTimeZone::SetTimeZoneRequest
  { { CommandTag(4), "SetDSTOffset", ItemType::kDefault }, 269 }, // TimeSynchronization::SetDSTOffset::SetDSTOffsetRequest
  { { CommandTag(5), "SetDefaultNTP", ItemType::kDefault }, 270 }, // TimeSynchronization::SetDefaultNTP::SetDefaultNTPRequest
  { { CommandTag(3), "SetTimeZoneResponse", ItemType::kDefault }, 268 }, // TimeSynchronization::SetTimeZoneResponse
};
...
const Entry<ItemInfo> _TimeSynchronization_SetUTCTimeRequest[] = {
  ...
  { { ContextTag(1), "granularity", ItemType::kEnum }, 275 }, // TimeSynchronization::GranularityEnum
  { { ContextTag(2), "timeSource", ItemType::kEnum }, 277 }, // TimeSynchronization::TimeSourceEnum
};

const Entry<ItemInfo> _TimeSynchronization_SetTrustedTimeSourceRequest[] = {
  { { ContextTag(0), "trustedTimeSource", ItemType::kDefault }, 262 }, // TimeSynchronization::FabricScopedTrustedTimeSourceStruct
};

const Entry<ItemInfo> _TimeSynchronization_SetTimeZoneRequest[] = {
  { { ContextTag(0), "timeZone", ItemType::kList }, 274 }, // TimeSynchronization::TimeZoneStruct[]
};
...
const Entry<ItemInfo> _TimeSynchronization_SetDSTOffsetRequest[] = {
  { { ContextTag(0), "DSTOffset", ItemType::kList }, 273 }, // TimeSynchronization::DSTOffsetStruct[]
};
...
const Entry<ItemInfo> _TimeSynchronization_DSTOffsetStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 261 }, // TimeSynchronization_DSTOffsetStruct[]
};

const Entry<ItemInfo> _TimeSynchronization_TimeZoneStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 263 }, // TimeSynchronization_TimeZoneStruct[]
};
...
const Entry<ItemInfo> _BridgedDeviceBasicInformation[] = {
  ...
  { { AttributeTag(20), "productAppearance", ItemType::kDefault }, 281 }, // BridgedDeviceBasicInformation::ProductAppearanceStruct
  ...
  { { EventTag(0), "StartUp", ItemType::kDefault }, 282 }, // BridgedDeviceBasicInformation::StartUp
  { { EventTag(3), "ReachableChanged", ItemType::kDefault }, 283 }, // BridgedDeviceBasicInformation::ReachableChanged
};

const Entry<ItemInfo> _BridgedDeviceBasicInformation_ProductAppearanceStruct[] = {
  { { ContextTag(0), "finish", ItemType::kEnum }, 285 }, // BridgedDeviceBasicInformation::ProductFinishEnum
  { { ContextTag(1), "primaryColor", ItemType::kEnum }, 284 }, // BridgedDeviceBasicInformation::ColorEnum
};
...
const Entry<ItemInfo> _Switch[] = {
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 294 }, // Switch::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // Switch::int16u
  { { EventTag(0), "SwitchLatched", ItemType::kDefault }, 287 }, // Switch::SwitchLatched
  { { EventTag(1), "InitialPress", ItemType::kDefault }, 288 }, // Switch::InitialPress
  { { EventTag(2), "LongPress", ItemType::kDefault }, 289 }, // Switch::LongPress
  { { EventTag(3), "ShortRelease", ItemType::kDefault }, 290 }, // Switch::ShortRelease
  { { EventTag(4), "LongRelease", ItemType::kDefault }, 291 }, // Switch::LongRelease
  { { EventTag(5), "MultiPressOngoing", ItemType::kDefault }, 292 }, // Switch::MultiPressOngoing
  { { EventTag(6), "MultiPressComplete", ItemType::kDefault }, 293 }, // Switch::MultiPressComplete
};
...
const Entry<ItemInfo> _AdministratorCommissioning[] = {
  { { AttributeTag(0), "windowStatus", ItemType::kEnum }, 298 }, // AdministratorCommissioning::CommissioningWindowStatusEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 300 }, // AdministratorCommissioning::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // AdministratorCommissioning::int16u
  { { CommandTag(0), "OpenCommissioningWindow", ItemType::kDefault }, 296 }, // AdministratorCommissioning::OpenCommissioningWindow::OpenCommissioningWindowRequest
  { { CommandTag(1), "OpenBasicCommissioningWindow", ItemType::kDefault }, 297 }, // AdministratorCommissioning::OpenBasicCommissioningWindow::OpenBasicCommissioningWindowRequest
...
const Entry<ItemInfo> _OperationalCredentials[] = {
  { { AttributeTag(0), "NOCs", ItemType::kList }, 316 }, // OperationalCredentials::NOCStruct[]
  { { AttributeTag(1), "fabrics", ItemType::kList }, 317 }, // OperationalCredentials::FabricDescriptorStruct[]
  ...
  { { CommandTag(0), "AttestationRequest", ItemType::kDefault }, 304 }, // OperationalCredentials::AttestationRequest::AttestationRequestRequest
  { { CommandTag(2), "CertificateChainRequest", ItemType::kDefault }, 306 }, // OperationalCredentials::CertificateChainRequest::CertificateChainRequestRequest
  { { CommandTag(4), "CSRRequest", ItemType::kDefault }, 308 }, // OperationalCredentials::CSRRequest::CSRRequestRequest
  { { CommandTag(6), "AddNOC", ItemType::kDefault }, 310 }, // OperationalCredentials::AddNOC::AddNOCRequest
  { { CommandTag(7), "UpdateNOC", ItemType::kDefault }, 311 }, // OperationalCredentials::UpdateNOC::UpdateNOCRequest
  { { CommandTag(9), "UpdateFabricLabel", ItemType::kDefault }, 313 }, // OperationalCredentials::UpdateFabricLabel::UpdateFabricLabelRequest
  { { CommandTag(10), "RemoveFabric", ItemType::kDefault }, 314 }, // OperationalCredentials::RemoveFabric::RemoveFabricRequest
  { { CommandTag(11), "AddTrustedRootCertificate", ItemType::kDefault }, 315 }, // OperationalCredentials::AddTrustedRootCertificate::AddTrustedRootCertificateRequest
  { { CommandTag(1), "AttestationResponse", ItemType::kDefault }, 305 }, // OperationalCredentials::AttestationResponse
  { { CommandTag(3), "CertificateChainResponse", ItemType::kDefault }, 307 }, // OperationalCredentials::CertificateChainResponse
  { { CommandTag(5), "CSRResponse", ItemType::kDefault }, 309 }, // OperationalCredentials::CSRResponse
  { { CommandTag(8), "NOCResponse", ItemType::kDefault }, 312 }, // OperationalCredentials::NOCResponse
};
...
const Entry<ItemInfo> _OperationalCredentials_CertificateChainRequestRequest[] = {
  { { ContextTag(0), "certificateType", ItemType::kEnum }, 318 }, // OperationalCredentials::CertificateChainTypeEnum
};
...
const Entry<ItemInfo> _OperationalCredentials_NOCResponse[] = {
  { { ContextTag(0), "statusCode", ItemType::kEnum }, 319 }, // OperationalCredentials::NodeOperationalCertStatusEnum
...
const Entry<ItemInfo> _OperationalCredentials_NOCStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 303 }, // OperationalCredentials_NOCStruct[]
};

const Entry<ItemInfo> _OperationalCredentials_FabricDescriptorStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 302 }, // OperationalCredentials_FabricDescriptorStruct[]
};
...
const Entry<ItemInfo> _GroupKeyManagement[] = {
  { { AttributeTag(0), "groupKeyMap", ItemType::kList }, 329 }, // GroupKeyManagement::GroupKeyMapStruct[]
  { { AttributeTag(1), "groupTable", ItemType::kList }, 330 }, // GroupKeyManagement::GroupInfoMapStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 332 }, // GroupKeyManagement::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // GroupKeyManagement::int16u
  { { CommandTag(0), "KeySetWrite", ItemType::kDefault }, 324 }, // GroupKeyManagement::KeySetWrite::KeySetWriteRequest
  { { CommandTag(1), "KeySetRead", ItemType::kDefault }, 325 }, // GroupKeyManagement::KeySetRead::KeySetReadRequest
  { { CommandTag(3), "KeySetRemove", ItemType::kDefault }, 327 }, // GroupKeyManagement::KeySetRemove::KeySetRemoveRequest
  { { CommandTag(4), "KeySetReadAllIndices", ItemType::kDefault }, kInvalidNodeIndex }, // GroupKeyManagement::KeySetReadAllIndices::()
  { { CommandTag(2), "KeySetReadResponse", ItemType::kDefault }, 326 }, // GroupKeyManagement::KeySetReadResponse
  { { CommandTag(5), "KeySetReadAllIndicesResponse", ItemType::kDefault }, 328 }, // GroupKeyManagement::KeySetReadAllIndicesResponse
};
...
const Entry<ItemInfo> _GroupKeyManagement_GroupKeySetStruct[] = {
  ...
  { { ContextTag(1), "groupKeySecurityPolicy", ItemType::kEnum }, 331 }, // GroupKeyManagement::GroupKeySecurityPolicyEnum
...
const Entry<ItemInfo> _GroupKeyManagement_KeySetWriteRequest[] = {
  { { ContextTag(0), "groupKeySet", ItemType::kDefault }, 323 }, // GroupKeyManagement::GroupKeySetStruct
};
...
const Entry<ItemInfo> _GroupKeyManagement_GroupKeyMapStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 322 }, // GroupKeyManagement_GroupKeyMapStruct[]
};

const Entry<ItemInfo> _GroupKeyManagement_GroupInfoMapStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 321 }, // GroupKeyManagement_GroupInfoMapStruct[]
};
...
const Entry<ItemInfo> _FixedLabel[] = {
  { { AttributeTag(0), "labelList", ItemType::kList }, 335 }, // FixedLabel::LabelStruct[]
...
const Entry<ItemInfo> _FixedLabel_LabelStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 334 }, // FixedLabel_LabelStruct[]
};

const Entry<ItemInfo> _UserLabel[] = {
  { { AttributeTag(0), "labelList", ItemType::kList }, 338 }, // UserLabel::LabelStruct[]
...
const Entry<ItemInfo> _UserLabel_LabelStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 337 }, // UserLabel_LabelStruct[]
};
...
const Entry<ItemInfo> _BooleanState[] = {
  ...
  { { EventTag(0), "StateChange", ItemType::kDefault }, 343 }, // BooleanState::StateChange
};
...
const Entry<ItemInfo> _IcdManagement[] = {
  ...
  { { AttributeTag(3), "registeredClients", ItemType::kList }, 349 }, // IcdManagement::MonitoringRegistrationStruct[]
  ...
  { { AttributeTag(6), "userActiveModeTriggerHint", ItemType::kBitmap }, 351 }, // IcdManagement::UserActiveModeTriggerBitmap
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 350 }, // IcdManagement::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // IcdManagement::int16u
  { { CommandTag(0), "RegisterClient", ItemType::kDefault }, 346 }, // IcdManagement::RegisterClient::RegisterClientRequest
  { { CommandTag(2), "UnregisterClient", ItemType::kDefault }, 348 }, // IcdManagement::UnregisterClient::UnregisterClientRequest
  { { CommandTag(3), "StayActiveRequest", ItemType::kDefault }, kInvalidNodeIndex }, // IcdManagement::StayActiveRequest::()
  { { CommandTag(1), "RegisterClientResponse", ItemType::kDefault }, 347 }, // IcdManagement::RegisterClientResponse
};
...
const Entry<ItemInfo> _IcdManagement_MonitoringRegistrationStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 345 }, // IcdManagement_MonitoringRegistrationStruct[]
};
...
const Entry<ItemInfo> _ModeSelect[] = {
  ...
  { { AttributeTag(2), "supportedModes", ItemType::kList }, 357 }, // ModeSelect::ModeOptionStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 358 }, // ModeSelect::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // ModeSelect::int16u
  { { CommandTag(0), "ChangeToMode", ItemType::kDefault }, 355 }, // ModeSelect::ChangeToMode::ChangeToModeRequest
};
...
const Entry<ItemInfo> _ModeSelect_ModeOptionStruct[] = {
  ...
  { { ContextTag(2), "semanticTags", ItemType::kList }, 356 }, // ModeSelect::SemanticTagStruct[]
};
...
const Entry<ItemInfo> _ModeSelect_SemanticTagStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 353 }, // ModeSelect_SemanticTagStruct[]
};

const Entry<ItemInfo> _ModeSelect_ModeOptionStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 354 }, // ModeSelect_ModeOptionStruct[]
};
...
const Entry<ItemInfo> _LaundryWasherMode[] = {
  { { AttributeTag(0), "supportedModes", ItemType::kList }, 364 }, // LaundryWasherMode::ModeOptionStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 367 }, // LaundryWasherMode::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // LaundryWasherMode::int16u
  { { CommandTag(0), "ChangeToMode", ItemType::kDefault }, 362 }, // LaundryWasherMode::ChangeToMode::ChangeToModeRequest
  { { CommandTag(1), "ChangeToModeResponse", ItemType::kDefault }, 363 }, // LaundryWasherMode::ChangeToModeResponse
};
...
const Entry<ItemInfo> _LaundryWasherMode_ModeOptionStruct[] = {
  ...
  { { ContextTag(2), "modeTags", ItemType::kList }, 365 }, // LaundryWasherMode::ModeTagStruct[]
};
...
const Entry<ItemInfo> _LaundryWasherMode_ModeOptionStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 361 }, // LaundryWasherMode_ModeOptionStruct[]
};

const Entry<ItemInfo> _LaundryWasherMode_ModeTagStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 360 }, // LaundryWasherMode_ModeTagStruct[]
};
...
const Entry<ItemInfo> _RefrigeratorAndTemperatureControlledCabinetMode[] = {
  { { AttributeTag(0), "supportedModes", ItemType::kList }, 373 }, // RefrigeratorAndTemperatureControlledCabinetMode::ModeOptionStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 376 }, // RefrigeratorAndTemperatureControlledCabinetMode::Feature
  ...
  { { CommandTag(0), "ChangeToMode", ItemType::kDefault }, 371 }, // RefrigeratorAndTemperatureControlledCabinetMode::ChangeToMode::ChangeToModeRequest
  { { CommandTag(1), "ChangeToModeResponse", ItemType::kDefault }, 372 }, // RefrigeratorAndTemperatureControlledCabinetMode::ChangeToModeResponse
};
...
const Entry<ItemInfo> _RefrigeratorAndTemperatureControlledCabinetMode_ModeOptionStruct[] = {
  ...
  { { ContextTag(2), "modeTags", ItemType::kList }, 374 }, // RefrigeratorAndTemperatureControlledCabinetMode::ModeTagStruct[]
};
...
const Entry<ItemInfo> _RefrigeratorAndTemperatureControlledCabinetMode_ModeOptionStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 370 }, // RefrigeratorAndTemperatureControlledCabinetMode_ModeOptionStruct[]
};

const Entry<ItemInfo> _RefrigeratorAndTemperatureControlledCabinetMode_ModeTagStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 369 }, // RefrigeratorAndTemperatureControlledCabinetMode_ModeTagStruct[]
};
...
const Entry<ItemInfo> _LaundryWasherControls[] = {
  ...
  { { AttributeTag(2), "numberOfRinses", ItemType::kEnum }, 379 }, // LaundryWasherControls::NumberOfRinsesEnum
  { { AttributeTag(3), "supportedRinses", ItemType::kList }, 378 }, // LaundryWasherControls::NumberOfRinsesEnum[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 380 }, // LaundryWasherControls::Feature
...
const Entry<ItemInfo> _LaundryWasherControls_NumberOfRinsesEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 379 }, // LaundryWasherControls_NumberOfRinsesEnum[]
};
...
const Entry<ItemInfo> _RvcRunMode[] = {
  { { AttributeTag(0), "supportedModes", ItemType::kList }, 386 }, // RvcRunMode::ModeOptionStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 390 }, // RvcRunMode::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // RvcRunMode::int16u
  { { CommandTag(0), "ChangeToMode", ItemType::kDefault }, 384 }, // RvcRunMode::ChangeToMode::ChangeToModeRequest
  { { CommandTag(1), "ChangeToModeResponse", ItemType::kDefault }, 385 }, // RvcRunMode::ChangeToModeResponse
};
...
const Entry<ItemInfo> _RvcRunMode_ModeOptionStruct[] = {
  ...
  { { ContextTag(2), "modeTags", ItemType::kList }, 387 }, // RvcRunMode::ModeTagStruct[]
};
...
const Entry<ItemInfo> _RvcRunMode_ModeOptionStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 383 }, // RvcRunMode_ModeOptionStruct[]
};

const Entry<ItemInfo> _RvcRunMode_ModeTagStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 382 }, // RvcRunMode_ModeTagStruct[]
};
...
const Entry<ItemInfo> _RvcCleanMode[] = {
  { { AttributeTag(0), "supportedModes", ItemType::kList }, 396 }, // RvcCleanMode::ModeOptionStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 400 }, // RvcCleanMode::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // RvcCleanMode::int16u
  { { CommandTag(0), "ChangeToMode", ItemType::kDefault }, 394 }, // RvcCleanMode::ChangeToMode::ChangeToModeRequest
  { { CommandTag(1), "ChangeToModeResponse", ItemType::kDefault }, 395 }, // RvcCleanMode::ChangeToModeResponse
};
...
const Entry<ItemInfo> _RvcCleanMode_ModeOptionStruct[] = {
  ...
  { { ContextTag(2), "modeTags", ItemType::kList }, 397 }, // RvcCleanMode::ModeTagStruct[]
};
...
const Entry<ItemInfo> _RvcCleanMode_ModeOptionStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 393 }, // RvcCleanMode_ModeOptionStruct[]
};

const Entry<ItemInfo> _RvcCleanMode_ModeTagStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 392 }, // RvcCleanMode_ModeTagStruct[]
};
...
const Entry<ItemInfo> _TemperatureControl[] = {
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 403 }, // TemperatureControl::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // TemperatureControl::int16u
  { { CommandTag(0), "SetTemperature", ItemType::kDefault }, 402 }, // TemperatureControl::SetTemperature::SetTemperatureRequest
};
...
const Entry<ItemInfo> _RefrigeratorAlarm[] = {
  { { AttributeTag(0), "mask", ItemType::kBitmap }, 406 }, // RefrigeratorAlarm::AlarmMap
  { { AttributeTag(2), "state", ItemType::kBitmap }, 406 }, // RefrigeratorAlarm::AlarmMap
  { { AttributeTag(3), "supported", ItemType::kBitmap }, 406 }, // RefrigeratorAlarm::AlarmMap
  ...
  { { EventTag(0), "Notify", ItemType::kDefault }, 405 }, // RefrigeratorAlarm::Notify
};

const Entry<ItemInfo> _RefrigeratorAlarm_Notify[] = {
  { { ContextTag(0), "active", ItemType::kBitmap }, 406 }, // RefrigeratorAlarm::AlarmMap
  { { ContextTag(1), "inactive", ItemType::kBitmap }, 406 }, // RefrigeratorAlarm::AlarmMap
  { { ContextTag(2), "state", ItemType::kBitmap }, 406 }, // RefrigeratorAlarm::AlarmMap
  { { ContextTag(3), "mask", ItemType::kBitmap }, 406 }, // RefrigeratorAlarm::AlarmMap
};
...
const Entry<ItemInfo> _DishwasherMode[] = {
  { { AttributeTag(0), "supportedModes", ItemType::kList }, 413 }, // DishwasherMode::ModeOptionStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 415 }, // DishwasherMode::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // DishwasherMode::int16u
  { { CommandTag(0), "ChangeToMode", ItemType::kDefault }, 410 }, // DishwasherMode::ChangeToMode::ChangeToModeRequest
  { { CommandTag(1), "ChangeToModeResponse", ItemType::kDefault }, 411 }, // DishwasherMode::ChangeToModeResponse
};
...
const Entry<ItemInfo> _DishwasherMode_ModeOptionStruct[] = {
  ...
  { { ContextTag(2), "modeTags", ItemType::kList }, 412 }, // DishwasherMode::ModeTagStruct[]
};
...
const Entry<ItemInfo> _DishwasherMode_ModeTagStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 408 }, // DishwasherMode_ModeTagStruct[]
};

const Entry<ItemInfo> _DishwasherMode_ModeOptionStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 409 }, // DishwasherMode_ModeOptionStruct[]
};
...
const Entry<ItemInfo> _AirQuality[] = {
  { { AttributeTag(0), "airQuality", ItemType::kEnum }, 417 }, // AirQuality::AirQualityEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 418 }, // AirQuality::Feature
...
const Entry<ItemInfo> _SmokeCoAlarm[] = {
  { { AttributeTag(0), "expressedState", ItemType::kEnum }, 428 }, // SmokeCoAlarm::ExpressedStateEnum
  { { AttributeTag(1), "smokeState", ItemType::kEnum }, 425 }, // SmokeCoAlarm::AlarmStateEnum
  { { AttributeTag(2), "COState", ItemType::kEnum }, 425 }, // SmokeCoAlarm::AlarmStateEnum
  { { AttributeTag(3), "batteryAlert", ItemType::kEnum }, 425 }, // SmokeCoAlarm::AlarmStateEnum
  { { AttributeTag(4), "deviceMuted", ItemType::kEnum }, 429 }, // SmokeCoAlarm::MuteStateEnum
  ...
  { { AttributeTag(7), "endOfServiceAlert", ItemType::kEnum }, 427 }, // SmokeCoAlarm::EndOfServiceEnum
  { { AttributeTag(8), "interconnectSmokeAlarm", ItemType::kEnum }, 425 }, // SmokeCoAlarm::AlarmStateEnum
  { { AttributeTag(9), "interconnectCOAlarm", ItemType::kEnum }, 425 }, // SmokeCoAlarm::AlarmStateEnum
  { { AttributeTag(10), "contaminationState", ItemType::kEnum }, 426 }, // SmokeCoAlarm::ContaminationStateEnum
  { { AttributeTag(11), "smokeSensitivityLevel", ItemType::kEnum }, 430 }, // SmokeCoAlarm::SensitivityEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 431 }, // SmokeCoAlarm::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // SmokeCoAlarm::int16u
  { { EventTag(0), "SmokeAlarm", ItemType::kDefault }, 420 }, // SmokeCoAlarm::SmokeAlarm
  { { EventTag(1), "COAlarm", ItemType::kDefault }, 421 }, // SmokeCoAlarm::COAlarm
  { { EventTag(2), "LowBattery", ItemType::kDefault }, 422 }, // SmokeCoAlarm::LowBattery
  { { EventTag(8), "InterconnectSmokeAlarm", ItemType::kDefault }, 423 }, // SmokeCoAlarm::InterconnectSmokeAlarm
  { { EventTag(9), "InterconnectCOAlarm", ItemType::kDefault }, 424 }, // SmokeCoAlarm::InterconnectCOAlarm
...
const Entry<ItemInfo> _SmokeCoAlarm_SmokeAlarm[] = {
  { { ContextTag(0), "alarmSeverityLevel", ItemType::kEnum }, 425 }, // SmokeCoAlarm::AlarmStateEnum
};
...
const Entry<ItemInfo> _DishwasherAlarm[] = {
  { { AttributeTag(0), "mask", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
  { { AttributeTag(1), "latch", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
  { { AttributeTag(2), "state", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
  { { AttributeTag(3), "supported", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 437 }, // DishwasherAlarm::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // DishwasherAlarm::int16u
  { { EventTag(0), "Notify", ItemType::kDefault }, 435 }, // DishwasherAlarm::Notify
  { { CommandTag(0), "Reset", ItemType::kDefault }, 433 }, // DishwasherAlarm::Reset::ResetRequest
  { { CommandTag(1), "ModifyEnabledAlarms", ItemType::kDefault }, 434 }, // DishwasherAlarm::ModifyEnabledAlarms::ModifyEnabledAlarmsRequest
};

const Entry<ItemInfo> _DishwasherAlarm_ResetRequest[] = {
  { { ContextTag(0), "alarms", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
};

const Entry<ItemInfo> _DishwasherAlarm_ModifyEnabledAlarmsRequest[] = {
  { { ContextTag(0), "mask", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
};

const Entry<ItemInfo> _DishwasherAlarm_Notify[] = {
  { { ContextTag(0), "active", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
  { { ContextTag(1), "inactive", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
  { { ContextTag(2), "state", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
  { { ContextTag(3), "mask", ItemType::kBitmap }, 436 }, // DishwasherAlarm::AlarmMap
};
...
const Entry<ItemInfo> _OperationalState[] = {
  ...
  { { AttributeTag(3), "operationalStateList", ItemType::kList }, 444 }, // OperationalState::OperationalStateStruct[]
  { { AttributeTag(4), "operationalState", ItemType::kEnum }, 446 }, // OperationalState::OperationalStateEnum
  { { AttributeTag(5), "operationalError", ItemType::kDefault }, 439 }, // OperationalState::ErrorStateStruct
  ...
  { { EventTag(0), "OperationalError", ItemType::kDefault }, 442 }, // OperationalState::OperationalError
  { { EventTag(1), "OperationCompletion", ItemType::kDefault }, 443 }, // OperationalState::OperationCompletion
  ...
  { { CommandTag(4), "OperationalCommandResponse", ItemType::kDefault }, 441 }, // OperationalState::OperationalCommandResponse
};
...
const Entry<ItemInfo> _OperationalState_OperationalCommandResponse[] = {
  { { ContextTag(0), "commandResponseState", ItemType::kDefault }, 439 }, // OperationalState::ErrorStateStruct
};

const Entry<ItemInfo> _OperationalState_OperationalError[] = {
  { { ContextTag(0), "errorState", ItemType::kDefault }, 439 }, // OperationalState::ErrorStateStruct
};
...
const Entry<ItemInfo> _OperationalState_OperationalStateStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 440 }, // OperationalState_OperationalStateStruct[]
};
...
const Entry<ItemInfo> _RvcOperationalState[] = {
  ...
  { { AttributeTag(3), "operationalStateList", ItemType::kList }, 453 }, // RvcOperationalState::OperationalStateStruct[]
  { { AttributeTag(4), "operationalState", ItemType::kDefault }, kInvalidNodeIndex }, // RvcOperationalState::enum8
  { { AttributeTag(5), "operationalError", ItemType::kDefault }, 448 }, // RvcOperationalState::ErrorStateStruct
  ...
  { { EventTag(0), "OperationalError", ItemType::kDefault }, 451 }, // RvcOperationalState::OperationalError
  { { EventTag(1), "OperationCompletion", ItemType::kDefault }, 452 }, // RvcOperationalState::OperationCompletion
  ...
  { { CommandTag(4), "OperationalCommandResponse", ItemType::kDefault }, 450 }, // RvcOperationalState::OperationalCommandResponse
};
...
const Entry<ItemInfo> _RvcOperationalState_OperationalCommandResponse[] = {
  { { ContextTag(0), "commandResponseState", ItemType::kDefault }, 448 }, // RvcOperationalState::ErrorStateStruct
};

const Entry<ItemInfo> _RvcOperationalState_OperationalError[] = {
  { { ContextTag(0), "errorState", ItemType::kDefault }, 448 }, // RvcOperationalState::ErrorStateStruct
};
...
const Entry<ItemInfo> _RvcOperationalState_OperationalStateStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 449 }, // RvcOperationalState_OperationalStateStruct[]
};
...
const Entry<ItemInfo> _HepaFilterMonitoring[] = {
  ...
  { { AttributeTag(1), "degradationDirection", ItemType::kEnum }, 460 }, // HepaFilterMonitoring::DegradationDirectionEnum
  { { AttributeTag(2), "changeIndication", ItemType::kEnum }, 459 }, // HepaFilterMonitoring::ChangeIndicationEnum
  ...
  { { AttributeTag(5), "replacementProductList", ItemType::kList }, 458 }, // HepaFilterMonitoring::ReplacementProductStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 462 }, // HepaFilterMonitoring::Feature
...
const Entry<ItemInfo> _HepaFilterMonitoring_ReplacementProductStruct[] = {
  { { ContextTag(0), "productIdentifierType", ItemType::kEnum }, 461 }, // HepaFilterMonitoring::ProductIdentifierTypeEnum
...
const Entry<ItemInfo> _HepaFilterMonitoring_ReplacementProductStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 457 }, // HepaFilterMonitoring_ReplacementProductStruct[]
};
...
const Entry<ItemInfo> _ActivatedCarbonFilterMonitoring[] = {
  ...
  { { AttributeTag(1), "degradationDirection", ItemType::kEnum }, 467 }, // ActivatedCarbonFilterMonitoring::DegradationDirectionEnum
  { { AttributeTag(2), "changeIndication", ItemType::kEnum }, 466 }, // ActivatedCarbonFilterMonitoring::ChangeIndicationEnum
  ...
  { { AttributeTag(5), "replacementProductList", ItemType::kList }, 465 }, // ActivatedCarbonFilterMonitoring::ReplacementProductStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 469 }, // ActivatedCarbonFilterMonitoring::Feature
...
const Entry<ItemInfo> _ActivatedCarbonFilterMonitoring_ReplacementProductStruct[] = {
  { { ContextTag(0), "productIdentifierType", ItemType::kEnum }, 468 }, // ActivatedCarbonFilterMonitoring::ProductIdentifierTypeEnum
...
const Entry<ItemInfo> _ActivatedCarbonFilterMonitoring_ReplacementProductStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 464 }, // ActivatedCarbonFilterMonitoring_ReplacementProductStruct[]
};
...
const Entry<ItemInfo> _DoorLock[] = {
  { { AttributeTag(0), "lockState", ItemType::kEnum }, 507 }, // DoorLock::DlLockState
  { { AttributeTag(1), "lockType", ItemType::kEnum }, 508 }, // DoorLock::DlLockType
  { { AttributeTag(2), "actuatorEnabled", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::boolean
  { { AttributeTag(3), "doorState", ItemType::kEnum }, 515 }, // DoorLock::DoorStateEnum
  ...
  { { AttributeTag(27), "credentialRulesSupport", ItemType::kBitmap }, 524 }, // DoorLock::DlCredentialRuleMask
  ...
  { { AttributeTag(37), "operatingMode", ItemType::kEnum }, 518 }, // DoorLock::OperatingModeEnum
  { { AttributeTag(38), "supportedOperatingModes", ItemType::kBitmap }, 535 }, // DoorLock::DlSupportedOperatingModes
  { { AttributeTag(39), "defaultConfigurationRegister", ItemType::kBitmap }, 526 }, // DoorLock::DlDefaultConfigurationRegister
  ...
  { { AttributeTag(44), "localProgrammingFeatures", ItemType::kBitmap }, 529 }, // DoorLock::DlLocalProgrammingFeatures
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 537 }, // DoorLock::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::int16u
  { { EventTag(0), "DoorLockAlarm", ItemType::kDefault }, 497 }, // DoorLock::DoorLockAlarm
  { { EventTag(1), "DoorStateChange", ItemType::kDefault }, 498 }, // DoorLock::DoorStateChange
  { { EventTag(2), "LockOperation", ItemType::kDefault }, 499 }, // DoorLock::LockOperation
  { { EventTag(3), "LockOperationError", ItemType::kDefault }, 500 }, // DoorLock::LockOperationError
  { { EventTag(4), "LockUserChange", ItemType::kDefault }, 501 }, // DoorLock::LockUserChange
  { { CommandTag(0), "LockDoor", ItemType::kDefault }, 472 }, // DoorLock::LockDoor::LockDoorRequest
  { { CommandTag(1), "UnlockDoor", ItemType::kDefault }, 473 }, // DoorLock::UnlockDoor::UnlockDoorRequest
  { { CommandTag(3), "UnlockWithTimeout", ItemType::kDefault }, 474 }, // DoorLock::UnlockWithTimeout::UnlockWithTimeoutRequest
  { { CommandTag(11), "SetWeekDaySchedule", ItemType::kDefault }, 475 }, // DoorLock::SetWeekDaySchedule::SetWeekDayScheduleRequest
  { { CommandTag(12), "GetWeekDaySchedule", ItemType::kDefault }, 476 }, // DoorLock::GetWeekDaySchedule::GetWeekDayScheduleRequest
  { { CommandTag(13), "ClearWeekDaySchedule", ItemType::kDefault }, 478 }, // DoorLock::ClearWeekDaySchedule::ClearWeekDayScheduleRequest
  { { CommandTag(14), "SetYearDaySchedule", ItemType::kDefault }, 479 }, // DoorLock::SetYearDaySchedule::SetYearDayScheduleRequest
  { { CommandTag(15), "GetYearDaySchedule", ItemType::kDefault }, 480 }, // DoorLock::GetYearDaySchedule::GetYearDayScheduleRequest
  { { CommandTag(16), "ClearYearDaySchedule", ItemType::kDefault }, 482 }, // DoorLock::ClearYearDaySchedule::ClearYearDayScheduleRequest
  { { CommandTag(17), "SetHolidaySchedule", ItemType::kDefault }, 483 }, // DoorLock::SetHolidaySchedule::SetHolidayScheduleRequest
  { { CommandTag(18), "GetHolidaySchedule", ItemType::kDefault }, 484 }, // DoorLock::GetHolidaySchedule::GetHolidayScheduleRequest
  { { CommandTag(19), "ClearHolidaySchedule", ItemType::kDefault }, 486 }, // DoorLock::ClearHolidaySchedule::ClearHolidayScheduleRequest
  { { CommandTag(26), "SetUser", ItemType::kDefault }, 487 }, // DoorLock::SetUser::SetUserRequest
  { { CommandTag(27), "GetUser", ItemType::kDefault }, 488 }, // DoorLock::GetUser::GetUserRequest
  { { CommandTag(29), "ClearUser", ItemType::kDefault }, 490 }, // DoorLock::ClearUser::ClearUserRequest
  { { CommandTag(34), "SetCredential", ItemType::kDefault }, 491 }, // DoorLock::SetCredential::SetCredentialRequest
  { { CommandTag(36), "GetCredentialStatus", ItemType::kDefault }, 493 }, // DoorLock::GetCredentialStatus::GetCredentialStatusRequest
  { { CommandTag(38), "ClearCredential", ItemType::kDefault }, 495 }, // DoorLock::ClearCredential::ClearCredentialRequest
  { { CommandTag(39), "UnboltDoor", ItemType::kDefault }, 496 }, // DoorLock::UnboltDoor::UnboltDoorRequest
  { { CommandTag(12), "GetWeekDayScheduleResponse", ItemType::kDefault }, 477 }, // DoorLock::GetWeekDayScheduleResponse
  { { CommandTag(15), "GetYearDayScheduleResponse", ItemType::kDefault }, 481 }, // DoorLock::GetYearDayScheduleResponse
  { { CommandTag(18), "GetHolidayScheduleResponse", ItemType::kDefault }, 485 }, // DoorLock::GetHolidayScheduleResponse
  { { CommandTag(28), "GetUserResponse", ItemType::kDefault }, 489 }, // DoorLock::GetUserResponse
  { { CommandTag(35), "SetCredentialResponse", ItemType::kDefault }, 492 }, // DoorLock::SetCredentialResponse
  { { CommandTag(37), "GetCredentialStatusResponse", ItemType::kDefault }, 494 }, // DoorLock::GetCredentialStatusResponse
};

const Entry<ItemInfo> _DoorLock_CredentialStruct[] = {
  { { ContextTag(0), "credentialType", ItemType::kEnum }, 505 }, // DoorLock::CredentialTypeEnum
...
const Entry<ItemInfo> _DoorLock_SetWeekDayScheduleRequest[] = {
  ...
  { { ContextTag(2), "daysMask", ItemType::kBitmap }, 523 }, // DoorLock::DaysMaskMap
...
const Entry<ItemInfo> _DoorLock_GetWeekDayScheduleResponse[] = {
  { { ContextTag(0), "weekDayIndex", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::int8u
  { { ContextTag(1), "userIndex", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::int16u
  { { ContextTag(2), "status", ItemType::kEnum }, 509 }, // DoorLock::DlStatus
  { { ContextTag(3), "daysMask", ItemType::kBitmap }, 523 }, // DoorLock::DaysMaskMap
...
const Entry<ItemInfo> _DoorLock_SetHolidayScheduleRequest[] = {
  ...
  { { ContextTag(3), "operatingMode", ItemType::kEnum }, 518 }, // DoorLock::OperatingModeEnum
};
...
const Entry<ItemInfo> _DoorLock_GetHolidayScheduleResponse[] = {
  { { ContextTag(0), "holidayIndex", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::int8u
  { { ContextTag(1), "status", ItemType::kEnum }, 509 }, // DoorLock::DlStatus
  { { ContextTag(2), "localStartTime", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::epoch_s
  { { ContextTag(3), "localEndTime", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::epoch_s
  { { ContextTag(4), "operatingMode", ItemType::kEnum }, 518 }, // DoorLock::OperatingModeEnum
};
...
const Entry<ItemInfo> _DoorLock_SetUserRequest[] = {
  { { ContextTag(0), "operationType", ItemType::kEnum }, 506 }, // DoorLock::DataOperationTypeEnum
  { { ContextTag(1), "userIndex", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::int16u
  ...
  { { ContextTag(4), "userStatus", ItemType::kEnum }, 521 }, // DoorLock::UserStatusEnum
  { { ContextTag(5), "userType", ItemType::kEnum }, 522 }, // DoorLock::UserTypeEnum
  { { ContextTag(6), "credentialRule", ItemType::kEnum }, 504 }, // DoorLock::CredentialRuleEnum
};
...
const Entry<ItemInfo> _DoorLock_GetUserResponse[] = {
  ...
  { { ContextTag(3), "userStatus", ItemType::kEnum }, 521 }, // DoorLock::UserStatusEnum
  { { ContextTag(4), "userType", ItemType::kEnum }, 522 }, // DoorLock::UserTypeEnum
  { { ContextTag(5), "credentialRule", ItemType::kEnum }, 504 }, // DoorLock::CredentialRuleEnum
  { { ContextTag(6), "credentials", ItemType::kList }, 502 }, // DoorLock::CredentialStruct[]
...
const Entry<ItemInfo> _DoorLock_SetCredentialRequest[] = {
  { { ContextTag(0), "operationType", ItemType::kEnum }, 506 }, // DoorLock::DataOperationTypeEnum
  { { ContextTag(1), "credential", ItemType::kDefault }, 471 }, // DoorLock::CredentialStruct
...
const Entry<ItemInfo> _DoorLock_SetCredentialResponse[] = {
  { { ContextTag(0), "status", ItemType::kEnum }, 509 }, // DoorLock::DlStatus
  { { ContextTag(1), "userIndex", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::int16u
...
const Entry<ItemInfo> _DoorLock_GetCredentialStatusRequest[] = {
  { { ContextTag(0), "credential", ItemType::kDefault }, 471 }, // DoorLock::CredentialStruct
};
...
const Entry<ItemInfo> _DoorLock_DoorLockAlarm[] = {
  { { ContextTag(0), "alarmCode", ItemType::kEnum }, 503 }, // DoorLock::AlarmCodeEnum
};

const Entry<ItemInfo> _DoorLock_DoorStateChange[] = {
  { { ContextTag(0), "doorState", ItemType::kEnum }, 515 }, // DoorLock::DoorStateEnum
};

const Entry<ItemInfo> _DoorLock_LockOperation[] = {
  { { ContextTag(0), "lockOperationType", ItemType::kEnum }, 517 }, // DoorLock::LockOperationTypeEnum
  { { ContextTag(1), "operationSource", ItemType::kEnum }, 520 }, // DoorLock::OperationSourceEnum
  ...
  { { ContextTag(5), "credentials", ItemType::kList }, 502 }, // DoorLock::CredentialStruct[]
};

const Entry<ItemInfo> _DoorLock_LockOperationError[] = {
  { { ContextTag(0), "lockOperationType", ItemType::kEnum }, 517 }, // DoorLock::LockOperationTypeEnum
  { { ContextTag(1), "operationSource", ItemType::kEnum }, 520 }, // DoorLock::OperationSourceEnum
  { { ContextTag(2), "operationError", ItemType::kEnum }, 519 }, // DoorLock::OperationErrorEnum
  { { ContextTag(3), "userIndex", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::int16u
...
const Entry<ItemInfo> _DoorLock_LockUserChange[] = {
  { { ContextTag(0), "lockDataType", ItemType::kEnum }, 516 }, // DoorLock::LockDataTypeEnum
  { { ContextTag(1), "dataOperationType", ItemType::kEnum }, 506 }, // DoorLock::DataOperationTypeEnum
  { { ContextTag(2), "operationSource", ItemType::kEnum }, 520 }, // DoorLock::OperationSourceEnum
  { { ContextTag(3), "userIndex", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::int16u
  { { ContextTag(4), "fabricIndex", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::fabric_idx
  { { ContextTag(5), "sourceNode", ItemType::kDefault }, kInvalidNodeIndex }, // DoorLock::node_id
...
const Entry<ItemInfo> _DoorLock_CredentialStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 471 }, // DoorLock_CredentialStruct[]
};
...
const Entry<ItemInfo> _WindowCovering[] = {
  { { AttributeTag(0), "type", ItemType::kEnum }, 544 }, // WindowCovering::Type
  ...
  { { AttributeTag(7), "configStatus", ItemType::kBitmap }, 545 }, // WindowCovering::ConfigStatus
  ...
  { { AttributeTag(10), "operationalStatus", ItemType::kBitmap }, 548 }, // WindowCovering::OperationalStatus
  ...
  { { AttributeTag(13), "endProductType", ItemType::kEnum }, 543 }, // WindowCovering::EndProductType
  ...
  { { AttributeTag(23), "mode", ItemType::kBitmap }, 547 }, // WindowCovering::Mode
  { { AttributeTag(26), "safetyStatus", ItemType::kBitmap }, 549 }, // WindowCovering::SafetyStatus
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 546 }, // WindowCovering::Feature
  ...
  { { CommandTag(4), "GoToLiftValue", ItemType::kDefault }, 539 }, // WindowCovering::GoToLiftValue::GoToLiftValueRequest
  { { CommandTag(5), "GoToLiftPercentage", ItemType::kDefault }, 540 }, // WindowCovering::GoToLiftPercentage::GoToLiftPercentageRequest
  { { CommandTag(7), "GoToTiltValue", ItemType::kDefault }, 541 }, // WindowCovering::GoToTiltValue::GoToTiltValueRequest
  { { CommandTag(8), "GoToTiltPercentage", ItemType::kDefault }, 542 }, // WindowCovering::GoToTiltPercentage::GoToTiltPercentageRequest
};
...
const Entry<ItemInfo> _BarrierControl[] = {
  ...
  { { CommandTag(0), "BarrierControlGoToPercent", ItemType::kDefault }, 551 }, // BarrierControl::BarrierControlGoToPercent::BarrierControlGoToPercentRequest
...
const Entry<ItemInfo> _PumpConfigurationAndControl[] = {
  ...
  { { AttributeTag(16), "pumpStatus", ItemType::kBitmap }, 558 }, // PumpConfigurationAndControl::PumpStatusBitmap
  { { AttributeTag(17), "effectiveOperationMode", ItemType::kEnum }, 556 }, // PumpConfigurationAndControl::OperationModeEnum
  { { AttributeTag(18), "effectiveControlMode", ItemType::kEnum }, 555 }, // PumpConfigurationAndControl::ControlModeEnum
  ...
  { { AttributeTag(32), "operationMode", ItemType::kEnum }, 556 }, // PumpConfigurationAndControl::OperationModeEnum
  { { AttributeTag(33), "controlMode", ItemType::kEnum }, 555 }, // PumpConfigurationAndControl::ControlModeEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 557 }, // PumpConfigurationAndControl::Feature
...
const Entry<ItemInfo> _Thermostat[] = {
  ...
  { { AttributeTag(27), "controlSequenceOfOperation", ItemType::kEnum }, 567 }, // Thermostat::ThermostatControlSequence
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 571 }, // Thermostat::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::int16u
  { { CommandTag(0), "SetpointRaiseLower", ItemType::kDefault }, 561 }, // Thermostat::SetpointRaiseLower::SetpointRaiseLowerRequest
  { { CommandTag(1), "SetWeeklySchedule", ItemType::kDefault }, 563 }, // Thermostat::SetWeeklySchedule::SetWeeklyScheduleRequest
  { { CommandTag(2), "GetWeeklySchedule", ItemType::kDefault }, 564 }, // Thermostat::GetWeeklySchedule::GetWeeklyScheduleRequest
  { { CommandTag(3), "ClearWeeklySchedule", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ClearWeeklySchedule::()
  { { CommandTag(0), "GetWeeklyScheduleResponse", ItemType::kDefault }, 562 }, // Thermostat::GetWeeklyScheduleResponse
};
...
const Entry<ItemInfo> _Thermostat_SetpointRaiseLowerRequest[] = {
  { { ContextTag(0), "mode", ItemType::kEnum }, 566 }, // Thermostat::SetpointAdjustMode
...
const Entry<ItemInfo> _Thermostat_GetWeeklyScheduleResponse[] = {
  ...
  { { ContextTag(1), "dayOfWeekForSequence", ItemType::kBitmap }, 570 }, // Thermostat::DayOfWeek
  { { ContextTag(2), "modeForSequence", ItemType::kBitmap }, 572 }, // Thermostat::ModeForSequence
  { { ContextTag(3), "transitions", ItemType::kList }, 565 }, // Thermostat::ThermostatScheduleTransition[]
};
...
const Entry<ItemInfo> _Thermostat_GetWeeklyScheduleRequest[] = {
  { { ContextTag(0), "daysToReturn", ItemType::kBitmap }, 570 }, // Thermostat::DayOfWeek
  { { ContextTag(1), "modeToReturn", ItemType::kBitmap }, 572 }, // Thermostat::ModeForSequence
};

const Entry<ItemInfo> _Thermostat_ThermostatScheduleTransition_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 560 }, // Thermostat_ThermostatScheduleTransition[]
};

const Entry<ItemInfo> _Thermostat_SetpointAdjustMode[] = {
  { { ConstantValueTag(0x0), "kHeat", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::SetpointAdjustMode::kHeat
  { { ConstantValueTag(0x1), "kCool", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::SetpointAdjustMode::kCool
  { { ConstantValueTag(0x2), "kBoth", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::SetpointAdjustMode::kBoth
};

const Entry<ItemInfo> _Thermostat_ThermostatControlSequence[] = {
  { { ConstantValueTag(0x0), "kCoolingOnly", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatControlSequence::kCoolingOnly
  { { ConstantValueTag(0x1), "kCoolingWithReheat", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatControlSequence::kCoolingWithReheat
  { { ConstantValueTag(0x2), "kHeatingOnly", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatControlSequence::kHeatingOnly
  { { ConstantValueTag(0x3), "kHeatingWithReheat", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatControlSequence::kHeatingWithReheat
  { { ConstantValueTag(0x4), "kCoolingAndHeating", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatControlSequence::kCoolingAndHeating
  { { ConstantValueTag(0x5), "kCoolingAndHeatingWithReheat", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatControlSequence::kCoolingAndHeatingWithReheat
};

const Entry<ItemInfo> _Thermostat_ThermostatRunningMode[] = {
  { { ConstantValueTag(0x0), "kOff", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatRunningMode::kOff
  { { ConstantValueTag(0x3), "kCool", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatRunningMode::kCool
  { { ConstantValueTag(0x4), "kHeat", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatRunningMode::kHeat
};

const Entry<ItemInfo> _Thermostat_ThermostatSystemMode[] = {
  { { ConstantValueTag(0x0), "kOff", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatSystemMode::kOff
  { { ConstantValueTag(0x1), "kAuto", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatSystemMode::kAuto
  { { ConstantValueTag(0x3), "kCool", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatSystemMode::kCool
  { { ConstantValueTag(0x4), "kHeat", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatSystemMode::kHeat
  { { ConstantValueTag(0x5), "kEmergencyHeat", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatSystemMode::kEmergencyHeat
  { { ConstantValueTag(0x6), "kPrecooling", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatSystemMode::kPrecooling
  { { ConstantValueTag(0x7), "kFanOnly", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatSystemMode::kFanOnly
  { { ConstantValueTag(0x8), "kDry", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatSystemMode::kDry
  { { ConstantValueTag(0x9), "kSleep", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ThermostatSystemMode::kSleep
};

const Entry<ItemInfo> _Thermostat_DayOfWeek[] = {
  { { ConstantValueTag(0x1), "kSunday", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::DayOfWeek::kSunday
  { { ConstantValueTag(0x2), "kMonday", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::DayOfWeek::kMonday
  { { ConstantValueTag(0x4), "kTuesday", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::DayOfWeek::kTuesday
  { { ConstantValueTag(0x8), "kWednesday", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::DayOfWeek::kWednesday
  { { ConstantValueTag(0x10), "kThursday", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::DayOfWeek::kThursday
  { { ConstantValueTag(0x20), "kFriday", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::DayOfWeek::kFriday
  { { ConstantValueTag(0x40), "kSaturday", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::DayOfWeek::kSaturday
  { { ConstantValueTag(0x80), "kAway", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::DayOfWeek::kAway
};
...
const Entry<ItemInfo> _Thermostat_ModeForSequence[] = {
  { { ConstantValueTag(0x1), "kHeatSetpointPresent", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ModeForSequence::kHeatSetpointPresent
  { { ConstantValueTag(0x2), "kCoolSetpointPresent", ItemType::kDefault }, kInvalidNodeIndex }, // Thermostat::ModeForSequence::kCoolSetpointPresent
};

const Entry<ItemInfo> _FanControl[] = {
  { { AttributeTag(0), "fanMode", ItemType::kEnum }, 576 }, // FanControl::FanModeEnum
  { { AttributeTag(1), "fanModeSequence", ItemType::kEnum }, 577 }, // FanControl::FanModeSequenceEnum
  ...
  { { AttributeTag(7), "rockSupport", ItemType::kBitmap }, 580 }, // FanControl::RockBitmap
  { { AttributeTag(8), "rockSetting", ItemType::kBitmap }, 580 }, // FanControl::RockBitmap
  { { AttributeTag(9), "windSupport", ItemType::kBitmap }, 581 }, // FanControl::WindBitmap
  { { AttributeTag(10), "windSetting", ItemType::kBitmap }, 581 }, // FanControl::WindBitmap
  { { AttributeTag(11), "airflowDirection", ItemType::kEnum }, 575 }, // FanControl::AirflowDirectionEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 579 }, // FanControl::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // FanControl::int16u
  { { CommandTag(0), "Step", ItemType::kDefault }, 574 }, // FanControl::Step::StepRequest
};

const Entry<ItemInfo> _FanControl_StepRequest[] = {
  { { ContextTag(0), "direction", ItemType::kEnum }, 578 }, // FanControl::StepDirectionEnum
...
const Entry<ItemInfo> _FanControl_FanModeSequenceEnum[] = {
  ...
  { { ConstantValueTag(0x4), "kOffOnAuto", ItemType::kDefault }, kInvalidNodeIndex }, // FanControl::FanModeSequenceEnum::kOffOnAuto
  { { ConstantValueTag(0x5), "kOffOn", ItemType::kDefault }, kInvalidNodeIndex }, // FanControl::FanModeSequenceEnum::kOffOn
};
...
const Entry<ItemInfo> _ColorControl[] = {
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 613 }, // ColorControl::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // ColorControl::int16u
  { { CommandTag(0), "MoveToHue", ItemType::kDefault }, 584 }, // ColorControl::MoveToHue::MoveToHueRequest
  { { CommandTag(1), "MoveHue", ItemType::kDefault }, 585 }, // ColorControl::MoveHue::MoveHueRequest
  { { CommandTag(2), "StepHue", ItemType::kDefault }, 586 }, // ColorControl::StepHue::StepHueRequest
  { { CommandTag(3), "MoveToSaturation", ItemType::kDefault }, 587 }, // ColorControl::MoveToSaturation::MoveToSaturationRequest
  { { CommandTag(4), "MoveSaturation", ItemType::kDefault }, 588 }, // ColorControl::MoveSaturation::MoveSaturationRequest
  { { CommandTag(5), "StepSaturation", ItemType::kDefault }, 589 }, // ColorControl::StepSaturation::StepSaturationRequest
  { { CommandTag(6), "MoveToHueAndSaturation", ItemType::kDefault }, 590 }, // ColorControl::MoveToHueAndSaturation::MoveToHueAndSaturationRequest
  { { CommandTag(7), "MoveToColor", ItemType::kDefault }, 591 }, // ColorControl::MoveToColor::MoveToColorRequest
  { { CommandTag(8), "MoveColor", ItemType::kDefault }, 592 }, // ColorControl::MoveColor::MoveColorRequest
  { { CommandTag(9), "StepColor", ItemType::kDefault }, 593 }, // ColorControl::StepColor::StepColorRequest
  { { CommandTag(10), "MoveToColorTemperature", ItemType::kDefault }, 594 }, // ColorControl::MoveToColorTemperature::MoveToColorTemperatureRequest
  { { CommandTag(64), "EnhancedMoveToHue", ItemType::kDefault }, 595 }, // ColorControl::EnhancedMoveToHue::EnhancedMoveToHueRequest
  { { CommandTag(65), "EnhancedMoveHue", ItemType::kDefault }, 596 }, // ColorControl::EnhancedMoveHue::EnhancedMoveHueRequest
  { { CommandTag(66), "EnhancedStepHue", ItemType::kDefault }, 597 }, // ColorControl::EnhancedStepHue::EnhancedStepHueRequest
  { { CommandTag(67), "EnhancedMoveToHueAndSaturation", ItemType::kDefault }, 598 }, // ColorControl::EnhancedMoveToHueAndSaturation::EnhancedMoveToHueAndSaturationRequest
  { { CommandTag(68), "ColorLoopSet", ItemType::kDefault }, 599 }, // ColorControl::ColorLoopSet::ColorLoopSetRequest
  { { CommandTag(71), "StopMoveStep", ItemType::kDefault }, 600 }, // ColorControl::StopMoveStep::StopMoveStepRequest
  { { CommandTag(75), "MoveColorTemperature", ItemType::kDefault }, 601 }, // ColorControl::MoveColorTemperature::MoveColorTemperatureRequest
  { { CommandTag(76), "StepColorTemperature", ItemType::kDefault }, 602 }, // ColorControl::StepColorTemperature::StepColorTemperatureRequest
};
...
const Entry<ItemInfo> _ColorControl_MoveToHueRequest[] = {
  ...
  { { ContextTag(1), "direction", ItemType::kEnum }, 606 }, // ColorControl::HueDirection
...
const Entry<ItemInfo> _ColorControl_MoveHueRequest[] = {
  { { ContextTag(0), "moveMode", ItemType::kEnum }, 607 }, // ColorControl::HueMoveMode
...
const Entry<ItemInfo> _ColorControl_StepHueRequest[] = {
  { { ContextTag(0), "stepMode", ItemType::kEnum }, 608 }, // ColorControl::HueStepMode
...
const Entry<ItemInfo> _ColorControl_MoveSaturationRequest[] = {
  { { ContextTag(0), "moveMode", ItemType::kEnum }, 609 }, // ColorControl::SaturationMoveMode
  { { ContextTag(1), "rate", ItemType::kDefault }, kInvalidNodeIndex }, // ColorControl::int8u
  { { ContextTag(2), "optionsMask", ItemType::kDefault }, kInvalidNodeIndex }, // ColorControl::bitmap8
  { { ContextTag(3), "optionsOverride", ItemType::kDefault }, kInvalidNodeIndex }, // ColorControl::bitmap8
};
...
const Entry<ItemInfo> _ColorControl_StepSaturationRequest[] = {
  { { ContextTag(0), "stepMode", ItemType::kEnum }, 610 }, // ColorControl::SaturationStepMode
  { { ContextTag(1), "stepSize", ItemType::kDefault }, kInvalidNodeIndex }, // ColorControl::int8u
  { { ContextTag(2), "transitionTime", ItemType::kDefault }, kInvalidNodeIndex }, // ColorControl::int8u
  { { ContextTag(3), "optionsMask", ItemType::kDefault }, kInvalidNodeIndex }, // ColorControl::bitmap8
  { { ContextTag(4), "optionsOverride", ItemType::kDefault }, kInvalidNodeIndex }, // ColorControl::bitmap8
...
const Entry<ItemInfo> _ColorControl_ColorLoopSetRequest[] = {
  { { ContextTag(0), "updateFlags", ItemType::kBitmap }, 612 }, // ColorControl::ColorLoopUpdateFlags
  { { ContextTag(1), "action", ItemType::kEnum }, 603 }, // ColorControl::ColorLoopAction
  { { ContextTag(2), "direction", ItemType::kEnum }, 604 }, // ColorControl::ColorLoopDirection
...
const Entry<ItemInfo> _BallastConfiguration[] = {
  ...
  { { AttributeTag(2), "ballastStatus", ItemType::kBitmap }, 615 }, // BallastConfiguration::BallastStatusBitmap
  ...
  { { AttributeTag(52), "lampAlarmMode", ItemType::kBitmap }, 616 }, // BallastConfiguration::LampAlarmModeBitmap
...
const Entry<ItemInfo> _IlluminanceMeasurement[] = {
  ...
  { { AttributeTag(4), "lightSensorType", ItemType::kEnum }, 618 }, // IlluminanceMeasurement::LightSensorTypeEnum
...
const Entry<ItemInfo> _PressureMeasurement[] = {
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 621 }, // PressureMeasurement::Feature
...
const Entry<ItemInfo> _OccupancySensing[] = {
  { { AttributeTag(0), "occupancy", ItemType::kBitmap }, 626 }, // OccupancySensing::OccupancyBitmap
  { { AttributeTag(1), "occupancySensorType", ItemType::kEnum }, 625 }, // OccupancySensing::OccupancySensorTypeEnum
  { { AttributeTag(2), "occupancySensorTypeBitmap", ItemType::kBitmap }, 627 }, // OccupancySensing::OccupancySensorTypeBitmap
...
const Entry<ItemInfo> _CarbonMonoxideConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 631 }, // CarbonMonoxideConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 630 }, // CarbonMonoxideConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 629 }, // CarbonMonoxideConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 632 }, // CarbonMonoxideConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _CarbonDioxideConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 636 }, // CarbonDioxideConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 635 }, // CarbonDioxideConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 634 }, // CarbonDioxideConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 637 }, // CarbonDioxideConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _NitrogenDioxideConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 641 }, // NitrogenDioxideConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 640 }, // NitrogenDioxideConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 639 }, // NitrogenDioxideConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 642 }, // NitrogenDioxideConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _OzoneConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 646 }, // OzoneConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 645 }, // OzoneConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 644 }, // OzoneConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 647 }, // OzoneConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _Pm25ConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 651 }, // Pm25ConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 650 }, // Pm25ConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 649 }, // Pm25ConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 652 }, // Pm25ConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _FormaldehydeConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 656 }, // FormaldehydeConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 655 }, // FormaldehydeConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 654 }, // FormaldehydeConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 657 }, // FormaldehydeConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _Pm1ConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 661 }, // Pm1ConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 660 }, // Pm1ConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 659 }, // Pm1ConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 662 }, // Pm1ConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _Pm10ConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 666 }, // Pm10ConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 665 }, // Pm10ConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 664 }, // Pm10ConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 667 }, // Pm10ConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _TotalVolatileOrganicCompoundsConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 671 }, // TotalVolatileOrganicCompoundsConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 670 }, // TotalVolatileOrganicCompoundsConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 669 }, // TotalVolatileOrganicCompoundsConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 672 }, // TotalVolatileOrganicCompoundsConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _RadonConcentrationMeasurement[] = {
  ...
  { { AttributeTag(8), "measurementUnit", ItemType::kEnum }, 676 }, // RadonConcentrationMeasurement::MeasurementUnitEnum
  { { AttributeTag(9), "measurementMedium", ItemType::kEnum }, 675 }, // RadonConcentrationMeasurement::MeasurementMediumEnum
  { { AttributeTag(10), "levelValue", ItemType::kEnum }, 674 }, // RadonConcentrationMeasurement::LevelValueEnum
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 677 }, // RadonConcentrationMeasurement::Feature
...
const Entry<ItemInfo> _Channel[] = {
  { { AttributeTag(0), "channelList", ItemType::kList }, 686 }, // Channel::ChannelInfoStruct[]
  { { AttributeTag(1), "lineup", ItemType::kDefault }, 681 }, // Channel::LineupInfoStruct
  { { AttributeTag(2), "currentChannel", ItemType::kDefault }, 680 }, // Channel::ChannelInfoStruct
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 689 }, // Channel::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // Channel::int16u
  { { CommandTag(0), "ChangeChannel", ItemType::kDefault }, 682 }, // Channel::ChangeChannel::ChangeChannelRequest
  { { CommandTag(2), "ChangeChannelByNumber", ItemType::kDefault }, 684 }, // Channel::ChangeChannelByNumber::ChangeChannelByNumberRequest
  { { CommandTag(3), "SkipChannel", ItemType::kDefault }, 685 }, // Channel::SkipChannel::SkipChannelRequest
  { { CommandTag(1), "ChangeChannelResponse", ItemType::kDefault }, 683 }, // Channel::ChangeChannelResponse
};
...
const Entry<ItemInfo> _Channel_LineupInfoStruct[] = {
  ...
  { { ContextTag(3), "lineupInfoType", ItemType::kEnum }, 688 }, // Channel::LineupInfoTypeEnum
};
...
const Entry<ItemInfo> _Channel_ChangeChannelResponse[] = {
  { { ContextTag(0), "status", ItemType::kEnum }, 687 }, // Channel::ChannelStatusEnum
...
const Entry<ItemInfo> _Channel_ChannelInfoStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 680 }, // Channel_ChannelInfoStruct[]
};

const Entry<ItemInfo> _Channel_ChannelStatusEnum[] = {
  { { ConstantValueTag(0x0), "kSuccess", ItemType::kDefault }, kInvalidNodeIndex }, // Channel::ChannelStatusEnum::kSuccess
  { { ConstantValueTag(0x1), "kMultipleMatches", ItemType::kDefault }, kInvalidNodeIndex }, // Channel::ChannelStatusEnum::kMultipleMatches
  { { ConstantValueTag(0x2), "kNoMatches", ItemType::kDefault }, kInvalidNodeIndex }, // Channel::ChannelStatusEnum::kNoMatches
};
...
const Entry<ItemInfo> _TargetNavigator[] = {
  { { AttributeTag(0), "targetList", ItemType::kList }, 694 }, // TargetNavigator::TargetInfoStruct[]
  ...
  { { CommandTag(0), "NavigateTarget", ItemType::kDefault }, 692 }, // TargetNavigator::NavigateTarget::NavigateTargetRequest
  { { CommandTag(1), "NavigateTargetResponse", ItemType::kDefault }, 693 }, // TargetNavigator::NavigateTargetResponse
};
...
const Entry<ItemInfo> _TargetNavigator_NavigateTargetResponse[] = {
  { { ContextTag(0), "status", ItemType::kEnum }, 695 }, // TargetNavigator::TargetNavigatorStatusEnum
  { { ContextTag(1), "data", ItemType::kDefault }, kInvalidNodeIndex }, // TargetNavigator::char_string
};

const Entry<ItemInfo> _TargetNavigator_TargetInfoStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 691 }, // TargetNavigator_TargetInfoStruct[]
};

const Entry<ItemInfo> _TargetNavigator_TargetNavigatorStatusEnum[] = {
  { { ConstantValueTag(0x0), "kSuccess", ItemType::kDefault }, kInvalidNodeIndex }, // TargetNavigator::TargetNavigatorStatusEnum::kSuccess
  { { ConstantValueTag(0x1), "kTargetNotFound", ItemType::kDefault }, kInvalidNodeIndex }, // TargetNavigator::TargetNavigatorStatusEnum::kTargetNotFound
  { { ConstantValueTag(0x2), "kNotAllowed", ItemType::kDefault }, kInvalidNodeIndex }, // TargetNavigator::TargetNavigatorStatusEnum::kNotAllowed
};

const Entry<ItemInfo> _MediaPlayback[] = {
  { { AttributeTag(0), "currentState", ItemType::kEnum }, 703 }, // MediaPlayback::PlaybackStateEnum
  ...
  { { AttributeTag(3), "sampledPosition", ItemType::kDefault }, 697 }, // MediaPlayback::PlaybackPositionStruct
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 704 }, // MediaPlayback::Feature
  ...
  { { CommandTag(6), "Rewind", ItemType::kDefault }, kInvalidNodeIndex }, // MediaPlayback::Rewind::()
  { { CommandTag(7), "FastForward", ItemType::kDefault }, kInvalidNodeIndex }, // MediaPlayback::FastForward::()
  { { CommandTag(8), "SkipForward", ItemType::kDefault }, 698 }, // MediaPlayback::SkipForward::SkipForwardRequest
  { { CommandTag(9), "SkipBackward", ItemType::kDefault }, 699 }, // MediaPlayback::SkipBackward::SkipBackwardRequest
  { { CommandTag(11), "Seek", ItemType::kDefault }, 701 }, // MediaPlayback::Seek::SeekRequest
  { { CommandTag(10), "PlaybackResponse", ItemType::kDefault }, 700 }, // MediaPlayback::PlaybackResponse
};
...
const Entry<ItemInfo> _MediaPlayback_PlaybackResponse[] = {
  { { ContextTag(0), "status", ItemType::kEnum }, 702 }, // MediaPlayback::MediaPlaybackStatusEnum
...
const Entry<ItemInfo> _MediaPlayback_MediaPlaybackStatusEnum[] = {
  { { ConstantValueTag(0x0), "kSuccess", ItemType::kDefault }, kInvalidNodeIndex }, // MediaPlayback::MediaPlaybackStatusEnum::kSuccess
  { { ConstantValueTag(0x1), "kInvalidStateForCommand", ItemType::kDefault }, kInvalidNodeIndex }, // MediaPlayback::MediaPlaybackStatusEnum::kInvalidStateForCommand
  { { ConstantValueTag(0x2), "kNotAllowed", ItemType::kDefault }, kInvalidNodeIndex }, // MediaPlayback::MediaPlaybackStatusEnum::kNotAllowed
  { { ConstantValueTag(0x3), "kNotActive", ItemType::kDefault }, kInvalidNodeIndex }, // MediaPlayback::MediaPlaybackStatusEnum::kNotActive
  { { ConstantValueTag(0x4), "kSpeedOutOfRange", ItemType::kDefault }, kInvalidNodeIndex }, // MediaPlayback::MediaPlaybackStatusEnum::kSpeedOutOfRange
  { { ConstantValueTag(0x5), "kSeekOutOfRange", ItemType::kDefault }, kInvalidNodeIndex }, // MediaPlayback::MediaPlaybackStatusEnum::kSeekOutOfRange
};
...
const Entry<ItemInfo> _MediaInput[] = {
  { { AttributeTag(0), "inputList", ItemType::kList }, 709 }, // MediaInput::InputInfoStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 711 }, // MediaInput::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // MediaInput::int16u
  { { CommandTag(0), "SelectInput", ItemType::kDefault }, 707 }, // MediaInput::SelectInput::SelectInputRequest
  ...
  { { CommandTag(3), "RenameInput", ItemType::kDefault }, 708 }, // MediaInput::RenameInput::RenameInputRequest
};

const Entry<ItemInfo> _MediaInput_InputInfoStruct[] = {
  { { ContextTag(0), "index", ItemType::kDefault }, kInvalidNodeIndex }, // MediaInput::int8u
  { { ContextTag(1), "inputType", ItemType::kEnum }, 710 }, // MediaInput::InputTypeEnum
...
const Entry<ItemInfo> _MediaInput_InputInfoStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 706 }, // MediaInput_InputInfoStruct[]
};
...
const Entry<ItemInfo> _KeypadInput[] = {
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 718 }, // KeypadInput::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::int16u
  { { CommandTag(0), "SendKey", ItemType::kDefault }, 714 }, // KeypadInput::SendKey::SendKeyRequest
  { { CommandTag(1), "SendKeyResponse", ItemType::kDefault }, 715 }, // KeypadInput::SendKeyResponse
};

const Entry<ItemInfo> _KeypadInput_SendKeyRequest[] = {
  { { ContextTag(0), "keyCode", ItemType::kEnum }, 716 }, // KeypadInput::CecKeyCode
};

const Entry<ItemInfo> _KeypadInput_SendKeyResponse[] = {
  { { ContextTag(0), "status", ItemType::kEnum }, 717 }, // KeypadInput::KeypadInputStatusEnum
};

const Entry<ItemInfo> _KeypadInput_CecKeyCode[] = {
  { { ConstantValueTag(0x0), "kSelect", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kSelect
  { { ConstantValueTag(0x1), "kUp", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kUp
  { { ConstantValueTag(0x2), "kDown", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kDown
  { { ConstantValueTag(0x3), "kLeft", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kLeft
  { { ConstantValueTag(0x4), "kRight", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kRight
  { { ConstantValueTag(0x5), "kRightUp", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kRightUp
  { { ConstantValueTag(0x6), "kRightDown", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kRightDown
  { { ConstantValueTag(0x7), "kLeftUp", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kLeftUp
  { { ConstantValueTag(0x8), "kLeftDown", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kLeftDown
  { { ConstantValueTag(0x9), "kRootMenu", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kRootMenu
  { { ConstantValueTag(0xA), "kSetupMenu", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kSetupMenu
  { { ConstantValueTag(0xB), "kContentsMenu", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kContentsMenu
  { { ConstantValueTag(0xC), "kFavoriteMenu", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kFavoriteMenu
  { { ConstantValueTag(0xD), "kExit", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kExit
  { { ConstantValueTag(0x10), "kMediaTopMenu", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kMediaTopMenu
  { { ConstantValueTag(0x11), "kMediaContextSensitiveMenu", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kMediaContextSensitiveMenu
  { { ConstantValueTag(0x1D), "kNumberEntryMode", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumberEntryMode
  { { ConstantValueTag(0x1E), "kNumber11", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumber11
  { { ConstantValueTag(0x1F), "kNumber12", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumber12
  { { ConstantValueTag(0x20), "kNumber0OrNumber10", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumber0OrNumber10
  { { ConstantValueTag(0x21), "kNumbers1", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumbers1
  { { ConstantValueTag(0x22), "kNumbers2", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumbers2
  { { ConstantValueTag(0x23), "kNumbers3", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumbers3
  { { ConstantValueTag(0x24), "kNumbers4", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumbers4
  { { ConstantValueTag(0x25), "kNumbers5", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumbers5
  { { ConstantValueTag(0x26), "kNumbers6", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumbers6
  { { ConstantValueTag(0x27), "kNumbers7", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumbers7
  { { ConstantValueTag(0x28), "kNumbers8", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumbers8
  { { ConstantValueTag(0x29), "kNumbers9", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNumbers9
  { { ConstantValueTag(0x2A), "kDot", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kDot
  { { ConstantValueTag(0x2B), "kEnter", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kEnter
  { { ConstantValueTag(0x2C), "kClear", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kClear
  { { ConstantValueTag(0x2F), "kNextFavorite", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kNextFavorite
  { { ConstantValueTag(0x30), "kChannelUp", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kChannelUp
  { { ConstantValueTag(0x31), "kChannelDown", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kChannelDown
  { { ConstantValueTag(0x32), "kPreviousChannel", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPreviousChannel
  { { ConstantValueTag(0x33), "kSoundSelect", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kSoundSelect
  { { ConstantValueTag(0x34), "kInputSelect", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kInputSelect
  { { ConstantValueTag(0x35), "kDisplayInformation", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kDisplayInformation
  { { ConstantValueTag(0x36), "kHelp", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kHelp
  { { ConstantValueTag(0x37), "kPageUp", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPageUp
  { { ConstantValueTag(0x38), "kPageDown", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPageDown
  { { ConstantValueTag(0x40), "kPower", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPower
  { { ConstantValueTag(0x41), "kVolumeUp", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kVolumeUp
  { { ConstantValueTag(0x42), "kVolumeDown", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kVolumeDown
  { { ConstantValueTag(0x43), "kMute", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kMute
  { { ConstantValueTag(0x44), "kPlay", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPlay
  { { ConstantValueTag(0x45), "kStop", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kStop
  { { ConstantValueTag(0x46), "kPause", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPause
  { { ConstantValueTag(0x47), "kRecord", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kRecord
  { { ConstantValueTag(0x48), "kRewind", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kRewind
  { { ConstantValueTag(0x49), "kFastForward", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kFastForward
  { { ConstantValueTag(0x4A), "kEject", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kEject
  { { ConstantValueTag(0x4B), "kForward", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kForward
  { { ConstantValueTag(0x4C), "kBackward", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kBackward
  { { ConstantValueTag(0x4D), "kStopRecord", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kStopRecord
  { { ConstantValueTag(0x4E), "kPauseRecord", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPauseRecord
  { { ConstantValueTag(0x4F), "kReserved", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kReserved
  { { ConstantValueTag(0x50), "kAngle", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kAngle
  { { ConstantValueTag(0x51), "kSubPicture", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kSubPicture
  { { ConstantValueTag(0x52), "kVideoOnDemand", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kVideoOnDemand
  { { ConstantValueTag(0x53), "kElectronicProgramGuide", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kElectronicProgramGuide
  { { ConstantValueTag(0x54), "kTimerProgramming", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kTimerProgramming
  { { ConstantValueTag(0x55), "kInitialConfiguration", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kInitialConfiguration
  { { ConstantValueTag(0x56), "kSelectBroadcastType", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kSelectBroadcastType
  { { ConstantValueTag(0x57), "kSelectSoundPresentation", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kSelectSoundPresentation
  { { ConstantValueTag(0x60), "kPlayFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPlayFunction
  { { ConstantValueTag(0x61), "kPausePlayFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPausePlayFunction
  { { ConstantValueTag(0x62), "kRecordFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kRecordFunction
  { { ConstantValueTag(0x63), "kPauseRecordFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPauseRecordFunction
  { { ConstantValueTag(0x64), "kStopFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kStopFunction
  { { ConstantValueTag(0x65), "kMuteFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kMuteFunction
  { { ConstantValueTag(0x66), "kRestoreVolumeFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kRestoreVolumeFunction
  { { ConstantValueTag(0x67), "kTuneFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kTuneFunction
  { { ConstantValueTag(0x68), "kSelectMediaFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kSelectMediaFunction
  { { ConstantValueTag(0x69), "kSelectAvInputFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kSelectAvInputFunction
  { { ConstantValueTag(0x6A), "kSelectAudioInputFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kSelectAudioInputFunction
  { { ConstantValueTag(0x6B), "kPowerToggleFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPowerToggleFunction
  { { ConstantValueTag(0x6C), "kPowerOffFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPowerOffFunction
  { { ConstantValueTag(0x6D), "kPowerOnFunction", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kPowerOnFunction
  { { ConstantValueTag(0x71), "kF1Blue", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kF1Blue
  { { ConstantValueTag(0x72), "kF2Red", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kF2Red
  { { ConstantValueTag(0x73), "kF3Green", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kF3Green
  { { ConstantValueTag(0x74), "kF4Yellow", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kF4Yellow
  { { ConstantValueTag(0x75), "kF5", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kF5
  { { ConstantValueTag(0x76), "kData", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::CecKeyCode::kData
};

const Entry<ItemInfo> _KeypadInput_KeypadInputStatusEnum[] = {
  { { ConstantValueTag(0x0), "kSuccess", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::KeypadInputStatusEnum::kSuccess
  { { ConstantValueTag(0x1), "kUnsupportedKey", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::KeypadInputStatusEnum::kUnsupportedKey
  { { ConstantValueTag(0x2), "kInvalidKeyInCurrentState", ItemType::kDefault }, kInvalidNodeIndex }, // KeypadInput::KeypadInputStatusEnum::kInvalidKeyInCurrentState
};
...
const Entry<ItemInfo> _ContentLauncher[] = {
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 734 }, // ContentLauncher::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // ContentLauncher::int16u
  { { CommandTag(0), "LaunchContent", ItemType::kDefault }, 726 }, // ContentLauncher::LaunchContent::LaunchContentRequest
  { { CommandTag(1), "LaunchURL", ItemType::kDefault }, 727 }, // ContentLauncher::LaunchURL::LaunchURLRequest
  { { CommandTag(2), "LauncherResponse", ItemType::kDefault }, 728 }, // ContentLauncher::LauncherResponse
};
...
const Entry<ItemInfo> _ContentLauncher_DimensionStruct[] = {
  ...
  { { ContextTag(2), "metric", ItemType::kEnum }, 732 }, // ContentLauncher::MetricTypeEnum
};
...
const Entry<ItemInfo> _ContentLauncher_ParameterStruct[] = {
  { { ContextTag(0), "type", ItemType::kEnum }, 733 }, // ContentLauncher::ParameterEnum
  { { ContextTag(1), "value", ItemType::kDefault }, kInvalidNodeIndex }, // ContentLauncher::char_string
  { { ContextTag(2), "externalIDList", ItemType::kList }, 730 }, // ContentLauncher::AdditionalInfoStruct[]
};

const Entry<ItemInfo> _ContentLauncher_ContentSearchStruct[] = {
  { { ContextTag(0), "parameterList", ItemType::kList }, 729 }, // ContentLauncher::ParameterStruct[]
};
...
const Entry<ItemInfo> _ContentLauncher_StyleInformationStruct[] = {
  ...
  { { ContextTag(2), "size", ItemType::kDefault }, 720 }, // ContentLauncher::DimensionStruct
};
...
const Entry<ItemInfo> _ContentLauncher_BrandingInformationStruct[] = {
  ...
  { { ContextTag(1), "background", ItemType::kDefault }, 724 }, // ContentLauncher::StyleInformationStruct
  { { ContextTag(2), "logo", ItemType::kDefault }, 724 }, // ContentLauncher::StyleInformationStruct
  { { ContextTag(3), "progressBar", ItemType::kDefault }, 724 }, // ContentLauncher::StyleInformationStruct
  { { ContextTag(4), "splash", ItemType::kDefault }, 724 }, // ContentLauncher::StyleInformationStruct
  { { ContextTag(5), "waterMark", ItemType::kDefault }, 724 }, // ContentLauncher::StyleInformationStruct
};

const Entry<ItemInfo> _ContentLauncher_LaunchContentRequest[] = {
  { { ContextTag(0), "search", ItemType::kDefault }, 723 }, // ContentLauncher::ContentSearchStruct
...
const Entry<ItemInfo> _ContentLauncher_LaunchURLRequest[] = {
  ...
  { { ContextTag(2), "brandingInformation", ItemType::kDefault }, 725 }, // ContentLauncher::BrandingInformationStruct
};

const Entry<ItemInfo> _ContentLauncher_LauncherResponse[] = {
  { { ContextTag(0), "status", ItemType::kEnum }, 731 }, // ContentLauncher::ContentLaunchStatusEnum
...
const Entry<ItemInfo> _ContentLauncher_ParameterStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 722 }, // ContentLauncher_ParameterStruct[]
};

const Entry<ItemInfo> _ContentLauncher_AdditionalInfoStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 721 }, // ContentLauncher_AdditionalInfoStruct[]
};

const Entry<ItemInfo> _ContentLauncher_ContentLaunchStatusEnum[] = {
  { { ConstantValueTag(0x0), "kSuccess", ItemType::kDefault }, kInvalidNodeIndex }, // ContentLauncher::ContentLaunchStatusEnum::kSuccess
  { { ConstantValueTag(0x1), "kUrlNotAvailable", ItemType::kDefault }, kInvalidNodeIndex }, // ContentLauncher::ContentLaunchStatusEnum::kUrlNotAvailable
  { { ConstantValueTag(0x2), "kAuthFailed", ItemType::kDefault }, kInvalidNodeIndex }, // ContentLauncher::ContentLaunchStatusEnum::kAuthFailed
};
...
const Entry<ItemInfo> _ContentLauncher_SupportedStreamingProtocol[] = {
  { { ConstantValueTag(0x1), "kDASH", ItemType::kDefault }, kInvalidNodeIndex }, // ContentLauncher::SupportedStreamingProtocol::kDASH
  { { ConstantValueTag(0x2), "kHLS", ItemType::kDefault }, kInvalidNodeIndex }, // ContentLauncher::SupportedStreamingProtocol::kHLS
};

const Entry<ItemInfo> _AudioOutput[] = {
  { { AttributeTag(0), "outputList", ItemType::kList }, 740 }, // AudioOutput::OutputInfoStruct[]
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 742 }, // AudioOutput::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // AudioOutput::int16u
  { { CommandTag(0), "SelectOutput", ItemType::kDefault }, 738 }, // AudioOutput::SelectOutput::SelectOutputRequest
  { { CommandTag(1), "RenameOutput", ItemType::kDefault }, 739 }, // AudioOutput::RenameOutput::RenameOutputRequest
};
...
const Entry<ItemInfo> _AudioOutput_OutputInfoStruct[] = {
  ...
  { { ContextTag(1), "outputType", ItemType::kEnum }, 741 }, // AudioOutput::OutputTypeEnum
...
const Entry<ItemInfo> _AudioOutput_OutputInfoStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 737 }, // AudioOutput_OutputInfoStruct[]
};
...
const Entry<ItemInfo> _ApplicationLauncher[] = {
  ...
  { { AttributeTag(1), "currentApp", ItemType::kDefault }, 745 }, // ApplicationLauncher::ApplicationEPStruct
  ...
  { { AttributeTag(65532), "featureMap", ItemType::kBitmap }, 751 }, // ApplicationLauncher::Feature
  { { AttributeTag(65533), "clusterRevision", ItemType::kDefault }, kInvalidNodeIndex }, // ApplicationLauncher::int16u
  { { CommandTag(0), "LaunchApp", ItemType::kDefault }, 746 }, // ApplicationLauncher::LaunchApp::LaunchAppRequest
  { { CommandTag(1), "StopApp", ItemType::kDefault }, 747 }, // ApplicationLauncher::StopApp::StopAppRequest
  { { CommandTag(2), "HideApp", ItemType::kDefault }, 748 }, // ApplicationLauncher::HideApp::HideAppRequest
  { { CommandTag(3), "LauncherResponse", ItemType::kDefault }, 749 }, // ApplicationLauncher::LauncherResponse
};
...
const Entry<ItemInfo> _ApplicationLauncher_ApplicationEPStruct[] = {
  { { ContextTag(0), "application", ItemType::kDefault }, 744 }, // ApplicationLauncher::ApplicationStruct
...
const Entry<ItemInfo> _ApplicationLauncher_LauncherResponse[] = {
  { { ContextTag(0), "status", ItemType::kEnum }, 750 }, // ApplicationLauncher::ApplicationLauncherStatusEnum
  { { ContextTag(1), "data", ItemType::kDefault }, kInvalidNodeIndex }, // ApplicationLauncher::octet_string
};

const Entry<ItemInfo> _ApplicationLauncher_ApplicationLauncherStatusEnum[] = {
  { { ConstantValueTag(0x0), "kSuccess", ItemType::kDefault }, kInvalidNodeIndex }, // ApplicationLauncher::ApplicationLauncherStatusEnum::kSuccess
  { { ConstantValueTag(0x1), "kAppNotAvailable", ItemType::kDefault }, kInvalidNodeIndex }, // ApplicationLauncher::ApplicationLauncherStatusEnum::kAppNotAvailable
  { { ConstantValueTag(0x2), "kSystemBusy", ItemType::kDefault }, kInvalidNodeIndex }, // ApplicationLauncher::ApplicationLauncherStatusEnum::kSystemBusy
};
...
const Entry<ItemInfo> _ApplicationBasic[] = {
  ...
  { { AttributeTag(4), "application", ItemType::kDefault }, 753 }, // ApplicationBasic::ApplicationStruct
  { { AttributeTag(5), "status", ItemType::kEnum }, 754 }, // ApplicationBasic::ApplicationStatusEnum
...
const Entry<ItemInfo> _AccountLogin[] = {
  ...
  { { CommandTag(0), "GetSetupPIN", ItemType::kDefault }, 756 }, // AccountLogin::GetSetupPIN::GetSetupPINRequest
  { { CommandTag(2), "Login", ItemType::kDefault }, 758 }, // AccountLogin::Login::LoginRequest
  { { CommandTag(3), "Logout", ItemType::kDefault }, kInvalidNodeIndex }, // AccountLogin::Logout::()
  { { CommandTag(1), "GetSetupPINResponse", ItemType::kDefault }, 757 }, // AccountLogin::GetSetupPINResponse
};
...
const Entry<ItemInfo> _ElectricalMeasurement[] = {
  ...
  { { CommandTag(1), "GetMeasurementProfileCommand", ItemType::kDefault }, 762 }, // ElectricalMeasurement::GetMeasurementProfileCommand::GetMeasurementProfileCommandRequest
  { { CommandTag(0), "GetProfileInfoResponseCommand", ItemType::kDefault }, 760 }, // ElectricalMeasurement::GetProfileInfoResponseCommand
  { { CommandTag(1), "GetMeasurementProfileResponseCommand", ItemType::kDefault }, 761 }, // ElectricalMeasurement::GetMeasurementProfileResponseCommand
};
...
const Entry<ItemInfo> _UnitTesting[] = {
  ...
  { { AttributeTag(1), "bitmap8", ItemType::kBitmap }, 812 }, // UnitTesting::Bitmap8MaskMap
  { { AttributeTag(2), "bitmap16", ItemType::kBitmap }, 809 }, // UnitTesting::Bitmap16MaskMap
  { { AttributeTag(3), "bitmap32", ItemType::kBitmap }, 810 }, // UnitTesting::Bitmap32MaskMap
  { { AttributeTag(4), "bitmap64", ItemType::kBitmap }, 811 }, // UnitTesting::Bitmap64MaskMap
  ...
  { { AttributeTag(28), "listStructOctetString", ItemType::kList }, 807 }, // UnitTesting::TestListStructOctet[]
  ...
  { { AttributeTag(35), "listNullablesAndOptionalsStruct", ItemType::kList }, 802 }, // UnitTesting::NullablesAndOptionalsStruct[]
  { { AttributeTag(36), "enumAttr", ItemType::kEnum }, 808 }, // UnitTesting::SimpleEnum
  { { AttributeTag(37), "structAttr", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  ...
  { { AttributeTag(43), "listFabricScoped", ItemType::kList }, 806 }, // UnitTesting::TestFabricScoped[]
  ...
  { { AttributeTag(16385), "nullableBitmap8", ItemType::kBitmap }, 812 }, // UnitTesting::Bitmap8MaskMap
  { { AttributeTag(16386), "nullableBitmap16", ItemType::kBitmap }, 809 }, // UnitTesting::Bitmap16MaskMap
  { { AttributeTag(16387), "nullableBitmap32", ItemType::kBitmap }, 810 }, // UnitTesting::Bitmap32MaskMap
  { { AttributeTag(16388), "nullableBitmap64", ItemType::kBitmap }, 811 }, // UnitTesting::Bitmap64MaskMap
  ...
  { { AttributeTag(16420), "nullableEnumAttr", ItemType::kEnum }, 808 }, // UnitTesting::SimpleEnum
  { { AttributeTag(16421), "nullableStruct", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  ...
  { { EventTag(1), "TestEvent", ItemType::kDefault }, 800 }, // UnitTesting::TestEvent
  { { EventTag(2), "TestFabricScopedEvent", ItemType::kDefault }, 801 }, // UnitTesting::TestFabricScopedEvent
  ...
  { { CommandTag(4), "TestAddArguments", ItemType::kDefault }, 775 }, // UnitTesting::TestAddArguments::TestAddArgumentsRequest
  { { CommandTag(5), "TestSimpleArgumentRequest", ItemType::kDefault }, 777 }, // UnitTesting::TestSimpleArgumentRequest::TestSimpleArgumentRequestRequest
  { { CommandTag(6), "TestStructArrayArgumentRequest", ItemType::kDefault }, 779 }, // UnitTesting::TestStructArrayArgumentRequest::TestStructArrayArgumentRequestRequest
  { { CommandTag(7), "TestStructArgumentRequest", ItemType::kDefault }, 781 }, // UnitTesting::TestStructArgumentRequest::TestStructArgumentRequestRequest
  { { CommandTag(8), "TestNestedStructArgumentRequest", ItemType::kDefault }, 783 }, // UnitTesting::TestNestedStructArgumentRequest::TestNestedStructArgumentRequestRequest
  { { CommandTag(9), "TestListStructArgumentRequest", ItemType::kDefault }, 785 }, // UnitTesting::TestListStructArgumentRequest::TestListStructArgumentRequestRequest
  { { CommandTag(10), "TestListInt8UArgumentRequest", ItemType::kDefault }, 787 }, // UnitTesting::TestListInt8UArgumentRequest::TestListInt8UArgumentRequestRequest
  { { CommandTag(11), "TestNestedStructListArgumentRequest", ItemType::kDefault }, 789 }, // UnitTesting::TestNestedStructListArgumentRequest::TestNestedStructListArgumentRequestRequest
  { { CommandTag(12), "TestListNestedStructListArgumentRequest", ItemType::kDefault }, 791 }, // UnitTesting::TestListNestedStructListArgumentRequest::TestListNestedStructListArgumentRequestRequest
  { { CommandTag(13), "TestListInt8UReverseRequest", ItemType::kDefault }, 792 }, // UnitTesting::TestListInt8UReverseRequest::TestListInt8UReverseRequestRequest
  { { CommandTag(14), "TestEnumsRequest", ItemType::kDefault }, 793 }, // UnitTesting::TestEnumsRequest::TestEnumsRequestRequest
  { { CommandTag(15), "TestNullableOptionalRequest", ItemType::kDefault }, 794 }, // UnitTesting::TestNullableOptionalRequest::TestNullableOptionalRequestRequest
  { { CommandTag(16), "TestComplexNullableOptionalRequest", ItemType::kDefault }, 795 }, // UnitTesting::TestComplexNullableOptionalRequest::TestComplexNullableOptionalRequestRequest
  { { CommandTag(17), "SimpleStructEchoRequest", ItemType::kDefault }, 796 }, // UnitTesting::SimpleStructEchoRequest::SimpleStructEchoRequestRequest
  { { CommandTag(18), "TimedInvokeRequest", ItemType::kDefault }, kInvalidNodeIndex }, // UnitTesting::TimedInvokeRequest::()
  { { CommandTag(19), "TestSimpleOptionalArgumentRequest", ItemType::kDefault }, 797 }, // UnitTesting::TestSimpleOptionalArgumentRequest::TestSimpleOptionalArgumentRequestRequest
  { { CommandTag(20), "TestEmitTestEventRequest", ItemType::kDefault }, 798 }, // UnitTesting::TestEmitTestEventRequest::TestEmitTestEventRequestRequest
  { { CommandTag(21), "TestEmitTestFabricScopedEventRequest", ItemType::kDefault }, 799 }, // UnitTesting::TestEmitTestFabricScopedEventRequest::TestEmitTestFabricScopedEventRequestRequest
  { { CommandTag(0), "TestSpecificResponse", ItemType::kDefault }, 771 }, // UnitTesting::TestSpecificResponse
  { { CommandTag(1), "TestAddArgumentsResponse", ItemType::kDefault }, 772 }, // UnitTesting::TestAddArgumentsResponse
  { { CommandTag(2), "TestSimpleArgumentResponse", ItemType::kDefault }, 773 }, // UnitTesting::TestSimpleArgumentResponse
  { { CommandTag(3), "TestStructArrayArgumentResponse", ItemType::kDefault }, 774 }, // UnitTesting::TestStructArrayArgumentResponse
  { { CommandTag(4), "TestListInt8UReverseResponse", ItemType::kDefault }, 776 }, // UnitTesting::TestListInt8UReverseResponse
  { { CommandTag(5), "TestEnumsResponse", ItemType::kDefault }, 778 }, // UnitTesting::TestEnumsResponse
  { { CommandTag(6), "TestNullableOptionalResponse", ItemType::kDefault }, 780 }, // UnitTesting::TestNullableOptionalResponse
  { { CommandTag(7), "TestComplexNullableOptionalResponse", ItemType::kDefault }, 782 }, // UnitTesting::TestComplexNullableOptionalResponse
  { { CommandTag(8), "BooleanResponse", ItemType::kDefault }, 784 }, // UnitTesting::BooleanResponse
  { { CommandTag(9), "SimpleStructResponse", ItemType::kDefault }, 786 }, // UnitTesting::SimpleStructResponse
  { { CommandTag(10), "TestEmitTestEventResponse", ItemType::kDefault }, 788 }, // UnitTesting::TestEmitTestEventResponse
  { { CommandTag(11), "TestEmitTestFabricScopedEventResponse", ItemType::kDefault }, 790 }, // UnitTesting::TestEmitTestFabricScopedEventResponse
};
...
const Entry<ItemInfo> _UnitTesting_SimpleStruct[] = {
  ...
  { { ContextTag(2), "c", ItemType::kEnum }, 808 }, // UnitTesting::SimpleEnum
  ...
  { { ContextTag(5), "f", ItemType::kBitmap }, 813 }, // UnitTesting::SimpleBitmap
...
const Entry<ItemInfo> _UnitTesting_TestFabricScoped[] = {
  ...
  { { ContextTag(6), "fabricSensitiveStruct", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
...
const Entry<ItemInfo> _UnitTesting_NullablesAndOptionalsStruct[] = {
  ...
  { { ContextTag(6), "nullableStruct", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  { { ContextTag(7), "optionalStruct", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  { { ContextTag(8), "nullableOptionalStruct", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  { { ContextTag(9), "nullableList", ItemType::kList }, 805 }, // UnitTesting::SimpleEnum[]
  { { ContextTag(10), "optionalList", ItemType::kList }, 805 }, // UnitTesting::SimpleEnum[]
  { { ContextTag(11), "nullableOptionalList", ItemType::kList }, 805 }, // UnitTesting::SimpleEnum[]
};

const Entry<ItemInfo> _UnitTesting_NestedStruct[] = {
  { { ContextTag(0), "a", ItemType::kDefault }, kInvalidNodeIndex }, // UnitTesting::int8u
  { { ContextTag(1), "b", ItemType::kDefault }, kInvalidNodeIndex }, // UnitTesting::boolean
  { { ContextTag(2), "c", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
};
...
const Entry<ItemInfo> _UnitTesting_NestedStructList[] = {
  ...
  { { ContextTag(1), "b", ItemType::kDefault }, kInvalidNodeIndex }, // UnitTesting::boolean
  { { ContextTag(2), "c", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  { { ContextTag(3), "d", ItemType::kList }, 804 }, // UnitTesting::SimpleStruct[]
...
const Entry<ItemInfo> _UnitTesting_DoubleNestedStructList[] = {
  { { ContextTag(0), "a", ItemType::kList }, 803 }, // UnitTesting::NestedStructList[]
};
...
const Entry<ItemInfo> _UnitTesting_TestStructArrayArgumentResponse[] = {
  { { ContextTag(0), "arg1", ItemType::kList }, 803 }, // UnitTesting::NestedStructList[]
  { { ContextTag(1), "arg2", ItemType::kList }, 804 }, // UnitTesting::SimpleStruct[]
  { { ContextTag(2), "arg3", ItemType::kList }, 805 }, // UnitTesting::SimpleEnum[]
  { { ContextTag(3), "arg4", ItemType::kList }, 1 }, // UnitTesting::boolean[]
  { { ContextTag(4), "arg5", ItemType::kEnum }, 808 }, // UnitTesting::SimpleEnum
...
const Entry<ItemInfo> _UnitTesting_TestEnumsResponse[] = {
  ...
  { { ContextTag(1), "arg2", ItemType::kEnum }, 808 }, // UnitTesting::SimpleEnum
};
...
const Entry<ItemInfo> _UnitTesting_TestStructArgumentRequestRequest[] = {
  { { ContextTag(0), "arg1", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
};
...
const Entry<ItemInfo> _UnitTesting_TestComplexNullableOptionalResponse[] = {
  ...
  { { ContextTag(15), "nullableStructValue", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  { { ContextTag(16), "optionalStructWasPresent", ItemType::kDefault }, kInvalidNodeIndex }, // UnitTesting::boolean
  { { ContextTag(17), "optionalStructValue", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  ...
  { { ContextTag(20), "nullableOptionalStructValue", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  { { ContextTag(21), "nullableListWasNull", ItemType::kDefault }, kInvalidNodeIndex }, // UnitTesting::boolean
  { { ContextTag(22), "nullableListValue", ItemType::kList }, 805 }, // UnitTesting::SimpleEnum[]
  { { ContextTag(23), "optionalListWasPresent", ItemType::kDefault }, kInvalidNodeIndex }, // UnitTesting::boolean
  { { ContextTag(24), "optionalListValue", ItemType::kList }, 805 }, // UnitTesting::SimpleEnum[]
  ...
  { { ContextTag(27), "nullableOptionalListValue", ItemType::kList }, 805 }, // UnitTesting::SimpleEnum[]
};

const Entry<ItemInfo> _UnitTesting_TestNestedStructArgumentRequestRequest[] = {
  { { ContextTag(0), "arg1", ItemType::kDefault }, 767 }, // UnitTesting::NestedStruct
};
...
const Entry<ItemInfo> _UnitTesting_TestListStructArgumentRequestRequest[] = {
  { { ContextTag(0), "arg1", ItemType::kList }, 804 }, // UnitTesting::SimpleStruct[]
};
...
const Entry<ItemInfo> _UnitTesting_TestNestedStructListArgumentRequestRequest[] = {
  { { ContextTag(0), "arg1", ItemType::kDefault }, 768 }, // UnitTesting::NestedStructList
};
...
const Entry<ItemInfo> _UnitTesting_TestEvent[] = {
  ...
  { { ContextTag(2), "arg2", ItemType::kEnum }, 808 }, // UnitTesting::SimpleEnum
  { { ContextTag(3), "arg3", ItemType::kDefault }, kInvalidNodeIndex }, // UnitTesting::boolean
  { { ContextTag(4), "arg4", ItemType::kDefault }, 764 }, // UnitTesting::SimpleStruct
  { { ContextTag(5), "arg5", ItemType::kList }, 804 }, // UnitTesting::SimpleStruct[]
  { { ContextTag(6), "arg6", ItemType::kList }, 805 }, // UnitTesting::SimpleEnum[]
};
...
const Entry<ItemInfo> _UnitTesting_NullablesAndOptionalsStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 766 }, // UnitTesting_NullablesAndOptionalsStruct[]
};

const Entry<ItemInfo> _UnitTesting_NestedStructList_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 768 }, // UnitTesting_NestedStructList[]
};

const Entry<ItemInfo> _UnitTesting_SimpleStruct_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 764 }, // UnitTesting_SimpleStruct[]
};

const Entry<ItemInfo> _UnitTesting_SimpleEnum_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 808 }, // UnitTesting_SimpleEnum[]
};

const Entry<ItemInfo> _UnitTesting_TestFabricScoped_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 765 }, // UnitTesting_TestFabricScoped[]
};

const Entry<ItemInfo> _UnitTesting_TestListStructOctet_list_[] = {
  { { AnonymousTag(), "Anonymous<>", ItemType::kDefault }, 770 }, // UnitTesting_TestListStructOctet[]
};
...
const Entry<ItemInfo> _FaultInjection[] = {
  ...
  { { CommandTag(0), "FailAtFault", ItemType::kDefault }, 815 }, // FaultInjection::FailAtFault::FailAtFaultRequest
  { { CommandTag(1), "FailRandomlyAtFault", ItemType::kDefault }, 816 }, // FaultInjection::FailRandomlyAtFault::FailRandomlyAtFaultRequest
};

const Entry<ItemInfo> _FaultInjection_FailAtFaultRequest[] = {
  { { ContextTag(0), "type", ItemType::kEnum }, 817 }, // FaultInjection::FaultType
...
const Entry<ItemInfo> _SampleMei[] = {
  ...
  { { CommandTag(2), "AddArguments", ItemType::kDefault }, 820 }, // SampleMei::AddArguments::AddArgumentsRequest
  { { CommandTag(1), "AddArgumentsResponse", ItemType::kDefault }, 819 }, // SampleMei::AddArgumentsResponse
};
...
const Entry<ItemInfo> _all_clusters[] = {
  ...
  { { ClusterTag(0x06), "OnOff", ItemType::kDefault }, 46 },
  { { ClusterTag(0x07), "OnOffSwitchConfiguration", ItemType::kDefault }, 55 },
  { { ClusterTag(0x08), "LevelControl", ItemType::kDefault }, 56 },
  { { ClusterTag(0x0F), "BinaryInputBasic", ItemType::kDefault }, 70 },
  { { ClusterTag(0x1C), "PulseWidthModulation", ItemType::kDefault }, 71 },
  { { ClusterTag(0x1D), "Descriptor", ItemType::kDefault }, 72 },
  { { ClusterTag(0x1E), "Binding", ItemType::kDefault }, 78 },
  { { ClusterTag(0x1F), "AccessControl", ItemType::kDefault }, 81 },
  { { ClusterTag(0x25), "Actions", ItemType::kDefault }, 93 },
  { { ClusterTag(0x28), "BasicInformation", ItemType::kDefault }, 117 },
  { { ClusterTag(0x29), "OtaSoftwareUpdateProvider", ItemType::kDefault }, 125 },
  { { ClusterTag(0x2A), "OtaSoftwareUpdateRequestor", ItemType::kDefault }, 135 },
  { { ClusterTag(0x2B), "LocalizationConfiguration", ItemType::kDefault }, 145 },
  { { ClusterTag(0x2C), "TimeFormatLocalization", ItemType::kDefault }, 146 },
  { { ClusterTag(0x2D), "UnitLocalization", ItemType::kDefault }, 151 },
  { { ClusterTag(0x2E), "PowerSourceConfiguration", ItemType::kDefault }, 154 },
  { { ClusterTag(0x2F), "PowerSource", ItemType::kDefault }, 155 },
  { { ClusterTag(0x30), "GeneralCommissioning", ItemType::kDefault }, 176 },
  { { ClusterTag(0x31), "NetworkCommissioning", ItemType::kDefault }, 185 },
  { { ClusterTag(0x32), "DiagnosticLogs", ItemType::kDefault }, 207 },
  { { ClusterTag(0x33), "GeneralDiagnostics", ItemType::kDefault }, 213 },
  { { ClusterTag(0x34), "SoftwareDiagnostics", ItemType::kDefault }, 229 },
  { { ClusterTag(0x35), "ThreadNetworkDiagnostics", ItemType::kDefault }, 234 },
  { { ClusterTag(0x36), "WiFiNetworkDiagnostics", ItemType::kDefault }, 248 },
  { { ClusterTag(0x37), "EthernetNetworkDiagnostics", ItemType::kDefault }, 257 },
  { { ClusterTag(0x38), "TimeSynchronization", ItemType::kDefault }, 260 },
  { { ClusterTag(0x39), "BridgedDeviceBasicInformation", ItemType::kDefault }, 280 },
  { { ClusterTag(0x3B), "Switch", ItemType::kDefault }, 286 },
  { { ClusterTag(0x3C), "AdministratorCommissioning", ItemType::kDefault }, 295 },
  { { ClusterTag(0x3E), "OperationalCredentials", ItemType::kDefault }, 301 },
  { { ClusterTag(0x3F), "GroupKeyManagement", ItemType::kDefault }, 320 },
  { { ClusterTag(0x40), "FixedLabel", ItemType::kDefault }, 333 },
  { { ClusterTag(0x41), "UserLabel", ItemType::kDefault }, 336 },
  { { ClusterTag(0x42), "ProxyConfiguration", ItemType::kDefault }, 339 },
  { { ClusterTag(0x43), "ProxyDiscovery", ItemType::kDefault }, 340 },
  { { ClusterTag(0x44), "ProxyValid", ItemType::kDefault }, 341 },
  { { ClusterTag(0x45), "BooleanState", ItemType::kDefault }, 342 },
  { { ClusterTag(0x46), "IcdManagement", ItemType::kDefault }, 344 },
  { { ClusterTag(0x50), "ModeSelect", ItemType::kDefault }, 352 },
  { { ClusterTag(0x51), "LaundryWasherMode", ItemType::kDefault }, 359 },
  { { ClusterTag(0x52), "RefrigeratorAndTemperatureControlledCabinetMode", ItemType::kDefault }, 368 },
  { { ClusterTag(0x53), "LaundryWasherControls", ItemType::kDefault }, 377 },
  { { ClusterTag(0x54), "RvcRunMode", ItemType::kDefault }, 381 },
  { { ClusterTag(0x55), "RvcCleanMode", ItemType::kDefault }, 391 },
  { { ClusterTag(0x56), "TemperatureControl", ItemType::kDefault }, 401 },
  { { ClusterTag(0x57), "RefrigeratorAlarm", ItemType::kDefault }, 404 },
  { { ClusterTag(0x59), "DishwasherMode", ItemType::kDefault }, 407 },
  { { ClusterTag(0x5B), "AirQuality", ItemType::kDefault }, 416 },
  { { ClusterTag(0x5C), "SmokeCoAlarm", ItemType::kDefault }, 419 },
  { { ClusterTag(0x5D), "DishwasherAlarm", ItemType::kDefault }, 432 },
  { { ClusterTag(0x60), "OperationalState", ItemType::kDefault }, 438 },
  { { ClusterTag(0x61), "RvcOperationalState", ItemType::kDefault }, 447 },
  { { ClusterTag(0x71), "HepaFilterMonitoring", ItemType::kDefault }, 456 },
  { { ClusterTag(0x72), "ActivatedCarbonFilterMonitoring", ItemType::kDefault }, 463 },
  { { ClusterTag(0x101), "DoorLock", ItemType::kDefault }, 470 },
  { { ClusterTag(0x102), "WindowCovering", ItemType::kDefault }, 538 },
  { { ClusterTag(0x103), "BarrierControl", ItemType::kDefault }, 550 },
  { { ClusterTag(0x200), "PumpConfigurationAndControl", ItemType::kDefault }, 554 },
  { { ClusterTag(0x201), "Thermostat", ItemType::kDefault }, 559 },
  { { ClusterTag(0x202), "FanControl", ItemType::kDefault }, 573 },
  { { ClusterTag(0x204), "ThermostatUserInterfaceConfiguration", ItemType::kDefault }, 582 },
  { { ClusterTag(0x300), "ColorControl", ItemType::kDefault }, 583 },
  { { ClusterTag(0x301), "BallastConfiguration", ItemType::kDefault }, 614 },
  { { ClusterTag(0x400), "IlluminanceMeasurement", ItemType::kDefault }, 617 },
  { { ClusterTag(0x402), "TemperatureMeasurement", ItemType::kDefault }, 619 },
  { { ClusterTag(0x403), "PressureMeasurement", ItemType::kDefault }, 620 },
  { { ClusterTag(0x404), "FlowMeasurement", ItemType::kDefault }, 622 },
  { { ClusterTag(0x405), "RelativeHumidityMeasurement", ItemType::kDefault }, 623 },
  { { ClusterTag(0x406), "OccupancySensing", ItemType::kDefault }, 624 },
  { { ClusterTag(0x40C), "CarbonMonoxideConcentrationMeasurement", ItemType::kDefault }, 628 },
  { { ClusterTag(0x40D), "CarbonDioxideConcentrationMeasurement", ItemType::kDefault }, 633 },
  { { ClusterTag(0x413), "NitrogenDioxideConcentrationMeasurement", ItemType::kDefault }, 638 },
  { { ClusterTag(0x415), "OzoneConcentrationMeasurement", ItemType::kDefault }, 643 },
  { { ClusterTag(0x42A), "Pm25ConcentrationMeasurement", ItemType::kDefault }, 648 },
  { { ClusterTag(0x42B), "FormaldehydeConcentrationMeasurement", ItemType::kDefault }, 653 },
  { { ClusterTag(0x42C), "Pm1ConcentrationMeasurement", ItemType::kDefault }, 658 },
  { { ClusterTag(0x42D), "Pm10ConcentrationMeasurement", ItemType::kDefault }, 663 },
  { { ClusterTag(0x42E), "TotalVolatileOrganicCompoundsConcentrationMeasurement", ItemType::kDefault }, 668 },
  { { ClusterTag(0x42F), "RadonConcentrationMeasurement", ItemType::kDefault }, 673 },
  { { ClusterTag(0x503), "WakeOnLan", ItemType::kDefault }, 678 },
  { { ClusterTag(0x504), "Channel", ItemType::kDefault }, 679 },
  { { ClusterTag(0x505), "TargetNavigator", ItemType::kDefault }, 690 },
  { { ClusterTag(0x506), "MediaPlayback", ItemType::kDefault }, 696 },
  { { ClusterTag(0x507), "MediaInput", ItemType::kDefault }, 705 },
  { { ClusterTag(0x508), "LowPower", ItemType::kDefault }, 712 },
  { { ClusterTag(0x509), "KeypadInput", ItemType::kDefault }, 713 },
  { { ClusterTag(0x50A), "ContentLauncher", ItemType::kDefault }, 719 },
  { { ClusterTag(0x50B), "AudioOutput", ItemType::kDefault }, 736 },
  { { ClusterTag(0x50C), "ApplicationLauncher", ItemType::kDefault }, 743 },
  { { ClusterTag(0x50D), "ApplicationBasic", ItemType::kDefault }, 752 },
  { { ClusterTag(0x50E), "AccountLogin", ItemType::kDefault }, 755 },
  { { ClusterTag(0xB04), "ElectricalMeasurement", ItemType::kDefault }, 759 },
  { { ClusterTag(0xFFF1FC05), "UnitTesting", ItemType::kDefault }, 763 },
  { { ClusterTag(0xFFF1FC06), "FaultInjection", ItemType::kDefault }, 814 },
  { { ClusterTag(0xFFF1FC20), "SampleMei", ItemType::kDefault }, 818 },
...
const std::array<const Node<ItemInfo>, 819 + 2> clusters_meta = { {
  ...
  _ENTRY(_Scenes_AddSceneRequest), // 23
  _ENTRY(_Scenes_AddSceneResponse), // 24
  _ENTRY(_Scenes_ViewSceneRequest), // 25
  _ENTRY(_Scenes_ViewSceneResponse), // 26
  _ENTRY(_Scenes_RemoveSceneRequest), // 27
  _ENTRY(_Scenes_RemoveSceneResponse), // 28
  _ENTRY(_Scenes_RemoveAllScenesRequest), // 29
  _ENTRY(_Scenes_RemoveAllScenesResponse), // 30
  _ENTRY(_Scenes_StoreSceneRequest), // 31
  _ENTRY(_Scenes_StoreSceneResponse), // 32
  _ENTRY(_Scenes_RecallSceneRequest), // 33
  _ENTRY(_Scenes_GetSceneMembershipRequest), // 34
  _ENTRY(_Scenes_GetSceneMembershipResponse), // 35
  _ENTRY(_Scenes_EnhancedAddSceneRequest), // 36
  _ENTRY(_Scenes_EnhancedAddSceneResponse), // 37
  _ENTRY(_Scenes_EnhancedViewSceneRequest), // 38
  _ENTRY(_Scenes_EnhancedViewSceneResponse), // 39
  _ENTRY(_Scenes_CopySceneRequest), // 40
  _ENTRY(_Scenes_CopySceneResponse), // 41
  _ENTRY(_Scenes_ExtensionFieldSet_list_), // 42
  _ENTRY(_Scenes_AttributeValuePair_list_), // 43
  _ENTRY(_Scenes_Feature), // 44
  _ENTRY(_Scenes_ScenesCopyMode), // 45
  _ENTRY(_OnOff), // 46
  _ENTRY(_OnOff_OffWithEffectRequest), // 47
  _ENTRY(_OnOff_OnWithTimedOffRequest), // 48
  _ENTRY(_OnOff_DelayedAllOffEffectVariantEnum), // 49
  _ENTRY(_OnOff_DyingLightEffectVariantEnum), // 50
  _ENTRY(_OnOff_EffectIdentifierEnum), // 51
  _ENTRY(_OnOff_StartUpOnOffEnum), // 52
  _ENTRY(_OnOff_Feature), // 53
  _ENTRY(_OnOff_OnOffControlBitmap), // 54
  _ENTRY(_OnOffSwitchConfiguration), // 55
  _ENTRY(_LevelControl), // 56
  _ENTRY(_LevelControl_MoveToLevelRequest), // 57
  _ENTRY(_LevelControl_MoveRequest), // 58
  _ENTRY(_LevelControl_StepRequest), // 59
  _ENTRY(_LevelControl_StopRequest), // 60
  _ENTRY(_LevelControl_MoveToLevelWithOnOffRequest), // 61
  _ENTRY(_LevelControl_MoveWithOnOffRequest), // 62
  _ENTRY(_LevelControl_StepWithOnOffRequest), // 63
  _ENTRY(_LevelControl_StopWithOnOffRequest), // 64
  _ENTRY(_LevelControl_MoveToClosestFrequencyRequest), // 65
  _ENTRY(_LevelControl_MoveMode), // 66
  _ENTRY(_LevelControl_StepMode), // 67
  _ENTRY(_LevelControl_Feature), // 68
  _ENTRY(_LevelControl_LevelControlOptions), // 69
  _ENTRY(_BinaryInputBasic), // 70
  _ENTRY(_PulseWidthModulation), // 71
  _ENTRY(_Descriptor), // 72
  _ENTRY(_Descriptor_DeviceTypeStruct), // 73
  _ENTRY(_Descriptor_SemanticTagStruct), // 74
  _ENTRY(_Descriptor_SemanticTagStruct_list_), // 75
  _ENTRY(_Descriptor_DeviceTypeStruct_list_), // 76
  _ENTRY(_Descriptor_Feature), // 77
  _ENTRY(_Binding), // 78
  _ENTRY(_Binding_TargetStruct), // 79
  _ENTRY(_Binding_TargetStruct_list_), // 80
  _ENTRY(_AccessControl), // 81
  _ENTRY(_AccessControl_AccessControlTargetStruct), // 82
  _ENTRY(_AccessControl_AccessControlEntryStruct), // 83
  _ENTRY(_AccessControl_AccessControlExtensionStruct), // 84
  _ENTRY(_AccessControl_AccessControlEntryChanged), // 85
  _ENTRY(_AccessControl_AccessControlExtensionChanged), // 86
  _ENTRY(_AccessControl_AccessControlEntryStruct_list_), // 87
  _ENTRY(_AccessControl_AccessControlExtensionStruct_list_), // 88
  _ENTRY(_AccessControl_AccessControlTargetStruct_list_), // 89
  _ENTRY(_AccessControl_AccessControlEntryAuthModeEnum), // 90
  _ENTRY(_AccessControl_AccessControlEntryPrivilegeEnum), // 91
  _ENTRY(_AccessControl_ChangeTypeEnum), // 92
  _ENTRY(_Actions), // 93
  _ENTRY(_Actions_ActionStruct), // 94
  _ENTRY(_Actions_EndpointListStruct), // 95
  _ENTRY(_Actions_InstantActionRequest), // 96
  _ENTRY(_Actions_InstantActionWithTransitionRequest), // 97
  _ENTRY(_Actions_StartActionRequest), // 98
  _ENTRY(_Actions_StartActionWithDurationRequest), // 99
  _ENTRY(_Actions_StopActionRequest), // 100
  _ENTRY(_Actions_PauseActionRequest), // 101
  _ENTRY(_Actions_PauseActionWithDurationRequest), // 102
  _ENTRY(_Actions_ResumeActionRequest), // 103
  _ENTRY(_Actions_EnableActionRequest), // 104
  _ENTRY(_Actions_EnableActionWithDurationRequest), // 105
  _ENTRY(_Actions_DisableActionRequest), // 106
  _ENTRY(_Actions_DisableActionWithDurationRequest), // 107
  _ENTRY(_Actions_StateChanged), // 108
  _ENTRY(_Actions_ActionFailed), // 109
  _ENTRY(_Actions_EndpointListStruct_list_), // 110
  _ENTRY(_Actions_ActionStruct_list_), // 111
  _ENTRY(_Actions_ActionErrorEnum), // 112
  _ENTRY(_Actions_ActionStateEnum), // 113
  _ENTRY(_Actions_ActionTypeEnum), // 114
  _ENTRY(_Actions_EndpointListTypeEnum), // 115
  _ENTRY(_Actions_CommandBits), // 116
  _ENTRY(_BasicInformation), // 117
  _ENTRY(_BasicInformation_CapabilityMinimaStruct), // 118
  _ENTRY(_BasicInformation_ProductAppearanceStruct), // 119
  _ENTRY(_BasicInformation_StartUp), // 120
  _ENTRY(_BasicInformation_Leave), // 121
  _ENTRY(_BasicInformation_ReachableChanged), // 122
  _ENTRY(_BasicInformation_ColorEnum), // 123
  _ENTRY(_BasicInformation_ProductFinishEnum), // 124
  _ENTRY(_OtaSoftwareUpdateProvider), // 125
  _ENTRY(_OtaSoftwareUpdateProvider_QueryImageRequest), // 126
  _ENTRY(_OtaSoftwareUpdateProvider_QueryImageResponse), // 127
  _ENTRY(_OtaSoftwareUpdateProvider_ApplyUpdateRequestRequest), // 128
  _ENTRY(_OtaSoftwareUpdateProvider_ApplyUpdateResponse), // 129
  _ENTRY(_OtaSoftwareUpdateProvider_NotifyUpdateAppliedRequest), // 130
  _ENTRY(_OtaSoftwareUpdateProvider_DownloadProtocolEnum_list_), // 131
  _ENTRY(_OtaSoftwareUpdateProvider_ApplyUpdateActionEnum), // 132
  _ENTRY(_OtaSoftwareUpdateProvider_DownloadProtocolEnum), // 133
  _ENTRY(_OtaSoftwareUpdateProvider_StatusEnum), // 134
  _ENTRY(_OtaSoftwareUpdateRequestor), // 135
  _ENTRY(_OtaSoftwareUpdateRequestor_ProviderLocation), // 136
  _ENTRY(_OtaSoftwareUpdateRequestor_AnnounceOTAProviderRequest), // 137
  _ENTRY(_OtaSoftwareUpdateRequestor_StateTransition), // 138
  _ENTRY(_OtaSoftwareUpdateRequestor_VersionApplied), // 139
  _ENTRY(_OtaSoftwareUpdateRequestor_DownloadError), // 140
  _ENTRY(_OtaSoftwareUpdateRequestor_ProviderLocation_list_), // 141
  _ENTRY(_OtaSoftwareUpdateRequestor_AnnouncementReasonEnum), // 142
  _ENTRY(_OtaSoftwareUpdateRequestor_ChangeReasonEnum), // 143
  _ENTRY(_OtaSoftwareUpdateRequestor_UpdateStateEnum), // 144
  _ENTRY(_LocalizationConfiguration), // 145
  _ENTRY(_TimeFormatLocalization), // 146
  _ENTRY(_TimeFormatLocalization_CalendarTypeEnum_list_), // 147
  _ENTRY(_TimeFormatLocalization_CalendarTypeEnum), // 148
  _ENTRY(_TimeFormatLocalization_HourFormatEnum), // 149
  _ENTRY(_TimeFormatLocalization_Feature), // 150
  _ENTRY(_UnitLocalization), // 151
  _ENTRY(_UnitLocalization_TempUnitEnum), // 152
  _ENTRY(_UnitLocalization_Feature), // 153
  _ENTRY(_PowerSourceConfiguration), // 154
  _ENTRY(_PowerSource), // 155
  _ENTRY(_PowerSource_BatChargeFaultChangeType), // 156
  _ENTRY(_PowerSource_BatFaultChangeType), // 157
  _ENTRY(_PowerSource_WiredFaultChangeType), // 158
  _ENTRY(_PowerSource_WiredFaultChange), // 159
  _ENTRY(_PowerSource_BatFaultChange), // 160
  _ENTRY(_PowerSource_BatChargeFaultChange), // 161
  _ENTRY(_PowerSource_BatFaultEnum_list_), // 162
  _ENTRY(_PowerSource_BatChargeFaultEnum_list_), // 163
  _ENTRY(_PowerSource_WiredFaultEnum_list_), // 164
  _ENTRY(_PowerSource_BatApprovedChemistryEnum), // 165
  _ENTRY(_PowerSource_BatChargeFaultEnum), // 166
  _ENTRY(_PowerSource_BatChargeLevelEnum), // 167
  _ENTRY(_PowerSource_BatChargeStateEnum), // 168
  _ENTRY(_PowerSource_BatCommonDesignationEnum), // 169
  _ENTRY(_PowerSource_BatFaultEnum), // 170
  _ENTRY(_PowerSource_BatReplaceabilityEnum), // 171
  _ENTRY(_PowerSource_PowerSourceStatusEnum), // 172
  _ENTRY(_PowerSource_WiredCurrentTypeEnum), // 173
  _ENTRY(_PowerSource_WiredFaultEnum), // 174
  _ENTRY(_PowerSource_Feature), // 175
  _ENTRY(_GeneralCommissioning), // 176
  _ENTRY(_GeneralCommissioning_BasicCommissioningInfo), // 177
  _ENTRY(_GeneralCommissioning_ArmFailSafeRequest), // 178
  _ENTRY(_GeneralCommissioning_ArmFailSafeResponse), // 179
  _ENTRY(_GeneralCommissioning_SetRegulatoryConfigRequest), // 180
  _ENTRY(_GeneralCommissioning_SetRegulatoryConfigResponse), // 181
  _ENTRY(_GeneralCommissioning_CommissioningCompleteResponse), // 182
  _ENTRY(_GeneralCommissioning_CommissioningErrorEnum), // 183
  _ENTRY(_GeneralCommissioning_RegulatoryLocationTypeEnum), // 184
  _ENTRY(_NetworkCommissioning), // 185
  _ENTRY(_NetworkCommissioning_NetworkInfoStruct), // 186
  _ENTRY(_NetworkCommissioning_ThreadInterfaceScanResultStruct), // 187
  _ENTRY(_NetworkCommissioning_WiFiInterfaceScanResultStruct), // 188
  _ENTRY(_NetworkCommissioning_ScanNetworksRequest), // 189
  _ENTRY(_NetworkCommissioning_ScanNetworksResponse), // 190
  _ENTRY(_NetworkCommissioning_AddOrUpdateWiFiNetworkRequest), // 191
  _ENTRY(_NetworkCommissioning_AddOrUpdateThreadNetworkRequest), // 192
  _ENTRY(_NetworkCommissioning_RemoveNetworkRequest), // 193
  _ENTRY(_NetworkCommissioning_NetworkConfigResponse), // 194
  _ENTRY(_NetworkCommissioning_ConnectNetworkRequest), // 195
  _ENTRY(_NetworkCommissioning_ConnectNetworkResponse), // 196
  _ENTRY(_NetworkCommissioning_ReorderNetworkRequest), // 197
  _ENTRY(_NetworkCommissioning_ThreadInterfaceScanResultStruct_list_), // 198
  _ENTRY(_NetworkCommissioning_WiFiBandEnum_list_), // 199
  _ENTRY(_NetworkCommissioning_WiFiInterfaceScanResultStruct_list_), // 200
  _ENTRY(_NetworkCommissioning_NetworkInfoStruct_list_), // 201
  _ENTRY(_NetworkCommissioning_NetworkCommissioningStatusEnum), // 202
  _ENTRY(_NetworkCommissioning_WiFiBandEnum), // 203
  _ENTRY(_NetworkCommissioning_Feature), // 204
  _ENTRY(_NetworkCommissioning_ThreadCapabilitiesBitmap), // 205
  _ENTRY(_NetworkCommissioning_WiFiSecurityBitmap), // 206
  _ENTRY(_DiagnosticLogs), // 207
  _ENTRY(_DiagnosticLogs_RetrieveLogsRequestRequest), // 208
  _ENTRY(_DiagnosticLogs_RetrieveLogsResponse), // 209
  _ENTRY(_DiagnosticLogs_IntentEnum), // 210
  _ENTRY(_DiagnosticLogs_StatusEnum), // 211
  _ENTRY(_DiagnosticLogs_TransferProtocolEnum), // 212
  _ENTRY(_GeneralDiagnostics), // 213
  _ENTRY(_GeneralDiagnostics_NetworkInterface), // 214
  _ENTRY(_GeneralDiagnostics_TestEventTriggerRequest), // 215
  _ENTRY(_GeneralDiagnostics_HardwareFaultChange), // 216
  _ENTRY(_GeneralDiagnostics_RadioFaultChange), // 217
  _ENTRY(_GeneralDiagnostics_NetworkFaultChange), // 218
  _ENTRY(_GeneralDiagnostics_BootReason), // 219
  _ENTRY(_GeneralDiagnostics_NetworkFaultEnum_list_), // 220
  _ENTRY(_GeneralDiagnostics_RadioFaultEnum_list_), // 221
  _ENTRY(_GeneralDiagnostics_HardwareFaultEnum_list_), // 222
  _ENTRY(_GeneralDiagnostics_NetworkInterface_list_), // 223
  _ENTRY(_GeneralDiagnostics_BootReasonEnum), // 224
  _ENTRY(_GeneralDiagnostics_HardwareFaultEnum), // 225
  _ENTRY(_GeneralDiagnostics_InterfaceTypeEnum), // 226
  _ENTRY(_GeneralDiagnostics_NetworkFaultEnum), // 227
  _ENTRY(_GeneralDiagnostics_RadioFaultEnum), // 228
  _ENTRY(_SoftwareDiagnostics), // 229
  _ENTRY(_SoftwareDiagnostics_ThreadMetricsStruct), // 230
  _ENTRY(_SoftwareDiagnostics_SoftwareFault), // 231
  _ENTRY(_SoftwareDiagnostics_ThreadMetricsStruct_list_), // 232
  _ENTRY(_SoftwareDiagnostics_Feature), // 233
  _ENTRY(_ThreadNetworkDiagnostics), // 234
  _ENTRY(_ThreadNetworkDiagnostics_NeighborTableStruct), // 235
  _ENTRY(_ThreadNetworkDiagnostics_OperationalDatasetComponents), // 236
  _ENTRY(_ThreadNetworkDiagnostics_RouteTableStruct), // 237
  _ENTRY(_ThreadNetworkDiagnostics_SecurityPolicy), // 238
  _ENTRY(_ThreadNetworkDiagnostics_ConnectionStatus), // 239
  _ENTRY(_ThreadNetworkDiagnostics_NetworkFaultChange), // 240
  ...
  _ENTRY(_ThreadNetworkDiagnostics_RouteTableStruct_list_), // 243
  _ENTRY(_ThreadNetworkDiagnostics_ConnectionStatusEnum), // 244
  _ENTRY(_ThreadNetworkDiagnostics_NetworkFaultEnum), // 245
  _ENTRY(_ThreadNetworkDiagnostics_RoutingRoleEnum), // 246
  _ENTRY(_ThreadNetworkDiagnostics_Feature), // 247
  _ENTRY(_WiFiNetworkDiagnostics), // 248
  _ENTRY(_WiFiNetworkDiagnostics_Disconnection), // 249
  _ENTRY(_WiFiNetworkDiagnostics_AssociationFailure), // 250
  _ENTRY(_WiFiNetworkDiagnostics_ConnectionStatus), // 251
  _ENTRY(_WiFiNetworkDiagnostics_AssociationFailureCauseEnum), // 252
  _ENTRY(_WiFiNetworkDiagnostics_ConnectionStatusEnum), // 253
  _ENTRY(_WiFiNetworkDiagnostics_SecurityTypeEnum), // 254
  _ENTRY(_WiFiNetworkDiagnostics_WiFiVersionEnum), // 255
  _ENTRY(_WiFiNetworkDiagnostics_Feature), // 256
  _ENTRY(_EthernetNetworkDiagnostics), // 257
  _ENTRY(_EthernetNetworkDiagnostics_PHYRateEnum), // 258
  _ENTRY(_EthernetNetworkDiagnostics_Feature), // 259
  _ENTRY(_TimeSynchronization), // 260
  _ENTRY(_TimeSynchronization_DSTOffsetStruct), // 261
  _ENTRY(_TimeSynchronization_FabricScopedTrustedTimeSourceStruct), // 262
  _ENTRY(_TimeSynchronization_TimeZoneStruct), // 263
  _ENTRY(_TimeSynchronization_TrustedTimeSourceStruct), // 264
  _ENTRY(_TimeSynchronization_SetUTCTimeRequest), // 265
  _ENTRY(_TimeSynchronization_SetTrustedTimeSourceRequest), // 266
  _ENTRY(_TimeSynchronization_SetTimeZoneRequest), // 267
  _ENTRY(_TimeSynchronization_SetTimeZoneResponse), // 268
  _ENTRY(_TimeSynchronization_SetDSTOffsetRequest), // 269
  _ENTRY(_TimeSynchronization_SetDefaultNTPRequest), // 270
  _ENTRY(_TimeSynchronization_DSTStatus), // 271
  _ENTRY(_TimeSynchronization_TimeZoneStatus), // 272
  _ENTRY(_TimeSynchronization_DSTOffsetStruct_list_), // 273
  _ENTRY(_TimeSynchronization_TimeZoneStruct_list_), // 274
  _ENTRY(_TimeSynchronization_GranularityEnum), // 275
  _ENTRY(_TimeSynchronization_StatusCode), // 276
  _ENTRY(_TimeSynchronization_TimeSourceEnum), // 277
  _ENTRY(_TimeSynchronization_TimeZoneDatabaseEnum), // 278
  _ENTRY(_TimeSynchronization_Feature), // 279
  _ENTRY(_BridgedDeviceBasicInformation), // 280
  _ENTRY(_BridgedDeviceBasicInformation_ProductAppearanceStruct), // 281
  _ENTRY(_BridgedDeviceBasicInformation_StartUp), // 282
  _ENTRY(_BridgedDeviceBasicInformation_ReachableChanged), // 283
  _ENTRY(_BridgedDeviceBasicInformation_ColorEnum), // 284
  _ENTRY(_BridgedDeviceBasicInformation_ProductFinishEnum), // 285
  _ENTRY(_Switch), // 286
  _ENTRY(_Switch_SwitchLatched), // 287
  _ENTRY(_Switch_InitialPress), // 288
  _ENTRY(_Switch_LongPress), // 289
  _ENTRY(_Switch_ShortRelease), // 290
  _ENTRY(_Switch_LongRelease), // 291
  _ENTRY(_Switch_MultiPressOngoing), // 292
  _ENTRY(_Switch_MultiPressComplete), // 293
  _ENTRY(_Switch_Feature), // 294
  _ENTRY(_AdministratorCommissioning), // 295
  _ENTRY(_AdministratorCommissioning_OpenCommissioningWindowRequest), // 296
  _ENTRY(_AdministratorCommissioning_OpenBasicCommissioningWindowRequest), // 297
  _ENTRY(_AdministratorCommissioning_CommissioningWindowStatusEnum), // 298
  _ENTRY(_AdministratorCommissioning_StatusCode), // 299
  _ENTRY(_AdministratorCommissioning_Feature), // 300
  _ENTRY(_OperationalCredentials), // 301
  _ENTRY(_OperationalCredentials_FabricDescriptorStruct), // 302
  _ENTRY(_OperationalCredentials_NOCStruct), // 303
  _ENTRY(_OperationalCredentials_AttestationRequestRequest), // 304
  _ENTRY(_OperationalCredentials_AttestationResponse), // 305
  _ENTRY(_OperationalCredentials_CertificateChainRequestRequest), // 306
  _ENTRY(_OperationalCredentials_CertificateChainResponse), // 307
  _ENTRY(_OperationalCredentials_CSRRequestRequest), // 308
  _ENTRY(_OperationalCredentials_CSRResponse), // 309
  _ENTRY(_OperationalCredentials_AddNOCRequest), // 310
  _ENTRY(_OperationalCredentials_UpdateNOCRequest), // 311
  _ENTRY(_OperationalCredentials_NOCResponse), // 312
  _ENTRY(_OperationalCredentials_UpdateFabricLabelRequest), // 313
  _ENTRY(_OperationalCredentials_RemoveFabricRequest), // 314
  _ENTRY(_OperationalCredentials_AddTrustedRootCertificateRequest), // 315
  _ENTRY(_OperationalCredentials_NOCStruct_list_), // 316
  _ENTRY(_OperationalCredentials_FabricDescriptorStruct_list_), // 317
  _ENTRY(_OperationalCredentials_CertificateChainTypeEnum), // 318
  _ENTRY(_OperationalCredentials_NodeOperationalCertStatusEnum), // 319
  _ENTRY(_GroupKeyManagement), // 320
  _ENTRY(_GroupKeyManagement_GroupInfoMapStruct), // 321
  _ENTRY(_GroupKeyManagement_GroupKeyMapStruct), // 322
  _ENTRY(_GroupKeyManagement_GroupKeySetStruct), // 323
  _ENTRY(_GroupKeyManagement_KeySetWriteRequest), // 324
  _ENTRY(_GroupKeyManagement_KeySetReadRequest), // 325
  _ENTRY(_GroupKeyManagement_KeySetReadResponse), // 326
  _ENTRY(_GroupKeyManagement_KeySetRemoveRequest), // 327
  _ENTRY(_GroupKeyManagement_KeySetReadAllIndicesResponse), // 328
  _ENTRY(_GroupKeyManagement_GroupKeyMapStruct_list_), // 329
  _ENTRY(_GroupKeyManagement_GroupInfoMapStruct_list_), // 330
  _ENTRY(_GroupKeyManagement_GroupKeySecurityPolicyEnum), // 331
  _ENTRY(_GroupKeyManagement_Feature), // 332
  _ENTRY(_FixedLabel), // 333
  _ENTRY(_FixedLabel_LabelStruct), // 334
  _ENTRY(_FixedLabel_LabelStruct_list_), // 335
  _ENTRY(_UserLabel), // 336
  _ENTRY(_UserLabel_LabelStruct), // 337
  _ENTRY(_UserLabel_LabelStruct_list_), // 338
  _ENTRY(_ProxyConfiguration), // 339
  _ENTRY(_ProxyDiscovery), // 340
  _ENTRY(_ProxyValid), // 341
  _ENTRY(_BooleanState), // 342
  _ENTRY(_BooleanState_StateChange), // 343
  _ENTRY(_IcdManagement), // 344
  _ENTRY(_IcdManagement_MonitoringRegistrationStruct), // 345
  _ENTRY(_IcdManagement_RegisterClientRequest), // 346
  _ENTRY(_IcdManagement_RegisterClientResponse), // 347
  _ENTRY(_IcdManagement_UnregisterClientRequest), // 348
  _ENTRY(_IcdManagement_MonitoringRegistrationStruct_list_), // 349
  _ENTRY(_IcdManagement_Feature), // 350
  _ENTRY(_IcdManagement_UserActiveModeTriggerBitmap), // 351
  _ENTRY(_ModeSelect), // 352
  _ENTRY(_ModeSelect_SemanticTagStruct), // 353
  _ENTRY(_ModeSelect_ModeOptionStruct), // 354
  _ENTRY(_ModeSelect_ChangeToModeRequest), // 355
  _ENTRY(_ModeSelect_SemanticTagStruct_list_), // 356
  _ENTRY(_ModeSelect_ModeOptionStruct_list_), // 357
  _ENTRY(_ModeSelect_Feature), // 358
  _ENTRY(_LaundryWasherMode), // 359
  _ENTRY(_LaundryWasherMode_ModeTagStruct), // 360
  _ENTRY(_LaundryWasherMode_ModeOptionStruct), // 361
  _ENTRY(_LaundryWasherMode_ChangeToModeRequest), // 362
  _ENTRY(_LaundryWasherMode_ChangeToModeResponse), // 363
  _ENTRY(_LaundryWasherMode_ModeOptionStruct_list_), // 364
  _ENTRY(_LaundryWasherMode_ModeTagStruct_list_), // 365
  _ENTRY(_LaundryWasherMode_ModeTag), // 366
  _ENTRY(_LaundryWasherMode_Feature), // 367
  _ENTRY(_RefrigeratorAndTemperatureControlledCabinetMode), // 368
  _ENTRY(_RefrigeratorAndTemperatureControlledCabinetMode_ModeTagStruct), // 369
  _ENTRY(_RefrigeratorAndTemperatureControlledCabinetMode_ModeOptionStruct), // 370
  _ENTRY(_RefrigeratorAndTemperatureControlledCabinetMode_ChangeToModeRequest), // 371
  _ENTRY(_RefrigeratorAndTemperatureControlledCabinetMode_ChangeToModeResponse), // 372
  _ENTRY(_RefrigeratorAndTemperatureControlledCabinetMode_ModeOptionStruct_list_), // 373
  _ENTRY(_RefrigeratorAndTemperatureControlledCabinetMode_ModeTagStruct_list_), // 374
  _ENTRY(_RefrigeratorAndTemperatureControlledCabinetMode_ModeTag), // 375
  _ENTRY(_RefrigeratorAndTemperatureControlledCabinetMode_Feature), // 376
  _ENTRY(_LaundryWasherControls), // 377
  _ENTRY(_LaundryWasherControls_NumberOfRinsesEnum_list_), // 378
  _ENTRY(_LaundryWasherControls_NumberOfRinsesEnum), // 379
  _ENTRY(_LaundryWasherControls_Feature), // 380
  _ENTRY(_RvcRunMode), // 381
  _ENTRY(_RvcRunMode_ModeTagStruct), // 382
  _ENTRY(_RvcRunMode_ModeOptionStruct), // 383
  _ENTRY(_RvcRunMode_ChangeToModeRequest), // 384
  _ENTRY(_RvcRunMode_ChangeToModeResponse), // 385
  _ENTRY(_RvcRunMode_ModeOptionStruct_list_), // 386
  _ENTRY(_RvcRunMode_ModeTagStruct_list_), // 387
  _ENTRY(_RvcRunMode_ModeTag), // 388
  _ENTRY(_RvcRunMode_StatusCode), // 389
  _ENTRY(_RvcRunMode_Feature), // 390
  _ENTRY(_RvcCleanMode), // 391
  _ENTRY(_RvcCleanMode_ModeTagStruct), // 392
  _ENTRY(_RvcCleanMode_ModeOptionStruct), // 393
  _ENTRY(_RvcCleanMode_ChangeToModeRequest), // 394
  _ENTRY(_RvcCleanMode_ChangeToModeResponse), // 395
  _ENTRY(_RvcCleanMode_ModeOptionStruct_list_), // 396
  _ENTRY(_RvcCleanMode_ModeTagStruct_list_), // 397
  _ENTRY(_RvcCleanMode_ModeTag), // 398
  _ENTRY(_RvcCleanMode_StatusCode), // 399
  _ENTRY(_RvcCleanMode_Feature), // 400
  _ENTRY(_TemperatureControl), // 401
  _ENTRY(_TemperatureControl_SetTemperatureRequest), // 402
  _ENTRY(_TemperatureControl_Feature), // 403
  _ENTRY(_RefrigeratorAlarm), // 404
  _ENTRY(_RefrigeratorAlarm_Notify), // 405
  _ENTRY(_RefrigeratorAlarm_AlarmMap), // 406
  _ENTRY(_DishwasherMode), // 407
  _ENTRY(_DishwasherMode_ModeTagStruct), // 408
  _ENTRY(_DishwasherMode_ModeOptionStruct), // 409
  _ENTRY(_DishwasherMode_ChangeToModeRequest), // 410
  _ENTRY(_DishwasherMode_ChangeToModeResponse), // 411
  _ENTRY(_DishwasherMode_ModeTagStruct_list_), // 412
  _ENTRY(_DishwasherMode_ModeOptionStruct_list_), // 413
  _ENTRY(_DishwasherMode_ModeTag), // 414
  _ENTRY(_DishwasherMode_Feature), // 415
  _ENTRY(_AirQuality), // 416
  _ENTRY(_AirQuality_AirQualityEnum), // 417
  _ENTRY(_AirQuality_Feature), // 418
  _ENTRY(_SmokeCoAlarm), // 419
  _ENTRY(_SmokeCoAlarm_SmokeAlarm), // 420
  _ENTRY(_SmokeCoAlarm_COAlarm), // 421
  _ENTRY(_SmokeCoAlarm_LowBattery), // 422
  _ENTRY(_SmokeCoAlarm_InterconnectSmokeAlarm), // 423
  _ENTRY(_SmokeCoAlarm_InterconnectCOAlarm), // 424
  _ENTRY(_SmokeCoAlarm_AlarmStateEnum), // 425
  _ENTRY(_SmokeCoAlarm_ContaminationStateEnum), // 426
  _ENTRY(_SmokeCoAlarm_EndOfServiceEnum), // 427
  _ENTRY(_SmokeCoAlarm_ExpressedStateEnum), // 428
  _ENTRY(_SmokeCoAlarm_MuteStateEnum), // 429
  _ENTRY(_SmokeCoAlarm_SensitivityEnum), // 430
  _ENTRY(_SmokeCoAlarm_Feature), // 431
  _ENTRY(_DishwasherAlarm), // 432
  _ENTRY(_DishwasherAlarm_ResetRequest), // 433
  _ENTRY(_DishwasherAlarm_ModifyEnabledAlarmsRequest), // 434
  _ENTRY(_DishwasherAlarm_Notify), // 435
  _ENTRY(_DishwasherAlarm_AlarmMap), // 436
  _ENTRY(_DishwasherAlarm_Feature), // 437
  _ENTRY(_OperationalState), // 438
  _ENTRY(_OperationalState_ErrorStateStruct), // 439
  _ENTRY(_OperationalState_OperationalStateStruct), // 440
  _ENTRY(_OperationalState_OperationalCommandResponse), // 441
  _ENTRY(_OperationalState_OperationalError), // 442
  _ENTRY(_OperationalState_OperationCompletion), // 443
  _ENTRY(_OperationalState_OperationalStateStruct_list_), // 444
  _ENTRY(_OperationalState_ErrorStateEnum), // 445
  _ENTRY(_OperationalState_OperationalStateEnum), // 446
  _ENTRY(_RvcOperationalState), // 447
  _ENTRY(_RvcOperationalState_ErrorStateStruct), // 448
  _ENTRY(_RvcOperationalState_OperationalStateStruct), // 449
  _ENTRY(_RvcOperationalState_OperationalCommandResponse), // 450
  _ENTRY(_RvcOperationalState_OperationalError), // 451
  _ENTRY(_RvcOperationalState_OperationCompletion), // 452
  _ENTRY(_RvcOperationalState_OperationalStateStruct_list_), // 453
  _ENTRY(_RvcOperationalState_ErrorStateEnum), // 454
  _ENTRY(_RvcOperationalState_OperationalStateEnum), // 455
  _ENTRY(_HepaFilterMonitoring), // 456
  _ENTRY(_HepaFilterMonitoring_ReplacementProductStruct), // 457
  _ENTRY(_HepaFilterMonitoring_ReplacementProductStruct_list_), // 458
  _ENTRY(_HepaFilterMonitoring_ChangeIndicationEnum), // 459
  _ENTRY(_HepaFilterMonitoring_DegradationDirectionEnum), // 460
  _ENTRY(_HepaFilterMonitoring_ProductIdentifierTypeEnum), // 461
  _ENTRY(_HepaFilterMonitoring_Feature), // 462
  _ENTRY(_ActivatedCarbonFilterMonitoring), // 463
  _ENTRY(_ActivatedCarbonFilterMonitoring_ReplacementProductStruct), // 464
  _ENTRY(_ActivatedCarbonFilterMonitoring_ReplacementProductStruct_list_), // 465
  _ENTRY(_ActivatedCarbonFilterMonitoring_ChangeIndicationEnum), // 466
  _ENTRY(_ActivatedCarbonFilterMonitoring_DegradationDirectionEnum), // 467
  _ENTRY(_ActivatedCarbonFilterMonitoring_ProductIdentifierTypeEnum), // 468
  _ENTRY(_ActivatedCarbonFilterMonitoring_Feature), // 469
  _ENTRY(_DoorLock), // 470
  _ENTRY(_DoorLock_CredentialStruct), // 471
  _ENTRY(_DoorLock_LockDoorRequest), // 472
  _ENTRY(_DoorLock_UnlockDoorRequest), // 473
  _ENTRY(_DoorLock_UnlockWithTimeoutRequest), // 474
  _ENTRY(_DoorLock_SetWeekDayScheduleRequest), // 475
  _ENTRY(_DoorLock_GetWeekDayScheduleRequest), // 476
  _ENTRY(_DoorLock_GetWeekDayScheduleResponse), // 477
  _ENTRY(_DoorLock_ClearWeekDayScheduleRequest), // 478
  _ENTRY(_DoorLock_SetYearDayScheduleRequest), // 479
  _ENTRY(_DoorLock_GetYearDayScheduleRequest), // 480
  _ENTRY(_DoorLock_GetYearDayScheduleResponse), // 481
  _ENTRY(_DoorLock_ClearYearDayScheduleRequest), // 482
  _ENTRY(_DoorLock_SetHolidayScheduleRequest), // 483
  _ENTRY(_DoorLock_GetHolidayScheduleRequest), // 484
  _ENTRY(_DoorLock_GetHolidayScheduleResponse), // 485
  _ENTRY(_DoorLock_ClearHolidayScheduleRequest), // 486
  _ENTRY(_DoorLock_SetUserRequest), // 487
  _ENTRY(_DoorLock_GetUserRequest), // 488
  _ENTRY(_DoorLock_GetUserResponse), // 489
  _ENTRY(_DoorLock_ClearUserRequest), // 490
  _ENTRY(_DoorLock_SetCredentialRequest), // 491
  _ENTRY(_DoorLock_SetCredentialResponse), // 492
  _ENTRY(_DoorLock_GetCredentialStatusRequest), // 493
  _ENTRY(_DoorLock_GetCredentialStatusResponse), // 494
  _ENTRY(_DoorLock_ClearCredentialRequest), // 495
  _ENTRY(_DoorLock_UnboltDoorRequest), // 496
  _ENTRY(_DoorLock_DoorLockAlarm), // 497
  _ENTRY(_DoorLock_DoorStateChange), // 498
  _ENTRY(_DoorLock_LockOperation), // 499
  _ENTRY(_DoorLock_LockOperationError), // 500
  _ENTRY(_DoorLock_LockUserChange), // 501
  _ENTRY(_DoorLock_CredentialStruct_list_), // 502
  _ENTRY(_DoorLock_AlarmCodeEnum), // 503
  _ENTRY(_DoorLock_CredentialRuleEnum), // 504
  _ENTRY(_DoorLock_CredentialTypeEnum), // 505
  _ENTRY(_DoorLock_DataOperationTypeEnum), // 506
  _ENTRY(_DoorLock_DlLockState), // 507
  _ENTRY(_DoorLock_DlLockType), // 508
  _ENTRY(_DoorLock_DlStatus), // 509
  _ENTRY(_DoorLock_DoorLockOperationEventCode), // 510
  _ENTRY(_DoorLock_DoorLockProgrammingEventCode), // 511
  _ENTRY(_DoorLock_DoorLockSetPinOrIdStatus), // 512
  _ENTRY(_DoorLock_DoorLockUserStatus), // 513
  _ENTRY(_DoorLock_DoorLockUserType), // 514
  _ENTRY(_DoorLock_DoorStateEnum), // 515
  _ENTRY(_DoorLock_LockDataTypeEnum), // 516
  _ENTRY(_DoorLock_LockOperationTypeEnum), // 517
  _ENTRY(_DoorLock_OperatingModeEnum), // 518
  _ENTRY(_DoorLock_OperationErrorEnum), // 519
  _ENTRY(_DoorLock_OperationSourceEnum), // 520
  _ENTRY(_DoorLock_UserStatusEnum), // 521
  _ENTRY(_DoorLock_UserTypeEnum), // 522
  _ENTRY(_DoorLock_DaysMaskMap), // 523
  _ENTRY(_DoorLock_DlCredentialRuleMask), // 524
  _ENTRY(_DoorLock_DlCredentialRulesSupport), // 525
  _ENTRY(_DoorLock_DlDefaultConfigurationRegister), // 526
  _ENTRY(_DoorLock_DlKeypadOperationEventMask), // 527
  _ENTRY(_DoorLock_DlKeypadProgrammingEventMask), // 528
  _ENTRY(_DoorLock_DlLocalProgrammingFeatures), // 529
  _ENTRY(_DoorLock_DlManualOperationEventMask), // 530
  _ENTRY(_DoorLock_DlRFIDOperationEventMask), // 531
  _ENTRY(_DoorLock_DlRFIDProgrammingEventMask), // 532
  _ENTRY(_DoorLock_DlRemoteOperationEventMask), // 533
  _ENTRY(_DoorLock_DlRemoteProgrammingEventMask), // 534
  _ENTRY(_DoorLock_DlSupportedOperatingModes), // 535
  _ENTRY(_DoorLock_DoorLockDayOfWeek), // 536
  _ENTRY(_DoorLock_Feature), // 537
  _ENTRY(_WindowCovering), // 538
  _ENTRY(_WindowCovering_GoToLiftValueRequest), // 539
  _ENTRY(_WindowCovering_GoToLiftPercentageRequest), // 540
  _ENTRY(_WindowCovering_GoToTiltValueRequest), // 541
  _ENTRY(_WindowCovering_GoToTiltPercentageRequest), // 542
  _ENTRY(_WindowCovering_EndProductType), // 543
  _ENTRY(_WindowCovering_Type), // 544
  _ENTRY(_WindowCovering_ConfigStatus), // 545
  _ENTRY(_WindowCovering_Feature), // 546
  _ENTRY(_WindowCovering_Mode), // 547
  _ENTRY(_WindowCovering_OperationalStatus), // 548
  _ENTRY(_WindowCovering_SafetyStatus), // 549
  _ENTRY(_BarrierControl), // 550
  _ENTRY(_BarrierControl_BarrierControlGoToPercentRequest), // 551
  _ENTRY(_BarrierControl_BarrierControlCapabilities), // 552
  _ENTRY(_BarrierControl_BarrierControlSafetyStatus), // 553
  _ENTRY(_PumpConfigurationAndControl), // 554
  _ENTRY(_PumpConfigurationAndControl_ControlModeEnum), // 555
  _ENTRY(_PumpConfigurationAndControl_OperationModeEnum), // 556
  _ENTRY(_PumpConfigurationAndControl_Feature), // 557
  _ENTRY(_PumpConfigurationAndControl_PumpStatusBitmap), // 558
  _ENTRY(_Thermostat), // 559
  _ENTRY(_Thermostat_ThermostatScheduleTransition), // 560
  _ENTRY(_Thermostat_SetpointRaiseLowerRequest), // 561
  _ENTRY(_Thermostat_GetWeeklyScheduleResponse), // 562
  _ENTRY(_Thermostat_SetWeeklyScheduleRequest), // 563
  _ENTRY(_Thermostat_GetWeeklyScheduleRequest), // 564
  _ENTRY(_Thermostat_ThermostatScheduleTransition_list_), // 565
  _ENTRY(_Thermostat_SetpointAdjustMode), // 566
  _ENTRY(_Thermostat_ThermostatControlSequence), // 567
  _ENTRY(_Thermostat_ThermostatRunningMode), // 568
  _ENTRY(_Thermostat_ThermostatSystemMode), // 569
  _ENTRY(_Thermostat_DayOfWeek), // 570
  _ENTRY(_Thermostat_Feature), // 571
  _ENTRY(_Thermostat_ModeForSequence), // 572
  _ENTRY(_FanControl), // 573
  _ENTRY(_FanControl_StepRequest), // 574
  _ENTRY(_FanControl_AirflowDirectionEnum), // 575
  _ENTRY(_FanControl_FanModeEnum), // 576
  _ENTRY(_FanControl_FanModeSequenceEnum), // 577
  _ENTRY(_FanControl_StepDirectionEnum), // 578
  _ENTRY(_FanControl_Feature), // 579
  _ENTRY(_FanControl_RockBitmap), // 580
  _ENTRY(_FanControl_WindBitmap), // 581
  _ENTRY(_ThermostatUserInterfaceConfiguration), // 582
  _ENTRY(_ColorControl), // 583
  _ENTRY(_ColorControl_MoveToHueRequest), // 584
  _ENTRY(_ColorControl_MoveHueRequest), // 585
  _ENTRY(_ColorControl_StepHueRequest), // 586
  _ENTRY(_ColorControl_MoveToSaturationRequest), // 587
  _ENTRY(_ColorControl_MoveSaturationRequest), // 588
  _ENTRY(_ColorControl_StepSaturationRequest), // 589
  _ENTRY(_ColorControl_MoveToHueAndSaturationRequest), // 590
  _ENTRY(_ColorControl_MoveToColorRequest), // 591
  _ENTRY(_ColorControl_MoveColorRequest), // 592
  _ENTRY(_ColorControl_StepColorRequest), // 593
  _ENTRY(_ColorControl_MoveToColorTemperatureRequest), // 594
  _ENTRY(_ColorControl_EnhancedMoveToHueRequest), // 595
  _ENTRY(_ColorControl_EnhancedMoveHueRequest), // 596
  _ENTRY(_ColorControl_EnhancedStepHueRequest), // 597
  _ENTRY(_ColorControl_EnhancedMoveToHueAndSaturationRequest), // 598
  _ENTRY(_ColorControl_ColorLoopSetRequest), // 599
  _ENTRY(_ColorControl_StopMoveStepRequest), // 600
  _ENTRY(_ColorControl_MoveColorTemperatureRequest), // 601
  _ENTRY(_ColorControl_StepColorTemperatureRequest), // 602
  _ENTRY(_ColorControl_ColorLoopAction), // 603
  _ENTRY(_ColorControl_ColorLoopDirection), // 604
  _ENTRY(_ColorControl_ColorMode), // 605
  _ENTRY(_ColorControl_HueDirection), // 606
  _ENTRY(_ColorControl_HueMoveMode), // 607
  _ENTRY(_ColorControl_HueStepMode), // 608
  _ENTRY(_ColorControl_SaturationMoveMode), // 609
  _ENTRY(_ColorControl_SaturationStepMode), // 610
  _ENTRY(_ColorControl_ColorCapabilities), // 611
  _ENTRY(_ColorControl_ColorLoopUpdateFlags), // 612
  _ENTRY(_ColorControl_Feature), // 613
  _ENTRY(_BallastConfiguration), // 614
  _ENTRY(_BallastConfiguration_BallastStatusBitmap), // 615
  _ENTRY(_BallastConfiguration_LampAlarmModeBitmap), // 616
  _ENTRY(_IlluminanceMeasurement), // 617
  _ENTRY(_IlluminanceMeasurement_LightSensorTypeEnum), // 618
  _ENTRY(_TemperatureMeasurement), // 619
  _ENTRY(_PressureMeasurement), // 620
  _ENTRY(_PressureMeasurement_Feature), // 621
  _ENTRY(_FlowMeasurement), // 622
  _ENTRY(_RelativeHumidityMeasurement), // 623
  _ENTRY(_OccupancySensing), // 624
  _ENTRY(_OccupancySensing_OccupancySensorTypeEnum), // 625
  _ENTRY(_OccupancySensing_OccupancyBitmap), // 626
  _ENTRY(_OccupancySensing_OccupancySensorTypeBitmap), // 627
  _ENTRY(_CarbonMonoxideConcentrationMeasurement), // 628
  _ENTRY(_CarbonMonoxideConcentrationMeasurement_LevelValueEnum), // 629
  _ENTRY(_CarbonMonoxideConcentrationMeasurement_MeasurementMediumEnum), // 630
  _ENTRY(_CarbonMonoxideConcentrationMeasurement_MeasurementUnitEnum), // 631
  _ENTRY(_CarbonMonoxideConcentrationMeasurement_Feature), // 632
  _ENTRY(_CarbonDioxideConcentrationMeasurement), // 633
  _ENTRY(_CarbonDioxideConcentrationMeasurement_LevelValueEnum), // 634
  _ENTRY(_CarbonDioxideConcentrationMeasurement_MeasurementMediumEnum), // 635
  _ENTRY(_CarbonDioxideConcentrationMeasurement_MeasurementUnitEnum), // 636
  _ENTRY(_CarbonDioxideConcentrationMeasurement_Feature), // 637
  _ENTRY(_NitrogenDioxideConcentrationMeasurement), // 638
  _ENTRY(_NitrogenDioxideConcentrationMeasurement_LevelValueEnum), // 639
  _ENTRY(_NitrogenDioxideConcentrationMeasurement_MeasurementMediumEnum), // 640
  _ENTRY(_NitrogenDioxideConcentrationMeasurement_MeasurementUnitEnum), // 641
  _ENTRY(_NitrogenDioxideConcentrationMeasurement_Feature), // 642
  _ENTRY(_OzoneConcentrationMeasurement), // 643
  _ENTRY(_OzoneConcentrationMeasurement_LevelValueEnum), // 644
  _ENTRY(_OzoneConcentrationMeasurement_MeasurementMediumEnum), // 645
  _ENTRY(_OzoneConcentrationMeasurement_MeasurementUnitEnum), // 646
  _ENTRY(_OzoneConcentrationMeasurement_Feature), // 647
  _ENTRY(_Pm25ConcentrationMeasurement), // 648
  _ENTRY(_Pm25ConcentrationMeasurement_LevelValueEnum), // 649
  _ENTRY(_Pm25ConcentrationMeasurement_MeasurementMediumEnum), // 650
  _ENTRY(_Pm25ConcentrationMeasurement_MeasurementUnitEnum), // 651
  _ENTRY(_Pm25ConcentrationMeasurement_Feature), // 652
  _ENTRY(_FormaldehydeConcentrationMeasurement), // 653
  _ENTRY(_FormaldehydeConcentrationMeasurement_LevelValueEnum), // 654
  _ENTRY(_FormaldehydeConcentrationMeasurement_MeasurementMediumEnum), // 655
  _ENTRY(_FormaldehydeConcentrationMeasurement_MeasurementUnitEnum), // 656
  _ENTRY(_FormaldehydeConcentrationMeasurement_Feature), // 657
  _ENTRY(_Pm1ConcentrationMeasurement), // 658
  _ENTRY(_Pm1ConcentrationMeasurement_LevelValueEnum), // 659
  _ENTRY(_Pm1ConcentrationMeasurement_MeasurementMediumEnum), // 660
  _ENTRY(_Pm1ConcentrationMeasurement_MeasurementUnitEnum), // 661
  _ENTRY(_Pm1ConcentrationMeasurement_Feature), // 662
  _ENTRY(_Pm10ConcentrationMeasurement), // 663
  _ENTRY(_Pm10ConcentrationMeasurement_LevelValueEnum), // 664
  _ENTRY(_Pm10ConcentrationMeasurement_MeasurementMediumEnum), // 665
  _ENTRY(_Pm10ConcentrationMeasurement_MeasurementUnitEnum), // 666
  _ENTRY(_Pm10ConcentrationMeasurement_Feature), // 667
  _ENTRY(_TotalVolatileOrganicCompoundsConcentrationMeasurement), // 668
  _ENTRY(_TotalVolatileOrganicCompoundsConcentrationMeasurement_LevelValueEnum), // 669
  _ENTRY(_TotalVolatileOrganicCompoundsConcentrationMeasurement_MeasurementMediumEnum), // 670
  _ENTRY(_TotalVolatileOrganicCompoundsConcentrationMeasurement_MeasurementUnitEnum), // 671
  _ENTRY(_TotalVolatileOrganicCompoundsConcentrationMeasurement_Feature), // 672
  _ENTRY(_RadonConcentrationMeasurement), // 673
  _ENTRY(_RadonConcentrationMeasurement_LevelValueEnum), // 674
  _ENTRY(_RadonConcentrationMeasurement_MeasurementMediumEnum), // 675
  _ENTRY(_RadonConcentrationMeasurement_MeasurementUnitEnum), // 676
  _ENTRY(_RadonConcentrationMeasurement_Feature), // 677
  _ENTRY(_WakeOnLan), // 678
  _ENTRY(_Channel), // 679
  _ENTRY(_Channel_ChannelInfoStruct), // 680
  _ENTRY(_Channel_LineupInfoStruct), // 681
  _ENTRY(_Channel_ChangeChannelRequest), // 682
  _ENTRY(_Channel_ChangeChannelResponse), // 683
  _ENTRY(_Channel_ChangeChannelByNumberRequest), // 684
  _ENTRY(_Channel_SkipChannelRequest), // 685
  _ENTRY(_Channel_ChannelInfoStruct_list_), // 686
  _ENTRY(_Channel_ChannelStatusEnum), // 687
  _ENTRY(_Channel_LineupInfoTypeEnum), // 688
  _ENTRY(_Channel_Feature), // 689
  _ENTRY(_TargetNavigator), // 690
  _ENTRY(_TargetNavigator_TargetInfoStruct), // 691
  _ENTRY(_TargetNavigator_NavigateTargetRequest), // 692
  _ENTRY(_TargetNavigator_NavigateTargetResponse), // 693
  _ENTRY(_TargetNavigator_TargetInfoStruct_list_), // 694
  _ENTRY(_TargetNavigator_TargetNavigatorStatusEnum), // 695
  _ENTRY(_MediaPlayback), // 696
  _ENTRY(_MediaPlayback_PlaybackPositionStruct), // 697
  _ENTRY(_MediaPlayback_SkipForwardRequest), // 698
  _ENTRY(_MediaPlayback_SkipBackwardRequest), // 699
  _ENTRY(_MediaPlayback_PlaybackResponse), // 700
  _ENTRY(_MediaPlayback_SeekRequest), // 701
  _ENTRY(_MediaPlayback_MediaPlaybackStatusEnum), // 702
  _ENTRY(_MediaPlayback_PlaybackStateEnum), // 703
  _ENTRY(_MediaPlayback_Feature), // 704
  _ENTRY(_MediaInput), // 705
  _ENTRY(_MediaInput_InputInfoStruct), // 706
  _ENTRY(_MediaInput_SelectInputRequest), // 707
  _ENTRY(_MediaInput_RenameInputRequest), // 708
  _ENTRY(_MediaInput_InputInfoStruct_list_), // 709
  _ENTRY(_MediaInput_InputTypeEnum), // 710
  _ENTRY(_MediaInput_Feature), // 711
  _ENTRY(_LowPower), // 712
  _ENTRY(_KeypadInput), // 713
  _ENTRY(_KeypadInput_SendKeyRequest), // 714
  _ENTRY(_KeypadInput_SendKeyResponse), // 715
  _ENTRY(_KeypadInput_CecKeyCode), // 716
  _ENTRY(_KeypadInput_KeypadInputStatusEnum), // 717
  _ENTRY(_KeypadInput_Feature), // 718
  _ENTRY(_ContentLauncher), // 719
  _ENTRY(_ContentLauncher_DimensionStruct), // 720
  _ENTRY(_ContentLauncher_AdditionalInfoStruct), // 721
  _ENTRY(_ContentLauncher_ParameterStruct), // 722
  _ENTRY(_ContentLauncher_ContentSearchStruct), // 723
  _ENTRY(_ContentLauncher_StyleInformationStruct), // 724
  _ENTRY(_ContentLauncher_BrandingInformationStruct), // 725
  _ENTRY(_ContentLauncher_LaunchContentRequest), // 726
  _ENTRY(_ContentLauncher_LaunchURLRequest), // 727
  _ENTRY(_ContentLauncher_LauncherResponse), // 728
  _ENTRY(_ContentLauncher_ParameterStruct_list_), // 729
  _ENTRY(_ContentLauncher_AdditionalInfoStruct_list_), // 730
  _ENTRY(_ContentLauncher_ContentLaunchStatusEnum), // 731
  _ENTRY(_ContentLauncher_MetricTypeEnum), // 732
  _ENTRY(_ContentLauncher_ParameterEnum), // 733
  _ENTRY(_ContentLauncher_Feature), // 734
  _ENTRY(_ContentLauncher_SupportedStreamingProtocol), // 735
  _ENTRY(_AudioOutput), // 736
  _ENTRY(_AudioOutput_OutputInfoStruct), // 737
  _ENTRY(_AudioOutput_SelectOutputRequest), // 738
  _ENTRY(_AudioOutput_RenameOutputRequest), // 739
  _ENTRY(_AudioOutput_OutputInfoStruct_list_), // 740
  _ENTRY(_AudioOutput_OutputTypeEnum), // 741
  _ENTRY(_AudioOutput_Feature), // 742
  _ENTRY(_ApplicationLauncher), // 743
  _ENTRY(_ApplicationLauncher_ApplicationStruct), // 744
  _ENTRY(_ApplicationLauncher_ApplicationEPStruct), // 745
  _ENTRY(_ApplicationLauncher_LaunchAppRequest), // 746
  _ENTRY(_ApplicationLauncher_StopAppRequest), // 747
  _ENTRY(_ApplicationLauncher_HideAppRequest), // 748
  _ENTRY(_ApplicationLauncher_LauncherResponse), // 749
  _ENTRY(_ApplicationLauncher_ApplicationLauncherStatusEnum), // 750
  _ENTRY(_ApplicationLauncher_Feature), // 751
  _ENTRY(_ApplicationBasic), // 752
  _ENTRY(_ApplicationBasic_ApplicationStruct), // 753
  _ENTRY(_ApplicationBasic_ApplicationStatusEnum), // 754
  _ENTRY(_AccountLogin), // 755
  _ENTRY(_AccountLogin_GetSetupPINRequest), // 756
  _ENTRY(_AccountLogin_GetSetupPINResponse), // 757
  _ENTRY(_AccountLogin_LoginRequest), // 758
  _ENTRY(_ElectricalMeasurement), // 759
  _ENTRY(_ElectricalMeasurement_GetProfileInfoResponseCommand), // 760
  _ENTRY(_ElectricalMeasurement_GetMeasurementProfileResponseCommand), // 761
  _ENTRY(_ElectricalMeasurement_GetMeasurementProfileCommandRequest), // 762
  _ENTRY(_UnitTesting), // 763
  _ENTRY(_UnitTesting_SimpleStruct), // 764
  _ENTRY(_UnitTesting_TestFabricScoped), // 765
  _ENTRY(_UnitTesting_NullablesAndOptionalsStruct), // 766
  _ENTRY(_UnitTesting_NestedStruct), // 767
  _ENTRY(_UnitTesting_NestedStructList), // 768
  _ENTRY(_UnitTesting_DoubleNestedStructList), // 769
  _ENTRY(_UnitTesting_TestListStructOctet), // 770
  _ENTRY(_UnitTesting_TestSpecificResponse), // 771
  _ENTRY(_UnitTesting_TestAddArgumentsResponse), // 772
  _ENTRY(_UnitTesting_TestSimpleArgumentResponse), // 773
  _ENTRY(_UnitTesting_TestStructArrayArgumentResponse), // 774
  _ENTRY(_UnitTesting_TestAddArgumentsRequest), // 775
  _ENTRY(_UnitTesting_TestListInt8UReverseResponse), // 776
  _ENTRY(_UnitTesting_TestSimpleArgumentRequestRequest), // 777
  _ENTRY(_UnitTesting_TestEnumsResponse), // 778
  _ENTRY(_UnitTesting_TestStructArrayArgumentRequestRequest), // 779
  _ENTRY(_UnitTesting_TestNullableOptionalResponse), // 780
  _ENTRY(_UnitTesting_TestStructArgumentRequestRequest), // 781
  _ENTRY(_UnitTesting_TestComplexNullableOptionalResponse), // 782
  _ENTRY(_UnitTesting_TestNestedStructArgumentRequestRequest), // 783
  _ENTRY(_UnitTesting_BooleanResponse), // 784
  _ENTRY(_UnitTesting_TestListStructArgumentRequestRequest), // 785
  _ENTRY(_UnitTesting_SimpleStructResponse), // 786
  _ENTRY(_UnitTesting_TestListInt8UArgumentRequestRequest), // 787
  _ENTRY(_UnitTesting_TestEmitTestEventResponse), // 788
  _ENTRY(_UnitTesting_TestNestedStructListArgumentRequestRequest), // 789
  _ENTRY(_UnitTesting_TestEmitTestFabricScopedEventResponse), // 790
  _ENTRY(_UnitTesting_TestListNestedStructListArgumentRequestRequest), // 791
  _ENTRY(_UnitTesting_TestListInt8UReverseRequestRequest), // 792
  _ENTRY(_UnitTesting_TestEnumsRequestRequest), // 793
  _ENTRY(_UnitTesting_TestNullableOptionalRequestRequest), // 794
  _ENTRY(_UnitTesting_TestComplexNullableOptionalRequestRequest), // 795
  _ENTRY(_UnitTesting_SimpleStructEchoRequestRequest), // 796
  _ENTRY(_UnitTesting_TestSimpleOptionalArgumentRequestRequest), // 797
  _ENTRY(_UnitTesting_TestEmitTestEventRequestRequest), // 798
  _ENTRY(_UnitTesting_TestEmitTestFabricScopedEventRequestRequest), // 799
  _ENTRY(_UnitTesting_TestEvent), // 800
  _ENTRY(_UnitTesting_TestFabricScopedEvent), // 801
  _ENTRY(_UnitTesting_NullablesAndOptionalsStruct_list_), // 802
  _ENTRY(_UnitTesting_NestedStructList_list_), // 803
  _ENTRY(_UnitTesting_SimpleStruct_list_), // 804
  _ENTRY(_UnitTesting_SimpleEnum_list_), // 805
  _ENTRY(_UnitTesting_TestFabricScoped_list_), // 806
  _ENTRY(_UnitTesting_TestListStructOctet_list_), // 807
  _ENTRY(_UnitTesting_SimpleEnum), // 808
  _ENTRY(_UnitTesting_Bitmap16MaskMap), // 809
  _ENTRY(_UnitTesting_Bitmap32MaskMap), // 810
  _ENTRY(_UnitTesting_Bitmap64MaskMap), // 811
  _ENTRY(_UnitTesting_Bitmap8MaskMap), // 812
  _ENTRY(_UnitTesting_SimpleBitmap), // 813
  _ENTRY(_FaultInjection), // 814
  _ENTRY(_FaultInjection_FailAtFaultRequest), // 815
  _ENTRY(_FaultInjection_FailRandomlyAtFaultRequest), // 816
  _ENTRY(_FaultInjection_FaultType), // 817
  _ENTRY(_SampleMei), // 818
  _ENTRY(_SampleMei_AddArgumentsResponse), // 819
  _ENTRY(_SampleMei_AddArgumentsRequest), // 820
} };
