...
JNI_METHOD(void, PowerSourceCluster, readWiredAssessedInputVoltageAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::WiredAssessedInputVoltage::TypeInfo;
    std::unique_ptr<CHIPPowerSourceWiredAssessedInputVoltageAttributeCallback, void (*)(CHIPPowerSourceWiredAssessedInputVoltageAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceWiredAssessedInputVoltageAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceWiredAssessedInputVoltageAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readWiredAssessedInputFrequencyAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::WiredAssessedInputFrequency::TypeInfo;
    std::unique_ptr<CHIPPowerSourceWiredAssessedInputFrequencyAttributeCallback, void (*)(CHIPPowerSourceWiredAssessedInputFrequencyAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceWiredAssessedInputFrequencyAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceWiredAssessedInputFrequencyAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readWiredCurrentTypeAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readWiredAssessedCurrentAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::WiredAssessedCurrent::TypeInfo;
    std::unique_ptr<CHIPPowerSourceWiredAssessedCurrentAttributeCallback, void (*)(CHIPPowerSourceWiredAssessedCurrentAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceWiredAssessedCurrentAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceWiredAssessedCurrentAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readWiredNominalVoltageAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readWiredMaximumCurrentAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readWiredPresentAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readActiveWiredFaultsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::ActiveWiredFaults::TypeInfo;
    std::unique_ptr<CHIPPowerSourceActiveWiredFaultsAttributeCallback, void (*)(CHIPPowerSourceActiveWiredFaultsAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceActiveWiredFaultsAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceActiveWiredFaultsAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readBatVoltageAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::BatVoltage::TypeInfo;
    std::unique_ptr<CHIPPowerSourceBatVoltageAttributeCallback, void (*)(CHIPPowerSourceBatVoltageAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceBatVoltageAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceBatVoltageAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readBatPercentRemainingAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::BatPercentRemaining::TypeInfo;
    std::unique_ptr<CHIPPowerSourceBatPercentRemainingAttributeCallback, void (*)(CHIPPowerSourceBatPercentRemainingAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceBatPercentRemainingAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceBatPercentRemainingAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readBatTimeRemainingAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::BatTimeRemaining::TypeInfo;
    std::unique_ptr<CHIPPowerSourceBatTimeRemainingAttributeCallback, void (*)(CHIPPowerSourceBatTimeRemainingAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceBatTimeRemainingAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceBatTimeRemainingAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readBatChargeLevelAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatReplacementNeededAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatReplaceabilityAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatPresentAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readActiveBatFaultsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::ActiveBatFaults::TypeInfo;
    std::unique_ptr<CHIPPowerSourceActiveBatFaultsAttributeCallback, void (*)(CHIPPowerSourceActiveBatFaultsAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceActiveBatFaultsAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceActiveBatFaultsAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readBatReplacementDescriptionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatCommonDesignationAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatANSIDesignationAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatIECDesignationAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatApprovedChemistryAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatCapacityAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatQuantityAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatChargeStateAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatTimeToFullChargeAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::BatTimeToFullCharge::TypeInfo;
    std::unique_ptr<CHIPPowerSourceBatTimeToFullChargeAttributeCallback, void (*)(CHIPPowerSourceBatTimeToFullChargeAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceBatTimeToFullChargeAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceBatTimeToFullChargeAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readBatFunctionalWhileChargingAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, PowerSourceCluster, readBatChargingCurrentAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::BatChargingCurrent::TypeInfo;
    std::unique_ptr<CHIPPowerSourceBatChargingCurrentAttributeCallback, void (*)(CHIPPowerSourceBatChargingCurrentAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceBatChargingCurrentAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceBatChargingCurrentAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readActiveBatChargeFaultsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::ActiveBatChargeFaults::TypeInfo;
    std::unique_ptr<CHIPPowerSourceActiveBatChargeFaultsAttributeCallback, void (*)(CHIPPowerSourceActiveBatChargeFaultsAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceActiveBatChargeFaultsAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceActiveBatChargeFaultsAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readEndpointListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::EndpointList::TypeInfo;
    std::unique_ptr<CHIPPowerSourceEndpointListAttributeCallback, void (*)(CHIPPowerSourceEndpointListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceEndpointListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceEndpointListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPPowerSourceGeneratedCommandListAttributeCallback, void (*)(CHIPPowerSourceGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPPowerSourceAcceptedCommandListAttributeCallback, void (*)(CHIPPowerSourceAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::PowerSource::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPPowerSourceEventListAttributeCallback, void (*)(CHIPPowerSourceEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, PowerSourceCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    ...
    std::unique_ptr<CHIPPowerSourceAttributeListAttributeCallback, void (*)(CHIPPowerSourceAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPPowerSourceAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPPowerSourceAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
