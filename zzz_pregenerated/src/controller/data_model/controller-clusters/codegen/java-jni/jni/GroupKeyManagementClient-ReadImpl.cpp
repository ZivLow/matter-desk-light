...
JNI_METHOD(void, GroupKeyManagementCluster, readGroupKeyMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jboolean isFabricFiltered)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::GroupKeyManagement::Attributes::GroupKeyMap::TypeInfo;
    std::unique_ptr<CHIPGroupKeyManagementGroupKeyMapAttributeCallback, void (*)(CHIPGroupKeyManagementGroupKeyMapAttributeCallback *)> onSuccess(chip::Platform::New<CHIPGroupKeyManagementGroupKeyMapAttributeCallback>(callback, false), chip::Platform::Delete<CHIPGroupKeyManagementGroupKeyMapAttributeCallback>);
...
JNI_METHOD(void, GroupKeyManagementCluster, readGroupTableAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jboolean isFabricFiltered)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::GroupKeyManagement::Attributes::GroupTable::TypeInfo;
    std::unique_ptr<CHIPGroupKeyManagementGroupTableAttributeCallback, void (*)(CHIPGroupKeyManagementGroupTableAttributeCallback *)> onSuccess(chip::Platform::New<CHIPGroupKeyManagementGroupTableAttributeCallback>(callback, false), chip::Platform::Delete<CHIPGroupKeyManagementGroupTableAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, GroupKeyManagementCluster, readMaxGroupsPerFabricAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, GroupKeyManagementCluster, readMaxGroupKeysPerFabricAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, GroupKeyManagementCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::GroupKeyManagement::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPGroupKeyManagementGeneratedCommandListAttributeCallback, void (*)(CHIPGroupKeyManagementGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPGroupKeyManagementGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPGroupKeyManagementGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, GroupKeyManagementCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::GroupKeyManagement::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPGroupKeyManagementAcceptedCommandListAttributeCallback, void (*)(CHIPGroupKeyManagementAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPGroupKeyManagementAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPGroupKeyManagementAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, GroupKeyManagementCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::GroupKeyManagement::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPGroupKeyManagementEventListAttributeCallback, void (*)(CHIPGroupKeyManagementEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPGroupKeyManagementEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPGroupKeyManagementEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, GroupKeyManagementCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::GroupKeyManagement::Attributes::AttributeList::TypeInfo;
    std::unique_ptr<CHIPGroupKeyManagementAttributeListAttributeCallback, void (*)(CHIPGroupKeyManagementAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPGroupKeyManagementAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPGroupKeyManagementAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, GroupKeyManagementCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, GroupKeyManagementCluster, readClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
