...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readSupportedModesAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    ...
    std::unique_ptr<CHIPRefrigeratorAndTemperatureControlledCabinetModeSupportedModesAttributeCallback, void (*)(CHIPRefrigeratorAndTemperatureControlledCabinetModeSupportedModesAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRefrigeratorAndTemperatureControlledCabinetModeSupportedModesAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRefrigeratorAndTemperatureControlledCabinetModeSupportedModesAttributeCallback>);
...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readCurrentModeAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readStartUpModeAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RefrigeratorAndTemperatureControlledCabinetMode::Attributes::StartUpMode::TypeInfo;
    std::unique_ptr<CHIPRefrigeratorAndTemperatureControlledCabinetModeStartUpModeAttributeCallback, void (*)(CHIPRefrigeratorAndTemperatureControlledCabinetModeStartUpModeAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRefrigeratorAndTemperatureControlledCabinetModeStartUpModeAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRefrigeratorAndTemperatureControlledCabinetModeStartUpModeAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readOnModeAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RefrigeratorAndTemperatureControlledCabinetMode::Attributes::OnMode::TypeInfo;
    std::unique_ptr<CHIPRefrigeratorAndTemperatureControlledCabinetModeOnModeAttributeCallback, void (*)(CHIPRefrigeratorAndTemperatureControlledCabinetModeOnModeAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRefrigeratorAndTemperatureControlledCabinetModeOnModeAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRefrigeratorAndTemperatureControlledCabinetModeOnModeAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    ...
    std::unique_ptr<CHIPRefrigeratorAndTemperatureControlledCabinetModeGeneratedCommandListAttributeCallback, void (*)(CHIPRefrigeratorAndTemperatureControlledCabinetModeGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRefrigeratorAndTemperatureControlledCabinetModeGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRefrigeratorAndTemperatureControlledCabinetModeGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RefrigeratorAndTemperatureControlledCabinetMode::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPRefrigeratorAndTemperatureControlledCabinetModeAcceptedCommandListAttributeCallback, void (*)(CHIPRefrigeratorAndTemperatureControlledCabinetModeAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRefrigeratorAndTemperatureControlledCabinetModeAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRefrigeratorAndTemperatureControlledCabinetModeAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RefrigeratorAndTemperatureControlledCabinetMode::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPRefrigeratorAndTemperatureControlledCabinetModeEventListAttributeCallback, void (*)(CHIPRefrigeratorAndTemperatureControlledCabinetModeEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRefrigeratorAndTemperatureControlledCabinetModeEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRefrigeratorAndTemperatureControlledCabinetModeEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RefrigeratorAndTemperatureControlledCabinetMode::Attributes::AttributeList::TypeInfo;
    std::unique_ptr<CHIPRefrigeratorAndTemperatureControlledCabinetModeAttributeListAttributeCallback, void (*)(CHIPRefrigeratorAndTemperatureControlledCabinetModeAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRefrigeratorAndTemperatureControlledCabinetModeAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRefrigeratorAndTemperatureControlledCabinetModeAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, RefrigeratorAndTemperatureControlledCabinetModeCluster, readClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
