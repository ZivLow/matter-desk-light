...
JNI_METHOD(void, FaultInjectionCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::FaultInjection::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPFaultInjectionGeneratedCommandListAttributeCallback, void (*)(CHIPFaultInjectionGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPFaultInjectionGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPFaultInjectionGeneratedCommandListAttributeCallback>);
...
JNI_METHOD(void, FaultInjectionCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::FaultInjection::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPFaultInjectionAcceptedCommandListAttributeCallback, void (*)(CHIPFaultInjectionAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPFaultInjectionAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPFaultInjectionAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, FaultInjectionCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::FaultInjection::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPFaultInjectionEventListAttributeCallback, void (*)(CHIPFaultInjectionEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPFaultInjectionEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPFaultInjectionEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, FaultInjectionCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::FaultInjection::Attributes::AttributeList::TypeInfo;
    std::unique_ptr<CHIPFaultInjectionAttributeListAttributeCallback, void (*)(CHIPFaultInjectionAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPFaultInjectionAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPFaultInjectionAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, FaultInjectionCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, FaultInjectionCluster, readClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
