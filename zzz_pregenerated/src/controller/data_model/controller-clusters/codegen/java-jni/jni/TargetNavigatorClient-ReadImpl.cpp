...
JNI_METHOD(void, TargetNavigatorCluster, readTargetListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::TargetNavigator::Attributes::TargetList::TypeInfo;
    std::unique_ptr<CHIPTargetNavigatorTargetListAttributeCallback, void (*)(CHIPTargetNavigatorTargetListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTargetNavigatorTargetListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTargetNavigatorTargetListAttributeCallback>);
...
JNI_METHOD(void, TargetNavigatorCluster, readCurrentTargetAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, TargetNavigatorCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::TargetNavigator::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPTargetNavigatorGeneratedCommandListAttributeCallback, void (*)(CHIPTargetNavigatorGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTargetNavigatorGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTargetNavigatorGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, TargetNavigatorCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::TargetNavigator::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPTargetNavigatorAcceptedCommandListAttributeCallback, void (*)(CHIPTargetNavigatorAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTargetNavigatorAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTargetNavigatorAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, TargetNavigatorCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::TargetNavigator::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPTargetNavigatorEventListAttributeCallback, void (*)(CHIPTargetNavigatorEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTargetNavigatorEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTargetNavigatorEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, TargetNavigatorCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    ...
    std::unique_ptr<CHIPTargetNavigatorAttributeListAttributeCallback, void (*)(CHIPTargetNavigatorAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTargetNavigatorAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTargetNavigatorAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, TargetNavigatorCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, TargetNavigatorCluster, readClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
