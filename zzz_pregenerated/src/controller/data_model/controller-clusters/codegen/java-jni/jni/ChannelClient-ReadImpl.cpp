...
JNI_METHOD(void, ChannelCluster, readChannelListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    ...
    std::unique_ptr<CHIPChannelChannelListAttributeCallback, void (*)(CHIPChannelChannelListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPChannelChannelListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPChannelChannelListAttributeCallback>);
...
JNI_METHOD(void, ChannelCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::Channel::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPChannelGeneratedCommandListAttributeCallback, void (*)(CHIPChannelGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPChannelGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPChannelGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, ChannelCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::Channel::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPChannelAcceptedCommandListAttributeCallback, void (*)(CHIPChannelAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPChannelAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPChannelAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, ChannelCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::Channel::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPChannelEventListAttributeCallback, void (*)(CHIPChannelEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPChannelEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPChannelEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, ChannelCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    ...
    std::unique_ptr<CHIPChannelAttributeListAttributeCallback, void (*)(CHIPChannelAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPChannelAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPChannelAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, ChannelCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
