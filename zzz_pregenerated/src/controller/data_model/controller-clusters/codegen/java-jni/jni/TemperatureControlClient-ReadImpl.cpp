...
JNI_METHOD(void, TemperatureControlCluster, readTemperatureSetpointAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
...
JNI_METHOD(void, TemperatureControlCluster, readMinTemperatureAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, TemperatureControlCluster, readMaxTemperatureAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, TemperatureControlCluster, readStepAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, TemperatureControlCluster, readSelectedTemperatureLevelAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, TemperatureControlCluster, readSupportedTemperatureLevelsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::TemperatureControl::Attributes::SupportedTemperatureLevels::TypeInfo;
    std::unique_ptr<CHIPTemperatureControlSupportedTemperatureLevelsAttributeCallback, void (*)(CHIPTemperatureControlSupportedTemperatureLevelsAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTemperatureControlSupportedTemperatureLevelsAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTemperatureControlSupportedTemperatureLevelsAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, TemperatureControlCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::TemperatureControl::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPTemperatureControlGeneratedCommandListAttributeCallback, void (*)(CHIPTemperatureControlGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTemperatureControlGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTemperatureControlGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, TemperatureControlCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::TemperatureControl::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPTemperatureControlAcceptedCommandListAttributeCallback, void (*)(CHIPTemperatureControlAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTemperatureControlAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTemperatureControlAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, TemperatureControlCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::TemperatureControl::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPTemperatureControlEventListAttributeCallback, void (*)(CHIPTemperatureControlEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTemperatureControlEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTemperatureControlEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, TemperatureControlCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::TemperatureControl::Attributes::AttributeList::TypeInfo;
    std::unique_ptr<CHIPTemperatureControlAttributeListAttributeCallback, void (*)(CHIPTemperatureControlAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPTemperatureControlAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPTemperatureControlAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, TemperatureControlCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, TemperatureControlCluster, readClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
