...
JNI_METHOD(void, RvcOperationalStateCluster, readPhaseListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RvcOperationalState::Attributes::PhaseList::TypeInfo;
    std::unique_ptr<CHIPRvcOperationalStatePhaseListAttributeCallback, void (*)(CHIPRvcOperationalStatePhaseListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRvcOperationalStatePhaseListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRvcOperationalStatePhaseListAttributeCallback>);
...
JNI_METHOD(void, RvcOperationalStateCluster, readCurrentPhaseAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RvcOperationalState::Attributes::CurrentPhase::TypeInfo;
    std::unique_ptr<CHIPRvcOperationalStateCurrentPhaseAttributeCallback, void (*)(CHIPRvcOperationalStateCurrentPhaseAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRvcOperationalStateCurrentPhaseAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRvcOperationalStateCurrentPhaseAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RvcOperationalStateCluster, readCountdownTimeAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RvcOperationalState::Attributes::CountdownTime::TypeInfo;
    std::unique_ptr<CHIPRvcOperationalStateCountdownTimeAttributeCallback, void (*)(CHIPRvcOperationalStateCountdownTimeAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRvcOperationalStateCountdownTimeAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRvcOperationalStateCountdownTimeAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RvcOperationalStateCluster, readOperationalStateListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RvcOperationalState::Attributes::OperationalStateList::TypeInfo;
    std::unique_ptr<CHIPRvcOperationalStateOperationalStateListAttributeCallback, void (*)(CHIPRvcOperationalStateOperationalStateListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRvcOperationalStateOperationalStateListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRvcOperationalStateOperationalStateListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RvcOperationalStateCluster, readOperationalStateAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, RvcOperationalStateCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RvcOperationalState::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPRvcOperationalStateGeneratedCommandListAttributeCallback, void (*)(CHIPRvcOperationalStateGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRvcOperationalStateGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRvcOperationalStateGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RvcOperationalStateCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RvcOperationalState::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPRvcOperationalStateAcceptedCommandListAttributeCallback, void (*)(CHIPRvcOperationalStateAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRvcOperationalStateAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRvcOperationalStateAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RvcOperationalStateCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RvcOperationalState::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPRvcOperationalStateEventListAttributeCallback, void (*)(CHIPRvcOperationalStateEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRvcOperationalStateEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRvcOperationalStateEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RvcOperationalStateCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::RvcOperationalState::Attributes::AttributeList::TypeInfo;
    std::unique_ptr<CHIPRvcOperationalStateAttributeListAttributeCallback, void (*)(CHIPRvcOperationalStateAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPRvcOperationalStateAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPRvcOperationalStateAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, RvcOperationalStateCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, RvcOperationalStateCluster, readClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
